		...
		private sealed class Serializer
		{
			...
			private void SerializeOther(object value)
			{
				...
				if ((object)value.GetType() != typeof(float))
				{
					...
					CultureInfo invariantCulture = CultureInfo.InvariantCulture;
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @A663A4 (inside System.Double::IsNaN +0x4C0)");
				}
				else
				{
					stringBuilder2 = builder;
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BCCF74 (inside System.Single::IsNaN +0x35C)");
				}
