	...
	public sealed class Filter : IEnumerable<IEntity>, IEnumerable, IDisposable
	{
		...
		public struct ComponentsBag<T> where T : struct, IComponent
		{
			...
			internal unsafe void Update(int[] entities, in int len)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1096C48 (inside Morpeh.Filter+ComponentsBag`1::.cctor +0x280)");
			}
		...
		private Filter(World world, ObservableHashSet<int> rootEntities, FastBitMask mask, FilterMode mode, bool fillWithPreviousEntities)
		{
			...
			if ((object)obj2 == null || (object)obj2.GetType() == typeof(Action<int>))
			{
				...
				while (true)
				{
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1183AF4 (inside System.Collections.Generic.GenericEqualityComparer`1<UnityEngine.Vector4>::.ctor +0x50)");
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1183AF0 (inside System.Collections.Generic.GenericEqualityComparer`1<UnityEngine.Vector4>::.ctor +0x4C)");
				goto IL_057f;
			}
			intPtr = (IntPtr)0;
			intPtr2 = (IntPtr)null;
