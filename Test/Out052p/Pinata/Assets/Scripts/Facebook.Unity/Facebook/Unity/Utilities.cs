...
namespace Facebook.Unity
{
	...
	internal static class Utilities
	{
		...
		public static long TotalSeconds(this DateTime dateTime)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E93B78 (inside System.DateTime::TimeToTicks +0xF0)");
		...
		private static DateTime FromTimestamp(int timestamp)
		{
			...
			object obj2 = default(object);
			object obj = obj2;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E93CAC (inside System.DateTime::TimeToTicks +0x224)");
			object obj3 = (long)(IntPtr)obj2 - 8L;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E94CB8 (inside System.DateTime::DaysInMonth +0x170)");
