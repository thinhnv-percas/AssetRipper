	...
	public class ActionData
	{
		...
		private List<FsmQuaternion> CopyFsmQuaternionParams()
		{
			if (fsmQuaternionParams != null)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9E2A78 (inside HutongGames.PlayMaker.Fsm::.cctor +0x2C4)");
		...
		private FsmRect GetFsmRect(Fsm fsm, int paramIndex)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9E2A80 (inside HutongGames.PlayMaker.Fsm::.cctor +0x2CC)");
		...
		private void SaveActionField(Fsm fsm, Type fieldType, object obj)
		{
			...
			//IL_1673: Expected F4, but got O
			//IL_16b9: Expected F4, but got O
			//IL_1700: Expected I4, but got O
			//IL_1745: Expected I, but got O
			//IL_3281: Expected I4, but got O
			//IL_1774: Expected I4, but got O
			//IL_17b4: Expected I4, but got O
			//IL_1841: Expected F4, but got O
			//IL_1856: Expected F4, but got I
			//IL_186b: Expected F4, but got I
			//IL_1880: Expected F4, but got I
			//IL_1138: Expected I4, but got O
			//IL_190e: Expected F4, but got O
			//IL_1923: Expected F4, but got I
			//IL_0f95: Expected I, but got O
			//IL_19b1: Expected F4, but got O
			//IL_19c6: Expected F4, but got I
			//IL_19db: Expected F4, but got I
			...
			//IL_1a69: Expected F4, but got O
			//IL_1a7e: Expected F4, but got I
			//IL_1a93: Expected F4, but got I
			//IL_1aa8: Expected F4, but got I
			//IL_101c: Expected O, but got I
			//IL_1b36: Expected F4, but got O
			//IL_1b4b: Expected F4, but got I
			//IL_1b60: Expected F4, but got I
			//IL_1b75: Expected F4, but got I
			//IL_22a8: Expected O, but got I
			//IL_1610: Expected I4, but got O
			//IL_1636: Expected I, but got O
																									...
																									if ((object)typeFromHandle25 != fieldType)
																									{
																										...
																										if ((object)typeFromHandle26 != fieldType)
																										{
																											...
																											else
																											{
																												...
																												if (obj != null)
																												{
																													Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9E2A88 (inside HutongGames.PlayMaker.Fsm::.cctor +0x2D4)");
																													return;
																												}
																												item2 = null;
