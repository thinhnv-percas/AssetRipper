	...
	public class FsmVar
	{
		...
		public Vector2 vector2Value
		{
			...
			set
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @158BC14 (inside UnityEngine.Vector3Int::.cctor +0x248)");
			}
		}
		...
		public Vector3 vector3Value
		{
			...
			get
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @158A1C8 (inside UnityEngine.Vector3::MoveTowards +0x298)");
				return vector3;
			}
		...
		public Rect rectValue
		{
			...
			get
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CCFA8 (inside UnityEngine.Rect::MinMaxRect +0xC)");
				return rect;
			}
		...
		private void UpdateType(INamedVariable sourceVar)
		{
			...
			//IL_00f8: Expected I4, but got I8
