...
namespace com.adjust.sdk
{
	...
	public class JSONNode
	{
		...
		public virtual double AsDouble
		{
			...
			set
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @A662F8 (inside System.Double::IsNaN +0x414)");
				string value2 = default(string);
				Value = value2;
			}
		}
