...
namespace UnityEngine.Purchasing.Security
{
	...
	internal class GooglePlayValidator
	{
		...
		public unsafe GooglePlayReceipt Validate(string receipt, string signature)
		{
			...
			//IL_0168: Expected I8, but got O
			//IL_01ac: Expected I8, but got O
			...
			if (key.Verify(bytes, signature2))
			{
				...
				if (dictionary != null)
				{
					...
					if (num != 0)
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E946C0 (inside System.DateTime::TimeToTicks +0xC38)");
