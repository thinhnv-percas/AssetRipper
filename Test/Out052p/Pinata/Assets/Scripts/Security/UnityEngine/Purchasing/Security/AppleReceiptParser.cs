						...
						if (count3 == 3)
						{
							...
							if (!(flag4 || flag3))
							{
								if (num3 == 12)
								{
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E95E88 (inside System.DateTime::ParseExact +0x1C0)");
								}
							}
							else
							{
			...
			if (a.Length >= 1)
			{
				if (b.Length != 0)
				{
					...
					while (num2 < num)
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E90634 (inside System.Buffer::memcpy1 +0x214)");
