...
namespace EasyMobile
{
	...
	public class BannerAdSize
	{
		...
		public override int GetHashCode()
		{
			...
			bool isSmartBanner = IsSmartBanner;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E8F13C (inside System.BitConverter::.cctor +0x54)");
			int width = Width;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @DC3558 (inside System.InvalidCastException::.ctor +0x280)");
			int height = Height;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @DC3558 (inside System.InvalidCastException::.ctor +0x280)");
