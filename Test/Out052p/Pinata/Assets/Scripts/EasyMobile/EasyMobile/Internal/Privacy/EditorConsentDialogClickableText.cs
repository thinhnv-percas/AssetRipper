...
namespace EasyMobile.Internal.Privacy
{
	...
	public class EditorConsentDialogClickableText : Text, IPointerClickHandler, IEventSystemHandler, IPointerExitHandler, IPointerEnterHandler, ISelectHandler
	{
				...
				if (!flag3)
				{
					...
					while (enumerator2.MoveNext())
					{
						...
						while (true)
						{
							...
							object obj6 = 0;
							Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD1C8 (inside UnityEngine.Rect::MinMaxRect +0x22C)");
		...
		protected unsafe override void OnPopulateMesh(VertexHelper toFill)
		{
			...
			//IL_06da: Expected F4, but got O
			//IL_06e7: Expected F4, but got O
			//IL_06f4: Expected F4, but got O
			//IL_0741: Expected F4, but got O
			//IL_08e0: Expected O, but got Ref
			//IL_078f: Expected F4, but got O
			//IL_07cc: Expected O, but got I
			//IL_067f: Expected O, but got I4
			//IL_0518: Expected F4, but got O
			//IL_0525: Expected F4, but got O
			//IL_0532: Expected F4, but got O
			//IL_057f: Expected F4, but got O
			//IL_05a8: Expected F4, but got O
					...
					while (true)
					{
						...
						if (num11 < currentVertCount3)
						{
							...
							if (System.Runtime.CompilerServices.Unsafe.As<UIVertex, UIntPtr>(ref vertex) < System.Runtime.CompilerServices.Unsafe.As<UIVertex, UIntPtr>(ref uIVertex))
							{
								...
								Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CCF70 (inside UnityEngine.RangeAttribute::.ctor +0x29C)");
