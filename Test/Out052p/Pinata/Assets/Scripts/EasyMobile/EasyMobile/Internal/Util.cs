...
namespace EasyMobile.Internal
{
	...
	internal static class Util
	{
		...
		public static DateTime FromMillisSinceUnixEpoch(long millisSinceEpoch)
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E9442C (inside System.DateTime::TimeToTicks +0x9A4)");
		...
		static Util()
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E93738 (inside System.DBNull::.cctor +0x360)");
