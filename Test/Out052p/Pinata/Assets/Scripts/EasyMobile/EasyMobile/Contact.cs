	...
	public class Contact
	{
		...
		public DateTime? Birthday
		{
			...
			internal set
			{
				...
				{
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @115B5D8 (inside System.Nullable`1::Unbox +0xC0)");
				}
				else
				{
					bool flag = this == null;
						...
						if (!(flag13 || flag12))
						{
							...
							if (!(flag17 || flag16))
							{
								...
								if ((num & 0xFF) != 0)
								{
									...
									Cpp2ILHelpers.NoteDecompilerIssue("Method not found @E96044 (inside System.DateTime::ParseExact +0x37C)");
