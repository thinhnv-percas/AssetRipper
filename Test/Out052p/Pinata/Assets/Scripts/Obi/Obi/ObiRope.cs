	...
	public class ObiRope : ObiRopeBase
	{
		...
		private sealed class _003C_003Ec
		{
			...
			internal int _003CApplyTearing_003Eb__40_0(ObiStructuralElement x, ObiStructuralElement y)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BCCD50 (inside System.Single::IsNaN +0x138)");
		...
		protected void ApplyTearing()
		{
			...
			//IL_040a: Expected F4, but got O
			//IL_0818: Expected O, but got I
			//IL_0441: Unsupported input type for neg.
		...
		{
			//IL_10c8: Expected I4, but got I8
			//IL_0aaf: Expected I, but got O
			...
			//IL_0fc1: Expected I, but got O
			//IL_0fe8: Expected O, but got I
			//IL_100f: Expected O, but got I
