...
namespace Obi
{
	...
	public class VoxelDistanceField
	{
		...
		public void JumpFlood()
		{
			...
			//IL_0702: Expected I4, but got F4
			//IL_076c: Expected I4, but got F4
						...
						if (!(flag10 || flag9))
						{
							...
							if (!(flag14 || flag13))
							{
								...
								if (!flag15)
								{
									...
									do
									{
										Cpp2ILHelpers.NoteDecompilerIssue("Method not found @6D2E60 (native ldexpf)");
		...
		private void JumpFloodPass(int stride, Vector3Int[,,] input, Vector3Int[,,] output)
		{
			...
			//IL_066c: Expected I4, but got I8
			//IL_06b5: Expected I4, but got I8
			//IL_06c7: Expected I4, but got I8
												...
												if ((long)num34 < 0L)
												{
													...
													if ((long)num35 < 0L)
													{
														...
														if ((int)((long)(IntPtr)obj11 & 0x80000000L) == 0)
														{
															...
															Cpp2ILHelpers.NoteDecompilerIssue("Method not found @158B62C (inside UnityEngine.Vector3::.cctor +0x230)");
															num47 = num48;
