...
namespace Obi
{
	...
	public class ObiRopeLineRenderer : MonoBehaviour
	{
		...
		public void UpdateRenderer(Camera camera)
		{
			...
			//IL_04a7: Expected F4, but got I
			//IL_04bc: Expected F4, but got I
					...
					while (true)
					{
						...
						if (!flag)
						{
							...
							do
							{
								...
								Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1588BC0 (inside UnityEngine.UnitySynchronizationContext::ExecuteTasks +0x1CC)");
