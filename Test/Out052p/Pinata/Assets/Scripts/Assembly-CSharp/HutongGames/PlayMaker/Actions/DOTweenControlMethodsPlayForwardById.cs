...
{
	[AttributeAttribute(Type = typeof(ActionCategoryAttribute), RVA = "0x74E4BC", Offset = "0x74E4BC")]
	[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x74E4BC", Offset = "0x74E4BC")]
	[AttributeAttribute(Type = typeof(HelpUrlAttribute), RVA = "0x74E4BC", Offset = "0x74E4BC")]
	[Token(Token = "0x20000A3")]
	public class DOTweenControlMethodsPlayForwardById : FsmStateAction
	{
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76FE28", Offset = "0x76FE28")]
		[Token(Token = "0x4000543")]
		[FieldOffset(Offset = "0x4C")]
		public TweenId tweenIdType;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76FE60", Offset = "0x76FE60")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76FE60", Offset = "0x76FE60")]
		[Token(Token = "0x4000544")]
		[FieldOffset(Offset = "0x50")]
		public FsmString stringAsId;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76FEB0", Offset = "0x76FEB0")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76FEB0", Offset = "0x76FEB0")]
		[Token(Token = "0x4000545")]
		[FieldOffset(Offset = "0x58")]
		public FsmString tagAsId;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76FF00", Offset = "0x76FF00")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76FF00", Offset = "0x76FF00")]
		[Token(Token = "0x4000546")]
		[FieldOffset(Offset = "0x60")]
		public FsmGameObject gameObjectAsId;

		[AttributeAttribute(Type = typeof(ActionSection), RVA = "0x76FF50", Offset = "0x76FF50")]
		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76FF50", Offset = "0x76FF50")]
		[Token(Token = "0x4000547")]
		[FieldOffset(Offset = "0x68")]
		public FsmBool debugThis;

		[Token(Token = "0x6000415")]
		[Address(RVA = "0xAF23E8", Offset = "0xAF23E8", Length = "0x104")]
		...
		public override void OnEnter()
		{
			...
			goto IL_019d;
			IL_019d:
			int num2 = DOTween.PlayForward(targetOrId);
			num = num2;
			goto IL_01b7;
			IL_01b7:
			if (debugThis.Value)
			{
				object obj = num;
				string message = string.Concat("DOTween Control Methods Play Forward By Id - Played ", obj, " tweens");
				State.Debug(message);
			}
			Finish();
		}
		...
		[Address(RVA = "0xAF26BC", Offset = "0xAF26BC", Length = "0x8")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tHutongGames.PlayMaker.FsmStateAction::.ctor(this);\n\treturn;\n// 1 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public DOTweenControlMethodsPlayForwardById()
		{
		}
	}
}
