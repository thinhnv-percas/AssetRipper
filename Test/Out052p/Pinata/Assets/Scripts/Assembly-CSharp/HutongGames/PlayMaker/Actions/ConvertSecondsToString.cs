...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class ConvertSecondsToString : FsmStateAction
	{
		...
		private void DoConvertSecondsToString()
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD0F0 (inside System.TimeSpan::TimeToTicks +0x170)");
			...
			if (array.Length != 0)
			{
				convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
				array[0] = this;
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD0A8 (inside System.TimeSpan::TimeToTicks +0x128)");
				convertSecondsToString = (ConvertSecondsToString)(object)(int)this;
				if (this != null)
				{
					convertSecondsToString = (ConvertSecondsToString)(this as object);
				...
				if (!(flag4 || flag3))
				{
					convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
					array[1] = this;
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD13C (inside System.TimeSpan::TimeToTicks +0x1BC)");
					convertSecondsToString = (ConvertSecondsToString)(object)(int)this;
					if (this != null)
					{
						convertSecondsToString = (ConvertSecondsToString)(this as object);
					...
					if (!(flag8 || flag7))
					{
						convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
						array[2] = this;
						Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD184 (inside System.TimeSpan::TimeToTicks +0x204)");
						convertSecondsToString = (ConvertSecondsToString)(object)(int)this;
						if (this != null)
						{
							convertSecondsToString = (ConvertSecondsToString)(this as object);
						...
						if (!(flag12 || flag11))
						{
							...
							if (!(flag16 || flag15))
							{
								convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
								array[4] = this;
								Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD1D0 (inside System.TimeSpan::TimeToTicks +0x250)");
								...
								if (!(flag20 || flag19))
								{
									convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
									array[5] = this;
									Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD1E8 (inside System.TimeSpan::TimeToTicks +0x268)");
									convertSecondsToString = (ConvertSecondsToString)(object)(double)value;
									if (this != null)
									{
										convertSecondsToString = (ConvertSecondsToString)(this as object);
									...
									if (!(flag24 || flag23))
									{
										convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
										array[6] = this;
										Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD200 (inside System.TimeSpan::TimeToTicks +0x280)");
										convertSecondsToString = (ConvertSecondsToString)(object)(double)value;
										if (this != null)
										{
											convertSecondsToString = (ConvertSecondsToString)(this as object);
										...
										if (!(flag28 || flag27))
										{
											convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
											array[7] = this;
											Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9BD218 (inside System.TimeSpan::TimeToTicks +0x298)");
											convertSecondsToString = (ConvertSecondsToString)(object)(double)value;
											if (this != null)
											{
												convertSecondsToString = (ConvertSecondsToString)(this as object);
											...
											if (!(flag32 || flag31))
											{
												convertSecondsToString = (ConvertSecondsToString)((long)(IntPtr)obj2 - 56L);
												array[8] = this;
												Cpp2ILHelpers.NoteDecompilerIssue("Method not found @9B7F4C (inside System.Threading.ThreadPool::RegisterWaitForSingleObject +0x134)");
												convertSecondsToString = (ConvertSecondsToString)(object)(double)value;
												if (this != null)
												{
													convertSecondsToString = (ConvertSecondsToString)(this as object);
