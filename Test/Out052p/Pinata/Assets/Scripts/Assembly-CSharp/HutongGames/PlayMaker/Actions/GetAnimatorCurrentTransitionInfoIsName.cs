	...
	public class GetAnimatorCurrentTransitionInfoIsName : FsmStateActionAnimatorBase
	{
		...
		private void IsName()
		{
			if (_animator != null)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1638F9C (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0x11C)");
