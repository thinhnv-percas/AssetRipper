...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class RectTransformSetAnchorRectPosition : BaseUpdateAction
	{
		...
		private void DoSetAnchor()
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD08C (inside UnityEngine.Rect::MinMaxRect +0xF0)");
			Vector2 anchorMax = _rt.anchorMax;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD144 (inside UnityEngine.Rect::MinMaxRect +0x1A8)");
