		...
		private void SetProperties()
		{
			...
			if (!(_joint == null))
			{
				...
				if (!min.IsNone)
				{
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @163E668 (inside UnityEngine.Joint2D::get_reactionTorque +0x40)");
				...
				if (!max.IsNone)
				{
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @163E670 (inside UnityEngine.Joint2D::get_reactionTorque +0x48)");
