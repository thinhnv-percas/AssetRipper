...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class RectOverlaps : FsmStateAction
	{
		...
		public static bool Intersect(Rect a, Rect b)
		{
			...
			FlipNegative(ref r2);
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD07C (inside UnityEngine.Rect::MinMaxRect +0xE0)");
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD124 (inside UnityEngine.Rect::MinMaxRect +0x188)");
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD124 (inside UnityEngine.Rect::MinMaxRect +0x188)");
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD07C (inside UnityEngine.Rect::MinMaxRect +0xE0)");
			float num = r.x - r.x;
			bool flag = num < 0f;
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD084 (inside UnityEngine.Rect::MinMaxRect +0xE8)");
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD134 (inside UnityEngine.Rect::MinMaxRect +0x198)");
			float num3 = r.x - r.x;
			bool flag7 = num3 < 0f;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD134 (inside UnityEngine.Rect::MinMaxRect +0x198)");
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10CD084 (inside UnityEngine.Rect::MinMaxRect +0xE8)");
		...
		{
			//IL_0047: Unsupported input type for neg.
			//IL_0047: Unknown result type (might be due to invalid IL or missing references)
			//IL_004c: Expected O, but got Unknown
			//IL_0065: Expected O, but got I
			//IL_00bb: Unsupported input type for neg.
