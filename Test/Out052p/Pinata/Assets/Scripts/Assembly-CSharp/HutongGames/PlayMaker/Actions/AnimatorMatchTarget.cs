	...
	public class AnimatorMatchTarget : FsmStateAction
	{
		...
		private void DoMatchTarget()
		{
			...
			if (!(_animator == null))
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1639294 (inside UnityEngine.Experimental.Animations.AnimationScriptPlayable::.cctor +0xA0)");
