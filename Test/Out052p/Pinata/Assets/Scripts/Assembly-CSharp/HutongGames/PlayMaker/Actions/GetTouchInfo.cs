	...
	public class GetTouchInfo : FsmStateAction
	{
		...
		private void DoGetTouchInfo()
		{
			...
			while (num2 < num)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @16717B4 (inside UnityEngine.SendMouseEvents::.cctor +0x194)");
				fsmFloat5.Value = num6;
				FsmInt fsmInt = storeTapCount;
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @16717BC (inside UnityEngine.SendMouseEvents::.cctor +0x19C)");
				fsmInt.Value = value6;
				goto IL_04af;
				IL_04af:
				num = touches.Length;
