...
public class DynamicBone : MonoBehaviour
{
	...
	private void AppendParticles(Transform b, int parentIndex, float boneLength)
	{
		...
		//IL_0b3f: Expected I4, but got I8
	...
	private void UpdateParticles2()
	{
		...
		//IL_0f08: Expected O, but got F4
		//IL_0b87: Expected F4, but got O
		//IL_0b94: Expected F4, but got O
		//IL_05e5: Expected O, but got I4
		//IL_0bce: Expected O, but got F4
		//IL_0bdb: Expected O, but got F4
		...
		//IL_0cfa: Expected F4, but got I
		//IL_0d0f: Expected F4, but got I
		//IL_0d24: Expected F4, but got I
		//IL_0d59: Expected F4, but got O
		//IL_0d66: Expected F4, but got O
		//IL_099a: Expected I, but got O
		//IL_09ab: Expected O, but got I
		//IL_0733: Expected O, but got F4
		//IL_0da0: Expected O, but got F4
		//IL_0dad: Expected O, but got F4
		...
		do
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10C26E8 (inside UnityEngine.Matrix4x4::op_Multiply +0x94)");
			float y4;
			float z4;
			if (particle.m_Transform != null)
			{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10C884C (inside UnityEngine.Object::.cctor +0x11C)");
			object obj13 = (long)(IntPtr)obj2 - 160L;
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @10C892C (inside UnityEngine.Object::.cctor +0x1FC)");
	...
	private void SkipUpdateParticles()
	{
		...
		//IL_08fa: Expected F4, but got O
		//IL_0907: Expected F4, but got O
		//IL_0914: Expected F4, but got O
		//IL_0921: Expected F4, but got O
		//IL_092e: Expected F4, but got O
		//IL_0965: Expected O, but got I
		//IL_0626: Expected F4, but got O
		//IL_0633: Expected F4, but got O
		//IL_0a00: Expected F4, but got I
		//IL_0a15: Expected F4, but got I
		//IL_0a2a: Expected F4, but got I
		//IL_0a48: Expected F4, but got O
		//IL_0a55: Expected F4, but got O
		//IL_0796: Expected F4, but got O
		//IL_07a3: Expected F4, but got O
		//IL_0b10: Expected O, but got I4
		//IL_088f: Expected F4, but got O
