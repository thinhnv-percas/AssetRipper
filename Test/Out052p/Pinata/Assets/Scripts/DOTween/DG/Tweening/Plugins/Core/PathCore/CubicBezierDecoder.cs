...
namespace DG.Tweening.Plugins.Core.PathCore
{
	...
	internal class CubicBezierDecoder : ABSPathDecoder
	{
		...
		internal override void FinalizePath(Path p, Vector3[] wps, bool isClosedPath)
		{
			...
			//IL_074f: Expected F4, but got O
			//IL_0764: Expected F4, but got I
			//IL_0779: Expected F4, but got I
			//IL_078e: Expected F4, but got I
			//IL_07a3: Expected F4, but got I
			//IL_07b8: Expected F4, but got I
			//IL_07f1: Expected F4, but got O
			//IL_0806: Expected F4, but got I
			//IL_081b: Expected F4, but got I
			//IL_0841: Expected F4, but got I
			//IL_0856: Expected F4, but got I
			//IL_086b: Expected F4, but got I
			//IL_0880: Expected F4, but got I
			//IL_0895: Expected F4, but got I
			//IL_08aa: Expected F4, but got I
			//IL_08eb: Expected F4, but got I
			//IL_0900: Expected F4, but got I
			//IL_0915: Expected F4, but got I
			//IL_0384: Expected O, but got I
			//IL_03a0: Expected O, but got I
			//IL_03ca: Expected O, but got I
			//IL_0455: Expected O, but got I
			//IL_096c: Expected O, but got I8
