	...
	public static class EaseManager
	{
		...
		private sealed class _003C_003Ec
		{
			...
			internal float _003CToEaseFunction_003Eb__4_1(float time, float duration, float overshootOrAmplitude, float period)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @6D2660 (native cos)");
				return 1f - num2;
			}
			...
			internal float _003CToEaseFunction_003Eb__4_2(float time, float duration, float overshootOrAmplitude, float period)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @6D21F0 (native sin)");
				return result;
			}
			...
			internal float _003CToEaseFunction_003Eb__4_16(float time, float duration, float overshootOrAmplitude, float period)
			{
				...
				if (time != 0f)
				{
					...
					float num2 = num + -1f;
					result = num2 * 10f;
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @6D2950 (native exp2)");
				}
				else
				{
					result = 0f;
				...
				if (time != 0f)
				{
					...
					if (!flag)
					{
						...
						else
						{
							...
							Cpp2ILHelpers.NoteDecompilerIssue("Method not found @6D2A50 (native asin)");
