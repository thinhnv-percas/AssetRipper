...
namespace DG.Tweening.Plugins
{
	...
	public class ColorPlugin : ABSTweenPlugin<Color, Color, ColorOptions>
	{
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_001F;\n\tv30 = *([1EBBB08]);\n\tv31 = *([v30 @ X8_v12]);\n\tv32 = \"il2cpp_codegen_initialize_method\"(v31, t, isRelative, methodInfo, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45);\n\tv49 = 0 | 1;\n\t*([2026A40]) = v49;\nL_001F:\n\tv92 = t.endValue;\n\tv90 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+130]);\n\tv88 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+134]);\n\tv86 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+138]);\n\tv61 = DG.Tweening.Core.DOGetter`1<UnityEngine.Color>::Invoke(t.getter);\n\tt.endValue = v61;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+130]) = v61.g;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+134]) = v61.b;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+138]) = v61.a;\n\tv103 = isRelative == 0;\n\tif (v103) goto L_0040;\n\tv111 = UnityEngine.Color::op_Addition(v61, t.endValue);\nL_0040:\n\tt.startValue = v92;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+120]) = v90;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+124]) = v88;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+128]) = v86;\n\tv201 = t + 0x12C;\n\tv165 = t + 0x130;\n\tv162 = t + 0x134;\n\tv135 = t + 0x11C;\n\tv132 = t + 0x120;\n\tv129 = t + 0x124;\n\tv212 = t.plugOptions != 0;\n\tif (v212) goto L_005E;\n\tgoto L_005E;\nL_005E:\n\tv215 = t.plugOptions != 0;\n\tif (v215) goto L_0064;\n\tgoto L_0064;\nL_0064:\n\tv126 = t.plugOptions != 0;\n\tif (v126) goto L_0079;\n\tgoto L_0079;\nL_0079:\n\t// 121 MakeStruct v121 @ AGG107FDC8_1_v1 (UnityEngine.Color), typeof(UnityEngine.Color), [v201 @ X8_v7], [v165 @ X9_v2], [v162 @ X10_v2], v86 @ V8_v3 (System.Single)\n\tDG.Tweening.Core.DOSetter`1<UnityEngine.Color>::Invoke(t.setter, v121);\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 85 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetFrom(TweenerCore<Color, Color, ColorOptions> t, bool isRelative)
		{
			...
			//IL_021e: Expected F4, but got O
			Color startValue = t.endValue;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+130]");
			float num = 0f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+134]");
			float num2 = 0f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+138]");
			float a = 0f;
			Color color = (t.endValue = t.getter());
			_ = color.g;
			_ = color.b;
			_ = color.a;
			if (isRelative)
			{
				Color color2 = color + t.endValue;
				a = color2.a;
				num2 = color2.b;
				num = color2.g;
				startValue = color2;
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv22 = UnityEngine.Color::op_Addition(t.endValue, t.startValue);\n\tt.endValue = v22;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+130]) = v22.g;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+134]) = v22.b;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+138]) = v22.a;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 27 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetRelativeEndValue(TweenerCore<Color, Color, ColorOptions> t)
		{
			Color color = (t.endValue += t.startValue);
			_ = color.g;
			_ = color.b;
			_ = color.a;
		}
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv22 = UnityEngine.Color::op_Subtraction(t.endValue, t.startValue);\n\tt.changeValue = v22;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+140]) = v22.g;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+144]) = v22.b;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Color, UnityEngine.Color, DG.Tweening.Plugins.Options.ColorOptions>)+148]) = v22.a;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 27 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Color, Color, ColorOptions> t)
		{
			Color color = (t.changeValue = t.endValue - t.startValue);
			_ = color.g;
			_ = color.b;
			_ = color.a;
		}
		...
		public override void EvaluateAndApply(ColorOptions options, Tween t, bool isRelative, DOGetter<Color> getter, DOSetter<Color> setter, float elapsed, Color startValue, Color changeValue, float duration, bool usingInversePosition, UpdateNotice updateNotice)
		{
			...
			if (0 == 0)
			{
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1084DF4 (inside DG.Tweening.Plugins.LongPlugin::.ctor +0x1D0)");
				return;
			}
