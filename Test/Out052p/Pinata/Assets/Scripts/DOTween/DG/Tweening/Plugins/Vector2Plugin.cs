...
namespace DG.Tweening.Plugins
{
	...
	public class Vector2Plugin : ABSTweenPlugin<Vector2, Vector2, VectorOptions>
	{
		...
		public override void SetFrom(TweenerCore<Vector2, Vector2, VectorOptions> t, bool isRelative)
		{
			...
			//IL_010c: Expected F4, but got I
			//IL_014c: Expected O, but got I
			//IL_02b0: Expected O, but got I
			//IL_0205: Expected F8, but got I
			//IL_046a: Unknown result type (might be due to invalid IL or missing references)
			//IL_046f: Expected I4, but got Unknown
			//IL_01b8: Expected F8, but got I
			//IL_03da: Expected O, but got F8
			//IL_035a: Expected F8, but got I
			//IL_04b4: Unknown result type (might be due to invalid IL or missing references)
			//IL_04b9: Expected I4, but got Unknown
			//IL_0312: Expected F8, but got I
			...
			if (isRelative)
			{
				Vector2 vector3 = vector2 + t.endValue;
				y = vector3.y;
				num = vector3.y;
				vector = vector3;
			}
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+138]");
			double num3;
		...
		public override void SetFrom(TweenerCore<Vector2, Vector2, VectorOptions> t, Vector2 fromValue, bool setImmediately)
		{
			...
			//IL_0380: Expected O, but got F8
			//IL_0446: Unknown result type (might be due to invalid IL or missing references)
			//IL_044b: Expected I4, but got Unknown
			float y = fromValue.y;
			t.startValue = fromValue;
			_ = fromValue.y;
			if (!setImmediately)
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0023;\n\tv26 = *([1EC9260]);\n\tv27 = *([v26 @ X8_v10]);\n\tv28 = \"il2cpp_codegen_initialize_method\"(v27, t, methodInfo, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42);\n\tv46 = 0 | 1;\n\t*([20274DF]) = v46;\nL_0023:\n\tgoto L_0030;\n\tv60 = *([v53 @ X0_v4+E0]);\n\tv61 = v60 == 0;\n\tv62 = ~v61;\n\tif (v62) goto L_0030;\n\tv64 = \"il2cpp_codegen_runtime_class_init\"(v53, t, methodInfo, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42);\nL_0030:\n\tv74 = UnityEngine.Vector2::op_Addition(t.endValue, t.startValue);\n\tt.endValue = v74;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+128]) = v74.y;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 47 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetRelativeEndValue(TweenerCore<Vector2, Vector2, VectorOptions> t)
		{
			Vector2 vector = (t.endValue += t.startValue);
			_ = vector.y;
		}

		[Token(Token = "0x60001F3")]
		[Address(RVA = "0x10DE360", Offset = "0x10DE360", Length = "0x114")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_001E;\n\tv26 = *([1EA6748]);\n\tv27 = *([v26 @ X8_v13]);\n\tv28 = \"il2cpp_codegen_initialize_method\"(v27, t, methodInfo, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42);\n\tv46 = 0 | 1;\n\t*([20274E0]) = v46;\nL_001E:\n\tv53 = t.plugOptions == 4;\n\tif (v53) goto L_003A;\n\tv69 = t.plugOptions != 2;\n\tif (v69) goto L_004D;\n\tv74 = 0;\n\tv95 = t.endValue - t.startValue;\n\tgoto L_003D;\nL_003A:\n\tv94 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+128]) - *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+120]);\nL_003D:\n\tv108 = 0x1588A6C(v106, 0, methodInfo, v30, v31, v32, v33, v34, v95, v94, v37, v38, v39, v40, v41, v42);\n\tt.changeValue = v74;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+130]) = v196;\n\tgoto L_0067;\nL_004D:\n\tgoto L_005A;\n\tv179 = *([v88 @ X0_v8+E0]);\n\tv180 = v179 == 0;\n\tv181 = ~v180;\n\tif (v181) goto L_005A;\n\tv183 = \"il2cpp_codegen_runtime_class_init\"(v88, t, methodInfo, v30, v31, v32, v33, v34, v35, v36, v37, v38, v39, v40, v41, v42);\nL_005A:\n\tv193 = UnityEngine.Vector2::op_Subtraction(t.endValue, t.startValue);\n\tt.changeValue = v193;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+130]) = v193.y;\nL_0067:\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 77 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Vector2, Vector2, VectorOptions> t)
		{
			...
			if ((IntPtr)t.plugOptions != (IntPtr)4)
			{
				...
				{
					Vector2 vector = (t.changeValue = t.endValue - t.startValue);
					_ = vector.y;
					return;
				}
			...
			else
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector2, UnityEngine.Vector2, DG.Tweening.Plugins.Options.VectorOptions>)+120]");
				int num2 = (int)((long)intPtr - 0L);
				float num = 0f;
				object obj = vector2;
			}
