...
namespace DG.Tweening.Plugins
{
	...
	public class SpiralPlugin : ABSTweenPlugin<Vector3, Vector3, SpiralOptions>
	{
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_001F;\n\tv30 = *([1F076B8]);\n\tv31 = *([v30 @ X8_v15]);\n\tv32 = \"il2cpp_codegen_initialize_method\"(v31, t, methodInfo, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46);\n\tv50 = 0 | 1;\n\t*([202A897]) = v50;\nL_001F:\n\tv56 = 10f / *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+144]);\n\tv57 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+148]) * v56;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+148]) = v57;\n\tgoto L_0031;\n\tv68 = *([v62 @ X0_v4+E0]);\n\tv69 = v68 == 0;\n\tv70 = ~v69;\n\tif (v70) goto L_0031;\n\tv72 = \"il2cpp_codegen_runtime_class_init\"(v62, t, methodInfo, v34, v35, v36, v37, v38, v57, v53, v54, v42, v43, v44, v45, v46);\nL_0031:\n\tv76 = UnityEngine.Vector3::get_up();\n\tgoto L_004C;\n\tv132 = *([v84 @ X0_v7+E0]);\n\tv133 = v132 == 0;\n\tv134 = ~v133;\n\tif (v134) goto L_004C;\n\tv136 = \"il2cpp_codegen_runtime_class_init\"(v84, t, methodInfo, v34, v35, v36, v37, v38, v76, v77, v78, v42, v43, v44, v45, v46);\nL_004C:\n\tv119 = UnityEngine.Quaternion::LookRotation(t.endValue, v76);\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+158]) = v119;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+15C]) = v119.y;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+160]) = v119.z;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+164]) = v119.w;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 69 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Vector3, Vector3, SpiralOptions> t)
		{
			float num = 10f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+144]");
			float num2 = num / 0f;
			Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<UnityEngine.Vector3, UnityEngine.Vector3, DG.Tweening.Plugins.SpiralOptions>)+148]");
			float num3 = 0f * num2;
			Vector3 up = Vector3.up;
			Quaternion quaternion = Quaternion.LookRotation(t.endValue, up);
			_ = quaternion.y;
			_ = quaternion.z;
			_ = quaternion.w;
		}
		...
		public unsafe override void EvaluateAndApply(SpiralOptions options, Tween t, bool isRelative, DOGetter<Vector3> getter, DOSetter<Vector3> setter, float elapsed, Vector3 startValue, Vector3 changeValue, float duration, bool usingInversePosition, UpdateNotice updateNotice)
		{
			...
			//IL_0920: Expected native int or pointer, but got O
			//IL_02c0: Expected F4, but got O
			//IL_0834: Unknown result type (might be due to invalid IL or missing references)
			//IL_0839: Expected I4, but got Unknown
			//IL_087e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0883: Expected I4, but got Unknown
			//IL_06d3: Expected O, but got F8
