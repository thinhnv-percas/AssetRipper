...
namespace GoogleMobileAds.Android
{
	...
	internal class Utils
	{
		...
		public unsafe static AndroidJavaObject GetAdRequestJavaObject(AdRequest request)
		{
			...
			//IL_0657: Expected I4, but got Unknown
			...
			//IL_1e22: Expected O, but got I
			//IL_03f3: Expected I, but got O
			//IL_1bee: Expected I, but got O
			...
			//IL_0bb8: Expected I, but got O
			//IL_0bbd: Expected I, but got O
			//IL_0d35: Expected I, but got O
			//IL_0d85: Expected O, but got I
			//IL_0dd2: Expected I, but got O
			//IL_1934: Expected O, but got I
			//IL_0e54: Expected I, but got O
			//IL_0e60: Expected O, but got I
			//IL_0e64: Expected O, but got I4
			//IL_0e6c: Expected O, but got I
			//IL_20a0: Expected O, but got I
			//IL_1e67: Expected O, but got I
			//IL_1985: Expected O, but got I
			//IL_0ec5: Expected O, but got I
			//IL_19dd: Expected O, but got I
			//IL_19af: Expected O, but got I
			//IL_0f25: Expected O, but got I
			//IL_0ef7: Expected O, but got I
			//IL_1a67: Expected O, but got I
			//IL_0fb3: Expected O, but got I
			//IL_1a3c: Expected O, but got I
			//IL_0fc5: Expected O, but got I
			//IL_0f8c: Expected O, but got I
			//IL_1ec5: Expected O, but got I
			//IL_1058: Expected O, but got I
			//IL_10d4: Expected O, but got I
			//IL_10ec: Expected O, but got I4
			//IL_10f5: Expected I, but got O
			//IL_10fd: Expected O, but got I
			//IL_110a: Expected O, but got I
			//IL_1898: Expected I, but got O
			//IL_18b1: Expected O, but got I
			//IL_18e7: Expected I, but got O
			//IL_1181: Expected I, but got O
			//IL_1f3c: Expected O, but got I
			//IL_1d6a: Expected O, but got I
			//IL_180c: Expected I, but got O
			//IL_1d95: Expected O, but got I
			//IL_1852: Expected I, but got O
			//IL_1229: Expected I, but got O
			...
			while (true)
			{
				...
				if (!flag17)
				{
					...
					if (enumerator15.MoveNext())
					{
						...
						if ((nint)0 == 0)
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Method not found @B3490C");
							Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v3608 @ X22_v68+38]");
							num11 = 0;
						}
						Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v113 @ X8_v9 (Il2CppStaticFields<System.EmptyArray`1<System.Object>>)+10]");
