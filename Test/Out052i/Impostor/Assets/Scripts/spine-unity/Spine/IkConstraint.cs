	...
	public class IkConstraint : IUpdatable
	{
		...
		public static void Apply(Bone bone, float targetX, float targetY, bool compress, bool stretch, bool uniform, float alpha)
		{
			...
			else
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Method not found @18550E0 (native atan2)");
			...
			else
			{
				...
				if (!(num38 < 0.0001f))
				{
					...
					if (!(flag7 && flag9))
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1854F60 (native sin)");
					...
					if (!(num140 < -1f))
					{
						...
						{
							Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1854F40 (native acos)");
							Cpp2ILHelpers.NoteDecompilerIssue("Method not found @1855120 (native sincos)");
