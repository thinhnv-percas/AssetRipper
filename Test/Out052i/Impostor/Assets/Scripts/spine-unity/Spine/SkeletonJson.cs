...
namespace Spine
{
	...
	public class SkeletonJson
	{
		...
		{
			//IL_3ec3: Expected O, but got I
			//IL_0de5: Expected O, but got I
			//IL_082c: Expected I, but got O
			//IL_3023: Expected O, but got I
			//IL_0d6e: Expected I, but got O
			//IL_0241: Expected O, but got I
			//IL_3070: Expected I4, but got O
			//IL_01f0: Expected O, but got I
			//IL_2dc5: Expected F4, but got O
			//IL_18fb: Expected I, but got O
			//IL_192c: Expected I, but got O
			//IL_43ff: Expected I, but got O
			//IL_3458: Expected O, but got I
			//IL_4613: Expected O, but got I
			//IL_0711: Expected O, but got F4
			//IL_0f9b: Expected O, but got F4
			//IL_1485: Expected O, but got F4
			//IL_0770: Expected I4, but got O
			//IL_20a6: Expected O, but got F4
			//IL_1a8b: Expected O, but got F4
			//IL_2273: Expected O, but got F4
			//IL_07a5: Expected I4, but got O
			//IL_2440: Expected O, but got F4
			//IL_1c69: Expected I4, but got O
			//IL_260d: Expected O, but got F4
			//IL_0ce3: Expected I4, but got O
			//IL_1ca4: Expected I4, but got O
			//IL_0d18: Expected I4, but got O
			//IL_1cf6: Expected I4, but got O
			//IL_1d31: Expected I4, but got O
			//IL_2cca: Expected F4, but got O
			//IL_2cd2: Expected O, but got I
			//IL_2ce0: Expected I, but got O
			//IL_1d83: Expected I4, but got O
			//IL_2d5a: Expected F4, but got O
			//IL_1db8: Expected I4, but got O
			//IL_2b17: Expected F4, but got O
			//IL_2b1f: Expected O, but got I
			//IL_2b2d: Expected I, but got O
			//IL_2da0: Expected F4, but got O
			//IL_287c: Expected O, but got I
			//IL_2c87: Expected F4, but got O
			//IL_2c95: Expected I, but got O
			//IL_2c9b: Expected O, but got I
		...
		private unsafe void ReadAnimation(Dictionary<string, object> map, string name, SkeletonData skeletonData)
		{
			...
			//IL_465b: Expected O, but got I4
			//IL_3117: Expected O, but got I
			//IL_4712: Expected O, but got F4
			//IL_3172: Expected O, but got I4
			//IL_4041: Expected F4, but got O
			//IL_40af: Expected F4, but got O
		...
		private static float[] GetFloatArray(Dictionary<string, object> map, string name, float scale)
		{
			...
			//IL_0100: Expected F4, but got O
			//IL_0111: Expected F4, but got O
			object obj = map[name];
