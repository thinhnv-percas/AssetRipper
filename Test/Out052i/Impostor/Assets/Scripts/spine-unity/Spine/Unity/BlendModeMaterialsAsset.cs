		...
		private class AtlasMaterialCache : IDisposable
		{
			...
			private AtlasPage GetAtlasPageWithMaterial(AtlasPage originalPage, Material materialTemplate)
			{
				if (originalPage != null)
				{
					...
					Cpp2ILHelpers.NoteDecompilerIssue("Method not found @133C218 (System.Collections.Generic.Dictionary`2::TryGetValue, and 1 more at this address)");
					...
					if (!flag2)
					{
						...
						Cpp2ILHelpers.NoteDecompilerIssue("Method not found @133AAF0 (System.Collections.Generic.Dictionary`2::Add, and 1 more at this address)");
					}
					return atlasPage2;
				}
