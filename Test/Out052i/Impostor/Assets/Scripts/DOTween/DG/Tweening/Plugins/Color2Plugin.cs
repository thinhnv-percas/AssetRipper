...
namespace DG.Tweening.Plugins
{
	...
	internal class Color2Plugin : ABSTweenPlugin<Color2, Color2, ColorOptions>
	{
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv147 = DG.Tweening.Core.DOGetter`1<DG.Tweening.Color2>::Invoke(t.getter);\n\tt.endValue = v146;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+154]) = v150;\n\tv154 = isRelative == 0;\n\tif (v154) goto L_FFFFFFFF;\n\tv267 = t.endValue + t.endValue;\n\tv268 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+148]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+148]);\n\tv85 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+14C]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+14C]);\n\tv82 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+150]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+150]);\n\tv79 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+154]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+154]);\n\tv76 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+158]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+158]);\n\tv73 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+15C]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+15C]);\n\tv70 = *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+160]) + *([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+160]);\n\tgoto L_004D;\nL_004D:\n\t// 77 MakeStruct v46 @ AGGC213DC_1_v2 (UnityEngine.Color), typeof(UnityEngine.Color), v267 @ V0_v3 (DG.Tweening.Color2), v268 @ V1_v3, v85 @ V2_v2, v82 @ V3_v2\n\t// 78 MakeStruct v43 @ AGGC213DC_2_v2 (UnityEngine.Color), typeof(UnityEngine.Color), v79 @ V4_v2, v76 @ V5_v2, v73 @ V6_v2, v70 @ V7_v2\n\tDG.Tweening.Color2::.ctor(v125, v46, v43);\n\tt.startValue = v175;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+134]) = v88;\n\tv282 = t.plugOptions == 0;\n\tif (v282) goto L_006A;\n\tgoto L_006E;\nL_006A:\n\t;\nL_006E:\n\t;\n\tDG.Tweening.Core.DOSetter`1<DG.Tweening.Color2>::Invoke(t.setter, &v146 @ stack_-B0_v2 (DG.Tweening.Color2));\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 124 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public unsafe override void SetFrom(TweenerCore<Color2, Color2, ColorOptions> t, bool isRelative)
		{
			...
			//IL_0218: Expected F4, but got O
			//IL_0225: Expected F4, but got O
			//IL_0232: Expected F4, but got O
			//IL_023f: Expected F4, but got O
			//IL_024c: Expected F4, but got O
			//IL_0259: Expected F4, but got O
			//IL_0266: Expected F4, but got O
			//IL_0273: Expected F4, but got O
			...
			if (isRelative)
			{
				...
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+158]");
				obj6 = num5 + 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+15C]");
				nint num6 = 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+15C]");
				obj7 = num6 + 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+160]");
				nint num7 = 0;
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+160]");
				obj8 = num7 + 0;
				int num8 = 0;
			...
			cb.b = (float)obj7;
			cb.a = (float)obj8;
			*(Color2*)(nint)color2 = new Color2(ca, cb);
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv7 = t.endValue;\n\tv7 = t.startValue;\n\tv21 = DG.Tweening.Color2::op_Addition(&v7 @ V1_v1 (DG.Tweening.Color2), &v7 @ V1_v1 (DG.Tweening.Color2));\n\tt.endValue = v21.ca;\n\t*([t @ X1 (DG.Tweening.Core.TweenerCore`3<DG.Tweening.Color2, DG.Tweening.Color2, DG.Tweening.Plugins.Options.ColorOptions>)+154]) = v21.cb;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 32 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
