...
namespace DG.Tweening.Plugins.Core.PathCore
{
	...
	public struct ControlPoint
	{
		...
		public unsafe override string ToString()
		{
			...
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BEEA54 (inside CodeStage.AntiCheat.Genuine.CodeHash.AndroidWorker+CodeHashGeneratorCallback::OnError +0x540)");
