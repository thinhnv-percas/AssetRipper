...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredQuaternion : IObscuredType
	{
		...
		{
			Quaternion quaternion = InternalDecrypt();
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BEE544 (inside CodeStage.AntiCheat.Genuine.CodeHash.AndroidWorker+CodeHashGeneratorCallback::OnError +0x30)");
