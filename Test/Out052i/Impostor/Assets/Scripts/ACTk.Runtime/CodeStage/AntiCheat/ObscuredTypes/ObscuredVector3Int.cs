...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredVector3Int : IObscuredType
	{
		...
		{
			Vector3Int vector3Int = InternalDecrypt();
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BEEC1C (inside CodeStage.AntiCheat.Genuine.CodeHash.AndroidWorker+CodeHashGeneratorCallback::OnError +0x708)");
