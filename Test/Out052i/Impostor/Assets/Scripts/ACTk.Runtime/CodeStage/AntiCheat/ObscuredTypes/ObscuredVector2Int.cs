...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredVector2Int : IObscuredType
	{
		...
		{
			Vector2Int vector2Int = InternalDecrypt();
			Cpp2ILHelpers.NoteDecompilerIssue("Method not found @BEE8D4 (inside CodeStage.AntiCheat.Genuine.CodeHash.AndroidWorker+CodeHashGeneratorCallback::OnError +0x3C0)");
