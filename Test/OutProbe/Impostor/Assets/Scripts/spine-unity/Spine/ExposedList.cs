...
namespace Spine
{
	...
	public class ExposedList<T> : IEnumerable<T>, IEnumerable
	{
		...
		public struct Enumerator : IEnumerator<T>, IEnumerator, IDisposable
		{
			...
			private unsafe void VerifyState()
			{
				...
				else
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @9E5D78");
		...
		public ExposedList<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
		{
			...
			//IL_0224: Expected I4, but got I8
		...
		public void Insert(int index, T item)
		{
			...
			Il2CppRuntime.Boundary("MANAGED", "Method not found @F4741C (Spine.ExposedList`1::Shift, and 1 more at this address)");
			int num = (int)((nint)item & 1);
			object obj = (nint)Items + index;
			int num2 = version + 1;
			version = num2;
