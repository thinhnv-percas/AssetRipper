...
namespace CodeStage.AntiCheat.ObscuredTypes
{
	...
	public struct ObscuredVector2 : IObscuredType
	{
		...
		{
			Vector2 vector = InternalDecrypt();
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @BEE74C (inside CodeStage.AntiCheat.Genuine.CodeHash.AndroidWorker+CodeHashGeneratorCallback::OnError +0x238)");
