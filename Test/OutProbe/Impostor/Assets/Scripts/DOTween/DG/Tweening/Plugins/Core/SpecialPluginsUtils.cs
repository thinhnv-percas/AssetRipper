...
namespace DG.Tweening.Plugins.Core
{
	...
	internal static class SpecialPluginsUtils
	{
		...
		internal static bool SetLookAt(TweenerCore<Quaternion, Vector3, QuaternionOptions> t)
		{
			...
			float y = t.endValue.y - position.y;
			float z = t.endValue.z - position.z;
			float x;
			if (t.plugOptions.axisConstraint != AxisConstraint.X)
			{
				bool flag = t.plugOptions.axisConstraint == AxisConstraint.Y;
