...
namespace DG.Tweening.Plugins
{
	...
	public class RectPlugin : ABSTweenPlugin<Rect, Rect, RectOptions>
	{
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_001E;\n\tv32 = System.Math;\n\tv33 = \"il2cpp_codegen_initialize_runtime_metadata\"(v32, t, isRelative, methodInfo, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46);\n\tv50 = 1;\n\t*([1A35778]) = v50;\nL_001E:\n\tv55 = t.getter;\n\tv131 = DG.Tweening.Core.DOGetter`1<UnityEngine.Rect>::Invoke(t.getter);\n\tt.endValue.m_XMin = t.endValue;\n\tt.endValue.m_YMin = v40;\n\tt.endValue.m_Width = v41;\n\tt.endValue.m_Height = v42;\n\tt.startValue = t.endValue;\n\tv135 = isRelative == 0;\n\tif (v135) goto L_003D;\n\tv113 = t.startValue;\n\tv140 = t.startValue + t.endValue;\n\tv205 = t.startValue.m_YMin + v40;\n\tv204 = t.startValue.m_Width + v41;\n\tv203 = t.startValue.m_Height + v42;\n\tt.startValue.m_XMin = v140;\n\tt.startValue.m_YMin = v205;\n\tt.startValue.m_Width = v204;\n\tt.startValue.m_Height = v203;\n\tgoto L_0041;\nL_003D:\n\tv205 = t.startValue.m_YMin;\n\tv204 = t.startValue.m_Width;\n\tv203 = t.startValue.m_Height;\nL_0041:\n\tv208 = t.plugOptions == 0;\n\tif (v208) goto L_014B;\n\tgoto L_004E;\n\tv240 = \"il2cpp_codegen_runtime_class_init\"(v211, v115, isRelative, methodInfo, v35, v36, v37, v38, v53, v40, v41, v42, v113, v111, v109, v107);\nL_004E:\n\tv246 = 0x1854ED0(&v244 @ stack_-58_v3 (System.Double), v55.method, isRelative, methodInfo, v35, v36, v37, v38, v105, v40, v41, v42, v113, t.startValue.m_YMin, t.startValue.m_Width, t.startValue.m_Height);\n\tv256 = v105 >= 0;\n\tif (v256) goto L_0073;\n\tv267 = v105 != -0.5d;\n\tif (v267) goto L_0085;\n\tgoto L_0078;\nL_0073:\n\tv278 = v105 != 0.5d;\n\tif (v278) goto L_0088;\nL_0078:\n\tv307 = v297 + v287;\n\tv300 = v297 & 1;\n\tv302 = v300 == 0;\n\tv305 = ~v302;\n\tif (v305) goto L_FFFFFFFF;\n\tgoto L_0084;\nL_0084:\n\tgoto L_008D;\nL_0085:\n\tv281 = v105 + -0.5d;\n\tv229 = System.Math::Ceiling(v281);\n\tgoto L_008D;\nL_0088:\n\tv285 = v105 + 0.5d;\n\tv229 = System.Math::Floor(v285);\nL_008D:\n\tv325 = 0x1854ED0(&v244 @ stack_-58_v3 (System.Double), v55.method, isRelative, methodInfo, v35, v36, v37, v38, v205, v307, v41, v42, v113, t.startValue.m_YMin, t.startValue.m_Width, t.startValue.m_Height);\n\tv337 = v205 >= 0;\n\tif (v337) goto L_00B2;\n\tv348 = v205 != -0.5d;\n\tif (v348) goto L_00C4;\n\tgoto L_00B7;\nL_00B2:\n\tv359 = v205 != 0.5d;\n\tif (v359) goto L_00C7;\nL_00B7:\n\tv389 = v378 + v368;\n\tv381 = v378 & 1;\n\tv383 = v381 == 0;\n\tv386 = ~v383;\n\tif (v386) goto L_FFFFFFFF;\n\tgoto L_00C3;\nL_00C3:\n\tgoto L_00CC;\nL_00C4:\n\tv362 = v205 + -0.5d;\n\tv217 = System.Math::Ceiling(v362);\n\tgoto L_00CC;\nL_00C7:\n\tv366 = v205 + 0.5d;\n\tv217 = System.Math::Floor(v366);\nL_00CC:\n\tv406 = 0x1854ED0(&v244 @ stack_-58_v3 (System.Double), v55.method, isRelative, methodInfo, v35, v36, v37, v38, v204, v389, v41, v42, v113, t.startValue.m_YMin, t.startValue.m_Width, t.startValue.m_Height);\n\tv418 = v204 >= 0;\n\tif (v418) goto L_00F1;\n\tv429 = v204 != -0.5d;\n\tif (v429) goto L_0103;\n\tgoto L_00F6;\nL_00F1:\n\tv440 = v204 != 0.5d;\n\tif (v440) goto L_0106;\nL_00F6:\n\tv470 = v459 + v449;\n\tv462 = v459 & 1;\n\tv464 = v462 == 0;\n\tv467 = ~v464;\n\tif (v467) goto L_FFFFFFFF;\n\tgoto L_0102;\nL_0102:\n\tgoto L_010B;\nL_0103:\n\tv443 = v204 + -0.5d;\n\tv216 = System.Math::Ceiling(v443);\n\tgoto L_010B;\nL_0106:\n\tv447 = v204 + 0.5d;\n\tv216 = System.Math::Floor(v447);\nL_010B:\n\tv235 = 0x1854ED0(&v244 @ stack_-58_v3 (System.Double), v55.method, isRelative, methodInfo, v35, v36, v37, v38, v203, v470, v41, v42, v113, t.startValue.m_YMin, t.startValue.m_Width, t.startValue.m_Height);\n\tv497 = v203 >= 0;\n\tif (v497) goto L_0130;\n\tv508 = v203 != -0.5d;\n\tif (v508) goto L_0142;\n\tgoto L_0135;\nL_0130:\n\tv519 = v203 != 0.5d;\n\tif (v519) goto L_0145;\nL_0135:\n\tv540 = v234 + v528;\n\tv541 = v234 & 1;\n\tv543 = v541 == 0;\n\tv546 = ~v543;\n\tif (v546) goto L_FFFFFFFF;\n\tgoto L_0141;\nL_0141:\n\tgoto L_FFFFFFFF;\nL_0142:\n\tv522 = v203 + -0.5d;\n\tv234 = System.Math::Ceiling(v522);\n\tgoto L_FFFFFFFF;\nL_0145:\n\tv526 = v203 + 0.5d;\n\tv234 = System.Math::Floor(v526);\nL_014B:\n\tv128 = t.setter;\n\tDG.Tweening.Core.DOSetter`1<UnityEngine.Rect>::Invoke(t.setter, v128.method);\n\tthrow System.NullReferenceException;\n\treturn;\n// 241 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetFrom(TweenerCore<Rect, Rect, RectOptions> t, bool isRelative)
		{
			...
			//IL_06fb: Expected I4, but got Unknown
			//IL_0740: Unknown result type (might be due to invalid IL or missing references)
			//IL_0745: Expected I4, but got Unknown
			//IL_078a: Unknown result type (might be due to invalid IL or missing references)
			//IL_078f: Expected I4, but got Unknown
			//IL_07d4: Unknown result type (might be due to invalid IL or missing references)
			//IL_07d9: Expected I4, but got Unknown
			DOGetter<Rect> getter = t.getter;
			object obj = t.getter();
			t.endValue.m_XMin = t.endValue.m_XMin;
			float num = default(float);
			t.endValue.m_YMin = num;
			float num2 = default(float);
			t.endValue.m_Width = num2;
			float num3 = default(float);
			t.endValue.m_Height = num3;
			t.startValue = t.endValue;
			float num7;
			float num6;
			float num5;
			...
			if (isRelative)
			{
				...
				float num4 = t.startValue.m_XMin + t.endValue.m_XMin;
				num5 = t.startValue.m_YMin + num;
				num6 = t.startValue.m_Width + num2;
				num7 = t.startValue.m_Height + num3;
				t.startValue.m_XMin = num4;
				t.startValue.m_YMin = num5;
				t.startValue.m_Width = num6;
				t.startValue.m_Height = num7;
				num8 = num4;
			}
			else
			{
				num5 = t.startValue.m_YMin;
				num6 = t.startValue.m_Width;
				num7 = t.startValue.m_Height;
				num8 = t.startValue.m_XMin;
		...
		public override void SetFrom(TweenerCore<Rect, Rect, RectOptions> t, Rect fromValue, bool setImmediately, bool isRelative)
		{
			...
			//IL_06e4: Expected I4, but got Unknown
			//IL_0729: Unknown result type (might be due to invalid IL or missing references)
			//IL_072e: Expected I4, but got Unknown
			//IL_0773: Unknown result type (might be due to invalid IL or missing references)
			//IL_0778: Expected I4, but got Unknown
			//IL_0663: Expected O, but got F8
			//IL_07bd: Unknown result type (might be due to invalid IL or missing references)
			//IL_07c2: Expected I4, but got Unknown
			Rect rect2;
			float num3;
			float num4;
			float num5;
			...
			t.startValue.m_XMin = rect2.m_XMin;
			t.startValue.m_YMin = num3;
			t.startValue.m_Width = num4;
			t.startValue.m_Height = num5;
			if (!setImmediately)
			{
				return;
			}
			...
			if ((object)t.plugOptions != null)
			{
				...
				if (rect2.m_XMin < 0f)
				{
					if ((double)rect2.m_XMin != -0.5)
					{
						double a = (double)rect2.m_XMin + -0.5;
						num6 = Math.Ceiling(a);
						num7 = -0.5;
						goto IL_02ea;
					}
				...
				else
				{
					if ((double)rect2.m_XMin != 0.5)
					{
						double d = (double)rect2.m_XMin + 0.5;
						num6 = Math.Floor(d);
						num7 = 0.5;
						goto IL_02ea;
					}
		...
		public override void EvaluateAndApply(RectOptions options, Tween t, bool isRelative, DOGetter<Rect> getter, DOSetter<Rect> setter, float elapsed, Rect startValue, Rect changeValue, float duration, bool usingInversePosition, int newCompletedSteps, UpdateNotice updateNotice)
		{
			...
			//IL_0822: Expected I4, but got Unknown
			//IL_0867: Unknown result type (might be due to invalid IL or missing references)
			//IL_086c: Expected I4, but got Unknown
