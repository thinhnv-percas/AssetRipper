...
namespace DG.Tweening.Core
{
	...
	public class TweenerCore<T1, T2, TPlugOptions> : Tweener where TPlugOptions : struct, IPlugOptions
	{
			...
			else
			{
				...
				if ((object)type == this.typeofT2)
				{
					...
					if (val != null)
					{
						...
						Il2CppRuntime.Boundary("MANAGED", "Method not found @CC13E0 (DG.Tweening.Tweener::DoChangeStartValue, and 1 more at this address)");
		...
		public override Tweener ChangeEndValue(object newEndValue, float newDuration = -1f, bool snapStartValue = false)
		{
			...
			else
			{
				...
				if ((object)type == this.typeofT2)
				{
					...
					{
						Il2CppRuntime.Boundary("UNKNOWN", "Unknown call target operand: \"il2cpp_vm_object_unbox\"");
						Il2CppRuntime.Boundary("MANAGED", "Method not found @CBD81C (DG.Tweening.Tweener::DoChangeEndValue, and 1 more at this address)");
						Tweener result = default(Tweener);
						return result;
					}
					goto IL_0311;
		...
		public override Tweener ChangeValues(object newStartValue, object newEndValue, float newDuration = -1f)
		{
			...
			//IL_03f5: Expected I4, but got Unknown
			//IL_0403: Expected I4, but got O
			//IL_041f: Expected I4, but got O
				...
				if ((object)type5 == null)
				{
					...
					if ((object)type2 == null)
					{
						...
						if ((object)color2 != null)
						{
							...
							{
								Il2CppRuntime.Boundary("UNKNOWN", "Unknown call target operand: \"il2cpp_vm_object_unbox\"");
								Il2CppRuntime.Boundary("MANAGED", "Method not found @CC2628 (DG.Tweening.Tweener::DoChangeValues, and 1 more at this address)");
		...
		public TweenerCore<T1, T2, TPlugOptions> ChangeEndValue(T2 newEndValue, bool snapStartValue)
		{
			...
			object obj2 = 0;
			Il2CppRuntime.Boundary("MANAGED", "Method not found @11CD3E8 (DG.Tweening.Core.TweenerCore`3::ChangeEndValue, and 1 more at this address)");
			TweenerCore<T1, T2, TPlugOptions> result = default(TweenerCore<T1, T2, TPlugOptions>);
			return result;
		}
