	...
	public class StringPlugin : ABSTweenPlugin<string, string, StringOptions>
	{
		...
		public override void SetChangeValue(TweenerCore<string, string, StringOptions> t)
		{
			...
			else
			{
				...
				startValueStrippedLength = text.Length;
			}
			t.plugOptions.startValueStrippedLength = startValueStrippedLength;
			...
			else
			{
				...
				changeValueStrippedLength = text2.Length;
			}
			t.plugOptions.changeValueStrippedLength = changeValueStrippedLength;
			int num;
			int num2;
			if (flag)
			{
			...
			else
			{
				...
				num = startValue.Length;
				bool flag5 = !flag2;
				num2 = startValue.Length;
				if (flag5)
				{
					goto IL_0123;
				}
			...
			if (num2 >= 4)
			{
				...
				if (num4 == 62)
				{
					...
					do
					{
						...
						if (num8 != 47)
						{
							int startValueStrippedLength2 = t.plugOptions.startValueStrippedLength + 1;
							t.plugOptions.startValueStrippedLength = startValueStrippedLength2;
						}
						break;
					}
					while (flag6);
			...
			if (num13 != 47)
			{
				int changeValueStrippedLength2 = t.plugOptions.changeValueStrippedLength + 1;
				t.plugOptions.changeValueStrippedLength = changeValueStrippedLength2;
			}
			return;
			IL_0123:
			string changeValue = t.changeValue;
			num3 = changeValue.Length;
			num2 = num;
			goto IL_04bc;
		}
		...
		public unsafe override void EvaluateAndApply(StringOptions options, Tween t, bool isRelative, DOGetter<string> getter, DOSetter<string> setter, float elapsed, string startValue, string changeValue, float duration, bool usingInversePosition, int newCompletedSteps, UpdateNotice updateNotice)
		{
			...
			//IL_06c0: Expected I4, but got Unknown
			//IL_017c: Expected O, but got I4
			//IL_06f6: Expected O, but got F8
			//IL_06ff: Unknown result type (might be due to invalid IL or missing references)
			//IL_0704: Expected I4, but got Unknown
			//IL_0745: Unknown result type (might be due to invalid IL or missing references)
			//IL_074a: Expected I4, but got Unknown
			//IL_0757: Expected O, but got F8
			...
			//IL_0527: Expected F8, but got I4
