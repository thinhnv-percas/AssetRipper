...
namespace DG.Tweening.Plugins
{
	...
	public class PathPlugin : ABSTweenPlugin<Vector3, Path, PathOptions>
	{
		...
		public override void SetChangeValue(TweenerCore<Vector3, Path, PathOptions> t)
		{
			...
			//IL_01fc: Expected F4, but got I
			//IL_0211: Expected F4, but got I
			//IL_0226: Expected F4, but got I
			...
			//IL_058b: Expected I4, but got I8
			...
			t.endValue.FinalizePath(t.plugOptions.isClosedPath, t.plugOptions.lockPositionAxis, currTargetVal);
