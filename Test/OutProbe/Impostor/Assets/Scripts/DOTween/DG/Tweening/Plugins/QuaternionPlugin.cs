...
namespace DG.Tweening.Plugins
{
	...
	public class QuaternionPlugin : ABSTweenPlugin<Quaternion, Vector3, QuaternionOptions>
	{
		...
		public override void SetFrom(TweenerCore<Quaternion, Vector3, QuaternionOptions> t, bool isRelative)
		{
			...
			euler.y = y;
			euler.z = z;
			Vector3 counterVal = Quaternion.Internal_MakePositive(euler);
			bool flag = (nint)tweenerCore.plugOptions == 1;
			tweenerCore.endValue.x = counterVal.x;
			tweenerCore.endValue.y = counterVal.y;
			tweenerCore.endValue.z = counterVal.z;
			Vector3 vector5;
			float y4;
			float z7;
			float z9;
			...
			if (!flag)
			{
				...
				if ((object)tweenerCore.plugOptions != null || tweenerCore._003CisRelative_003Ek__BackingField)
				{
					...
					if ((nint)tweenerCore.plugOptions == 2)
					{
						...
						rotation2.x = counterVal.x;
						rotation2.y = counterVal.y;
						rotation2.z = counterVal.z;
						rotation2.w = counterVal.x;
						Quaternion quaternion = Quaternion.Inverse(rotation2);
						float num = counterVal.x * quaternion.x;
						float num2 = counterVal.x * quaternion.w;
						float num3 = counterVal.x * quaternion.y;
						float num4 = counterVal.y * quaternion.w;
						float num5 = num + num2;
						float num6 = counterVal.x * quaternion.z;
						float num7 = num3 + num4;
						float num8 = counterVal.z * quaternion.w;
						float num9 = counterVal.x * quaternion.w;
						float num10 = num6 + num8;
						float num11 = counterVal.x * quaternion.x;
						float num12 = num9 - num11;
						float num13 = counterVal.y * quaternion.z;
						float num14 = num13 + num5;
						float num15 = counterVal.z * quaternion.x;
						float num16 = num15 + num7;
						float num17 = counterVal.x * quaternion.y;
						float num18 = num17 + num10;
						float num19 = counterVal.z * quaternion.y;
						float num20 = counterVal.y * quaternion.y;
						float num21 = num12 - num20;
						float num22 = counterVal.x * quaternion.z;
						float num23 = counterVal.z * quaternion.z;
						float num24 = num16 - num22;
						float num25 = num14 - num19;
						float num26 = num21 - num23;
						float num27 = counterVal.y * quaternion.x;
						...
						float z2 = tweenerCore.endValue.z * ((float)Math.PI / 180f);
						float num28 = num18 - num27;
						Vector3 vector2 = default(Vector3);
						vector2.x = x2;
						vector2.y = num29;
						vector2.z = z2;
						Quaternion quaternion2 = Quaternion.Euler(vector2 * 57.29578f);
						...
						num56 = num52 - num45;
						num57 = num53 - num38;
						float num58 = counterVal.x * num56;
						float num59 = counterVal.x * num54;
						float num60 = counterVal.y * num56;
						float num61 = counterVal.x * num55;
						float num62 = counterVal.z * num55;
						float num63 = counterVal.x * num57;
						float num64 = num58 + num59;
						float num65 = counterVal.z * num56;
						float num66 = num60 + num61;
						float num67 = counterVal.x * num57;
						float num68 = counterVal.y * num57;
						float num69 = counterVal.z * num54;
						float num70 = num65 + num67;
						float num71 = counterVal.y * num54;
						float num72 = num62 + num64;
						float num73 = num63 + num66;
						num74 = num71 + num70;
						x3 = num72 - num68;
						y2 = num73 - num69;
						num75 = counterVal.x * num55;
						z3 = counterVal.z;
					...
					{
						Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"Instruction DUP not yet implemented.\"");
						float x4 = tweenerCore.endValue.x * counterVal.x;
						float z4 = tweenerCore.endValue.z * ((float)Math.PI / 180f);
						Vector3 vector3 = default(Vector3);
						vector3.x = x4;
						vector3.y = num29;
						vector3.z = z4;
						quaternion3 = Quaternion.Euler(vector3 * 57.29578f);
						num55 = quaternion3.y;
						num57 = quaternion3.z;
						num56 = quaternion3.w;
						float num76 = counterVal.x * quaternion3.x;
						float num77 = counterVal.x * quaternion3.w;
						float num78 = counterVal.x * quaternion3.y;
						float num79 = counterVal.y * quaternion3.w;
						float num80 = num76 + num77;
						float num81 = counterVal.x * quaternion3.z;
						float num82 = num78 + num79;
						float num83 = counterVal.z * quaternion3.w;
						float num84 = num81 + num83;
						float num85 = counterVal.y * quaternion3.z;
						float num86 = num85 + num80;
						float num87 = counterVal.z * quaternion3.x;
						float num88 = num87 + num82;
						float num89 = counterVal.x * quaternion3.y;
						num74 = num89 + num84;
						float num90 = counterVal.z * quaternion3.y;
						x3 = num86 - num90;
						float num91 = counterVal.x * quaternion3.z;
						y2 = num88 - num91;
						num75 = counterVal.y * quaternion3.x;
						z3 = counterVal.z;
					}
					float num92 = counterVal.x * num56;
					float num93 = counterVal.x * quaternion3.x;
					float num94 = counterVal.y * num55;
					...
					float x5 = vector4.x * 57.29578f;
					float y3 = vector4.y * 57.29578f;
					float z6 = vector4.z * 57.29578f;
					Vector3 euler2 = default(Vector3);
					euler2.x = x5;
					euler2.y = y3;
					euler2.z = z6;
					vector5 = Quaternion.Internal_MakePositive(euler2);
					y4 = vector5.y;
					z7 = vector5.z;
					z8 = 0f - tweenerCore.endValue.z;
					tweenerCore.startValue.x = vector5.x;
					tweenerCore.startValue.y = vector5.y;
					Cpp2ILHelpers.NoteDecompilerIssue("Not implemented instruction: \"Instruction UNIMPLEMENTED not yet implemented.\"");
					tweenerCore.startValue.z = vector5.z;
					tweenerCore.endValue = tweenerCore.endValue;
					tweenerCore.endValue.z = z8;
					goto IL_0df9;
				}
				z9 = tweenerCore.endValue.z;
				y5 = num29;
				x6 = tweenerCore.endValue.x;
			}
			else
			{
				z9 = tweenerCore.endValue.z + counterVal.z;
				x6 = tweenerCore.endValue.x + counterVal.x;
				object obj6 = default(object);
				y5 = (float)obj6 + counterVal.y;
			}
			Vector3 val = default(Vector3);
			val.x = x6;
			val.y = y5;
			val.z = z9;
			vector5 = GetEulerValForCalculations(tweenerCore, val, counterVal);
			y4 = vector5.y;
			z7 = vector5.z;
			tweenerCore.startValue.x = vector5.x;
			tweenerCore.startValue.y = vector5.y;
			...
			float x7 = vector5.x * ((float)Math.PI / 180f);
			float y6 = y4 * ((float)Math.PI / 180f);
			float z10 = z7 * ((float)Math.PI / 180f);
		...
		public override void SetFrom(TweenerCore<Quaternion, Vector3, QuaternionOptions> t, Vector3 fromValue, bool setImmediately, bool isRelative)
		{
			...
			if (isRelative)
			{
				...
				float z2 = vector3.z + t.endValue.z;
				t.endValue = (Vector3)num3;
				t.endValue.z = z2;
				num4 = fromValue.z + vector3.z;
				vector4 = (Vector3)num;
			}
			else
			{
			...
			val.y = num2;
			val.z = num4;
			Vector3 counterVal = default(Vector3);
			counterVal.x = t.endValue.x;
			counterVal.y = t.endValue.y;
			counterVal.z = t.endValue.z;
			Vector3 eulerValForCalculations = GetEulerValForCalculations(t, val, counterVal);
			t.startValue.x = eulerValForCalculations.x;
			t.startValue.y = eulerValForCalculations.y;
			t.startValue.z = eulerValForCalculations.z;
			if (setImmediately)
			{
				DOSetter<Quaternion> setter = t.setter;
				float x2 = vector4.x * ((float)Math.PI / 180f);
				float y2 = num2 * ((float)Math.PI / 180f);
				float z3 = num4 * ((float)Math.PI / 180f);
				Vector3 vector5 = default(Vector3);
				vector5.x = x2;
				vector5.y = y2;
				vector5.z = z3;
				Quaternion quaternion = Quaternion.Euler(vector5 * 57.29578f);
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv230 = v62.endValue;\n\tv253 = v62.endValue.y;\n\tv200 = v62.endValue.z;\n\tv25 = ~v62.isFrom;\n\tv26 = ~v25;\n\tif (v26) goto L_002B;\n\t// 27 MakeStruct v50 @ AGGC25B48_2_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), v62.endValue (UnityEngine.Vector3), v62.endValue.y (System.Single), v62.endValue.z (System.Single)\n\t// 28 MakeStruct v51 @ AGGC25B48_3_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), v62.startValue (UnityEngine.Vector3), v62.startValue.y (System.Single), v62.startValue.z (System.Single)\n\tv52 = DG.Tweening.Plugins.QuaternionPlugin::GetEulerValForCalculations(this, v62, v50, v51);\nL_002B:\n\tv80 = v62.plugOptions == 1;\n\tif (v80) goto L_013C;\n\tv85 = v62.plugOptions == 0;\n\tv86 = ~v85;\n\tif (v86) goto L_013A;\n\tv177 = ~v62.<isRelative>k__BackingField;\n\tv92 = ~v177;\n\tif (v92) goto L_013C;\n\tv210 = 0x1854EF0(this, v62, methodInfo, v30, v31, v32, v33, v34, v230, 0x43B40000, v52.z, v62.startValue, v62.startValue.y, v62.startValue.z, v41, v42);\n\tv213 = v230 - 0x43B40000;\n\tv214 = v213 < 0;\n\tv215 = v213 == 0;\n\tv216 = v230 ^ 0x43B40000;\n\tv217 = v230 ^ v213;\n\tv218 = v216 & v217;\n\tv219 = v218 < 0;\n\tv220 = v230 >= 0x43B40000;\n\tif (v220) goto L_FFFFFFFF;\n\tgoto L_004C;\nL_004C:\n\tv224 = v214 == v219;\n\tv225 = ~v215;\n\tv226 = v224 & v225;\n\tv227 = ~v226;\n\tif (v227) goto L_FFFFFFFF;\n\tgoto L_0057;\nL_0057:\n\tv233 = 0x1854EF0(v210, v62, methodInfo, v30, v31, v32, v33, v34, v253, 0x43B40000, v52.z, v62.startValue, v62.startValue.y, v62.startValue.z, v41, v42);\n\tv236 = v253 - 0x43B40000;\n\tv237 = v236 < 0;\n\tv238 = v236 == 0;\n\tv239 = v253 ^ 0x43B40000;\n\tv240 = v253 ^ v236;\n\tv241 = v239 & v240;\n\tv242 = v241 < 0;\n\tv243 = v253 >= 0x43B40000;\n\tif (v243) goto L_FFFFFFFF;\n\tgoto L_0067;\nL_0067:\n\tv247 = v237 == v242;\n\tv248 = ~v238;\n\tv249 = v247 & v248;\n\tv250 = ~v249;\n\tif (v250) goto L_FFFFFFFF;\n\tgoto L_0072;\nL_0072:\n\tv192 = 0x1854EF0(v233, v62, methodInfo, v30, v31, v32, v33, v34, v200, 0x43B40000, v52.z, v62.startValue, v62.startValue.y, v62.startValue.z, v41, v42);\n\tv258 = v200 - 0x43B40000;\n\tv259 = v258 < 0;\n\tv260 = v258 == 0;\n\tv261 = v200 ^ 0x43B40000;\n\tv262 = v200 ^ v258;\n\tv263 = v261 & v262;\n\tv264 = v263 < 0;\n\tv265 = v230 - v62.startValue;\n\tv266 = v200 >= 0x43B40000;\n\tif (v266) goto L_FFFFFFFF;\n\tgoto L_0083;\nL_0083:\n\tv270 = -v265;\n\tv271 = v259 == v264;\n\tv272 = ~v260;\n\tv273 = v271 & v272;\n\tv274 = ~v273;\n\tif (v274) goto L_FFFFFFFF;\n\tgoto L_0090;\nL_0090:\n\tv281 = v265 < 0;\n\tv282 = v265 == 0;\n\tv284 = v265 ^ v265;\n\tv285 = v265 & v284;\n\tv286 = v285 < 0;\n\tv288 = v281 == v286;\n\tv289 = ~v282;\n\tv290 = v288 & v289;\n\tv291 = ~v290;\n\tif (v291) goto L_FFFFFFFF;\n\tgoto L_00A1;\nL_00A1:\n\tv296 = v253 - v62.startValue.y;\n\tv310 = v294 <= 0x43340000;\n\tif (v310) goto L_00C8;\n\tv313 = 0x43B40000 - v294;\n\tv314 = -v313;\n\tv318 = v265 < 0;\n\tv319 = v265 == 0;\n\tv321 = v265 ^ v265;\n\tv322 = v265 & v321;\n\tv323 = v322 < 0;\n\tv324 = v318 == v323;\n\tv325 = ~v319;\n\tv326 = v324 & v325;\n\tv327 = ~v326;\n\tif (v327) goto L_FFFFFFFF;\n\tgoto L_FFFFFFFF;\nL_00C8:\n\tv364 = -v296;\n\tv349 = v296 < 0;\n\tv350 = v296 == 0;\n\tv352 = v296 ^ v296;\n\tv353 = v296 & v352;\n\tv354 = v353 < 0;\n\tv356 = v349 == v354;\n\tv357 = ~v350;\n\tv358 = v356 & v357;\n\tv359 = ~v358;\n\tif (v359) goto L_00E6;\n\tgoto L_00E6;\nL_00E6:\n\tv197 = v277 - v62.startValue.z;\n\tv377 = v364 <= 0x43340000;\n\tif (v377) goto L_0102;\n\tv380 = 0x43B40000 - v364;\n\tv381 = -v380;\n\tv385 = v296 < 0;\n\tv386 = v296 == 0;\n\tv388 = v296 ^ v296;\n\tv389 = v296 & v388;\n\tv390 = v389 < 0;\n\tv391 = v385 == v390;\n\tv392 = ~v386;\n\tv393 = v391 & v392;\n\tv394 = ~v393;\n\tif (v394) goto L_FFFFFFFF;\n\tgoto L_FFFFFFFF;\nL_0102:\n\tv196 = -v197;\n\tv416 = v197 < 0;\n\tv417 = v197 == 0;\n\tv419 = v197 ^ v197;\n\tv420 = v197 & v419;\n\tv421 = v420 < 0;\n\tv422 = v416 == v421;\n\tv423 = ~v417;\n\tv424 = v422 & v423;\n\tv425 = ~v424;\n\tif (v425) goto L_011A;\n\tgoto L_011A;\nL_011A:\n\tv195 = 0x43B40000 - v196;\n\tv198 = -v195;\n\tv432 = v416 == v421;\n\tv433 = ~v417;\n\tv434 = v432 & v433;\n\tv435 = ~v434;\n\tif (v435) goto L_0128;\n\tgoto L_0128;\nL_0128:\n\tv190 = v196 - 0x43340000;\n\tv189 = v190 < 0;\n\tv188 = v190 == 0;\n\tv187 = v196 ^ 0x43340000;\n\tv186 = v196 ^ v190;\n\tv185 = v187 & v186;\n\tv184 = v185 < 0;\n\tv439 = v189 == v184;\n\tv181 = ~v188;\n\tv182 = v439 & v181;\n\tv183 = ~v182;\n\tif (v183) goto L_FFFFFFFF;\n\tgoto L_FFFFFFFF;\n\tgoto L_013F;\nL_013A:\n\tv91 = ~v62.<isRelative>k__BackingField;\n\tif (v91) goto L_013F;\nL_013C:\n\tv204 = v230 - v62.startValue;\n\tv253 = v253 - v62.startValue.y;\n\tv200 = v200 - v62.startValue.z;\nL_013F:\n\tv62.changeValue.x = v204;\n\tv62.changeValue.y = v253;\n\tv62.changeValue.z = v200;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 165 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Quaternion, Vector3, QuaternionOptions> t)
		{
			...
			//IL_0767: Expected O, but got F4
			//IL_0770: Unknown result type (might be due to invalid IL or missing references)
			//IL_0775: Expected I4, but got Unknown
			//IL_09e8: Expected O, but got F4
			//IL_09f1: Unknown result type (might be due to invalid IL or missing references)
			//IL_09f6: Expected I4, but got Unknown
			//IL_0309: Expected O, but got F4
			//IL_0312: Unknown result type (might be due to invalid IL or missing references)
			//IL_0317: Expected I4, but got Unknown
			//IL_0a7c: Expected O, but got F4
			//IL_0a85: Unknown result type (might be due to invalid IL or missing references)
			//IL_0a8a: Expected I4, but got Unknown
			//IL_03d4: Expected O, but got F4
			//IL_03dd: Unknown result type (might be due to invalid IL or missing references)
			//IL_03e2: Expected I4, but got Unknown
			//IL_08f6: Unknown result type (might be due to invalid IL or missing references)
			//IL_08fb: Expected I4, but got Unknown
			//IL_0908: Expected O, but got F4
			TweenerCore<Quaternion, Vector3, QuaternionOptions> tweenerCore = default(TweenerCore<Quaternion, Vector3, QuaternionOptions>);
			Vector3 vector = tweenerCore.endValue;
			float num = tweenerCore.endValue.y;
			float num2 = tweenerCore.endValue.z;
			if (!tweenerCore.isFrom)
			{
				Vector3 val = default(Vector3);
				val.x = tweenerCore.endValue.x;
				val.y = tweenerCore.endValue.y;
				val.z = tweenerCore.endValue.z;
				Vector3 counterVal = default(Vector3);
				counterVal.x = tweenerCore.startValue.x;
				counterVal.y = tweenerCore.startValue.y;
				counterVal.z = tweenerCore.startValue.z;
				Vector3 eulerValForCalculations = GetEulerValForCalculations(tweenerCore, val, counterVal);
			...
			if ((object)tweenerCore.plugOptions == null)
			{
				...
				float num19 = num - tweenerCore.startValue.y;
				bool flag21 = !(num18 > 180f);
				float num20 = num13;
				if (!flag21)
				{
					float num21 = 360f - num18;
					float num22 = 0f - num21;
					bool flag22 = num13 < 0f;
					bool flag23 = num13 == 0f;
					object obj8 = num13 ^ num13;
					int num23 = num13 & (nint)obj8;
					bool flag24 = num23 < 0;
					bool flag25 = flag22 == flag24;
					bool flag26 = !flag23;
					float num24 = ((!(flag25 && flag26)) ? num21 : num22);
					num20 = num24;
				}
				float num25 = 0f - num19;
				bool flag27 = num19 < 0f;
				bool flag28 = num19 == 0f;
				object obj9 = num19 ^ num19;
				int num26 = num19 & (nint)obj9;
				bool flag29 = num26 < 0;
				...
				float num27 = num16 - tweenerCore.startValue.z;
				bool flag32 = !(num25 > 180f);
				float num28 = num19;
				if (!flag32)
				{
					float num29 = 360f - num25;
					float num30 = 0f - num29;
					bool flag33 = num19 < 0f;
					bool flag34 = num19 == 0f;
					object obj10 = num19 ^ num19;
					int num31 = num19 & (nint)obj10;
					bool flag35 = num31 < 0;
					bool flag36 = flag33 == flag35;
					bool flag37 = !flag34;
					float num32 = ((!(flag36 && flag37)) ? num29 : num30);
					num28 = num32;
				}
				float num33 = 0f - num27;
				bool flag38 = num27 < 0f;
				bool flag39 = num27 == 0f;
				object obj11 = num27 ^ num27;
				int num34 = num27 & (nint)obj11;
				bool flag40 = num34 < 0;
				...
				float num37 = num33 - 180f;
				bool flag45 = num37 < 0f;
				bool flag46 = num37 == 0f;
				int num38 = num33 ^ 0x43340000;
				object obj12 = num33 ^ num37;
				int num39 = (int)(num38 & (nint)obj12);
				bool flag47 = num39 < 0;
				bool flag48 = flag45 == flag47;
				bool flag49 = !flag46;
				num2 = ((!(flag48 && flag49)) ? num27 : num35);
				num = num28;
				x = num20;
			}
			else
			{
				bool flag50 = !tweenerCore._003CisRelative_003Ek__BackingField;
				x = vector.x;
				if (!flag50)
				{
					goto IL_04a9;
			...
			goto IL_0979;
			IL_0979:
			tweenerCore.changeValue.x = x;
			tweenerCore.changeValue.y = num;
			tweenerCore.changeValue.z = num2;
			return;
			IL_04a9:
			x = vector.x - tweenerCore.startValue.x;
			num -= tweenerCore.startValue.y;
			num2 -= tweenerCore.startValue.z;
			goto IL_0979;
		}
