		...
		public virtual string Decode(Stream bt)
		{
			...
			if (stream != null)
			{
				...
				while (true)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @13CC990 (inside System.UInt32::TryParse +0x8D0)");
