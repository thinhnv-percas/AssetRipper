...
namespace LunarConsolePlugin
{
	...
	public sealed class LunarConsole : MonoBehaviour
	{
							...
							if (!(flag12 || flag11))
							{
								...
								if (!(flag16 || flag15))
								{
									...
									if (!(flag20 || flag19))
									{
										...
										Il2CppRuntime.Boundary("UNKNOWN", "Method not found @13D4BA8 (inside LunarConsolePlugin.CVar::get_HasRange +0x8)");
		...
		private void SaveVariables()
		{
			...
			//IL_040f: Expected I4, but got O
			//IL_00a8: Expected O, but got I4
			//IL_05a5: Expected I4, but got O
			//IL_0442: Expected I4, but got O
		...
		private void ConsoleActionHandler(IDictionary<string, string> data)
		{
			...
			if ((uint)((ulong)(long)(IntPtr)obj9 & 1uL) != 0)
			{
				...
				if (int.TryParse(text, out var result))
				{
					if (registry == null)
					{
						Il2CppRuntime.Boundary("UNKNOWN", "Method not found @13E8374 (inside LunarConsolePluginInternal.StringUtils::.cctor +0x114)");
						return;
					}
