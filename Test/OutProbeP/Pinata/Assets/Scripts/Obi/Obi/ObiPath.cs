...
namespace Obi
{
	...
	public class ObiPath
	{
		...
		private float GaussLobattoIntegrationStep(Vector3 p1, Vector3 p2, Vector3 p3, Vector3 p4, float a, float b, float fa, float fb, int nevals, int maxevals, float acc)
		{
			...
			//IL_054d: Expected F4, but got I
			//IL_0562: Expected F4, but got I
			//IL_0589: Expected F4, but got I
			//IL_059e: Expected F4, but got I
			//IL_05b3: Expected F4, but got I
			//IL_0615: Expected F4, but got I
			//IL_0615: Expected I4, but got F4
			//IL_0615: Expected F4, but got I
			//IL_0615: Expected F4, but got I
			//IL_0615: Expected F4, but got I
			//IL_0615: Expected O, but got I
			//IL_0615: Expected O, but got I
			//IL_062e: Expected F4, but got I
			//IL_0643: Expected F4, but got I
			//IL_066a: Expected F4, but got I
			//IL_067f: Expected F4, but got I
			//IL_0694: Expected F4, but got I
			//IL_06ee: Expected I4, but got F4
			//IL_06ee: Expected F4, but got I
			//IL_06ee: Expected F4, but got I
			//IL_06ee: Expected F4, but got I
			//IL_06ee: Expected O, but got I
			//IL_06ee: Expected O, but got I
			//IL_070c: Expected F4, but got I
			//IL_0721: Expected F4, but got I
			//IL_0748: Expected F4, but got I
			//IL_075d: Expected F4, but got I
			//IL_0772: Expected F4, but got I
			//IL_07cc: Expected I4, but got F4
			//IL_07cc: Expected F4, but got I
			//IL_07cc: Expected F4, but got I
			//IL_07cc: Expected F4, but got I
			//IL_07cc: Expected O, but got I
			//IL_07cc: Expected O, but got I
			//IL_07e5: Expected F4, but got I
			//IL_07fa: Expected F4, but got I
			//IL_0821: Expected F4, but got I
			//IL_0836: Expected F4, but got I
			//IL_084b: Expected F4, but got I
			//IL_08a5: Expected I4, but got F4
			//IL_08a5: Expected F4, but got I
			//IL_08a5: Expected F4, but got I
			//IL_08a5: Expected F4, but got I
			//IL_08a5: Expected O, but got I
			//IL_08a5: Expected O, but got I
			//IL_08c3: Expected F4, but got I
			//IL_08d8: Expected F4, but got I
			//IL_08ff: Expected F4, but got I
			//IL_0914: Expected F4, but got I
			//IL_0929: Expected F4, but got I
			//IL_0983: Expected I4, but got F4
			//IL_0983: Expected F4, but got I
			//IL_0983: Expected F4, but got I
			//IL_0983: Expected F4, but got I
			//IL_0983: Expected O, but got I
			//IL_0983: Expected O, but got I
			//IL_099c: Expected F4, but got I
			//IL_09b1: Expected F4, but got I
			//IL_09d8: Expected F4, but got I
			//IL_09ed: Expected F4, but got I
			//IL_0a02: Expected F4, but got I
			//IL_0a5c: Expected I4, but got F4
			//IL_0a5c: Expected F4, but got I
			//IL_0a5c: Expected F4, but got I
			//IL_0a5c: Expected F4, but got I
		...
		public unsafe void InsertControlPoint(int index, Vector3 position, Vector3 inTangentVector, Vector3 outTangentVector, Vector3 normal, float mass, float rotationalMass, float thickness, int phase, Color color, string name)
		{
			...
			object obj = obj2;
			ObiPointsDataChannel obiPointsDataChannel = m_Points;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1034188 (inside Obi.ObiVolumeConstraintsBatch::SetParameters +0x1F0)");
		...
		public unsafe int InsertControlPoint(float mu)
		{
			...
			//IL_018f: Expected F4, but got I
			//IL_01b8: Expected O, but got I
			//IL_0219: Expected F4, but got I
			...
			//IL_0512: Expected O, but got F4
			//IL_059f: Expected O, but got F4
			//IL_062a: Expected F4, but got I
			//IL_06b5: Expected F4, but got I
			//IL_0740: Expected F4, but got I
			//IL_07cb: Expected F4, but got I
