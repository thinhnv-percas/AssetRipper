...
namespace Obi
{
	...
	public class ObiPathSmoother : MonoBehaviour
	{
		...
		{
			//IL_0b42: Expected I, but got O
			//IL_0b4c: Expected I, but got O
			...
			//IL_0142: Expected F4, but got I
			//IL_01f8: Expected F4, but got O
			//IL_0505: Unknown result type (might be due to invalid IL or missing references)
			//IL_050a: Expected O, but got Unknown
			//IL_0b59: Expected I4, but got O
			//IL_0b6b: Expected I4, but got O
			//IL_0461: Unknown result type (might be due to invalid IL or missing references)
			//IL_0466: Expected O, but got Unknown
			//IL_0535: Expected F4, but got O
			//IL_0542: Expected F4, but got O
			//IL_054f: Expected F4, but got O
			//IL_055c: Expected F4, but got O
			//IL_0569: Expected F4, but got O
			//IL_0576: Expected F4, but got O
			//IL_0594: Expected F4, but got O
			//IL_05a1: Expected F4, but got O
			//IL_05ae: Expected F4, but got O
			//IL_05bb: Expected F4, but got O
			//IL_05c8: Expected F4, but got O
			//IL_05d5: Expected F4, but got O
			...
			//IL_0760: Expected O, but got Ref
			//IL_0760: Expected O, but got Ref
