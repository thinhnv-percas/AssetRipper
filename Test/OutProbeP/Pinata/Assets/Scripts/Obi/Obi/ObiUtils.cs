...
namespace Obi
{
	...
	public static class ObiUtils
	{
		...
		{
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @100E244 (inside UnityEngine.BootConfigData::WrapBootConfigData +0x17C)");
		...
		public unsafe static Bounds Transform(this Bounds b, Matrix4x4 m)
		{
			...
			//IL_0415: Expected native int or pointer, but got O
			object obj2 = default(object);
			object obj = obj2;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10C2040 (inside UnityEngine.Matrix4x4::Inverse_Injected +0x438)");
			...
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10C2040 (inside UnityEngine.Matrix4x4::Inverse_Injected +0x438)");
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @100E564 (inside UnityEngine.BootConfigData::WrapBootConfigData +0x49C)");
		...
		public unsafe static Matrix4x4 Add(this Matrix4x4 a, Matrix4x4 other)
		{
			...
			do
			{
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10C1E5C (inside UnityEngine.Matrix4x4::Inverse_Injected +0x254)");
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10C1E5C (inside UnityEngine.Matrix4x4::Inverse_Injected +0x254)");
				obj = (long)(IntPtr)obj + (long)(IntPtr)obj;
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10C1D2C (inside UnityEngine.Matrix4x4::Inverse_Injected +0x124)");
				num++;
			}
			while (num != 16);
		...
		public static Quaternion RestDarboux(Quaternion q1, Quaternion q2)
		{
			...
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @158C010 (inside UnityEngine.Vector4::Magnitude +0x1B4)");
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @158C010 (inside UnityEngine.Vector4::Magnitude +0x1B4)");
		...
		static ObiUtils()
		{
			...
			//IL_0abb: Expected O, but got I4
			//IL_0aff: Expected O, but got I4
			//IL_0b3a: Expected O, but got I4
			//IL_0b7e: Expected O, but got I4
			//IL_0bb9: Expected O, but got I4
			//IL_0bfd: Expected O, but got I4
			//IL_0c38: Expected O, but got I4
			//IL_0c7c: Expected O, but got I4
