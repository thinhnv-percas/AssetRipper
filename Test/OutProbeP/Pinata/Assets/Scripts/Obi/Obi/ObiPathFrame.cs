...
namespace Obi
{
	...
	public struct ObiPathFrame
	{
		...
		public unsafe ObiPathFrame(Vector3 position, Vector3 tangent, Vector3 normal, Vector3 binormal, Vector4 color, float thickness)
		{
			...
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2DC30 (inside Obi.ObiPath+<GetDataChannels>d__17::System.Collections.IEnumerable.GetEnumerator +0x4)");
		}
		...
		public unsafe void Reset()
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2DC74 (inside Obi.ObiPath+<GetDataChannels>d__17::System.Collections.IEnumerable.GetEnumerator +0x48)");
		}
		...
		public unsafe void SetTwist(float twist)
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2E118 (inside Obi.ObiPathFrame::op_Multiply +0x1D4)");
		}
		...
		public unsafe void SetTwistAndTangent(float twist, Vector3 tangent)
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2E1FC (inside Obi.ObiPathFrame::op_Multiply +0x2B8)");
		}
		...
		public unsafe void Transport(ObiPathFrame frame, float twist)
		{
			...
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2E3A4 (inside Obi.ObiPathFrame::op_Multiply +0x460)");
		}
		...
		public unsafe void Transport(Vector3 newPosition, Vector3 newTangent, float twist)
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2E534 (inside Obi.ObiPathFrame::op_Multiply +0x5F0)");
		}
		...
		public unsafe void Transport(Vector3 newPosition, Vector3 newTangent, Vector3 newNormal, float twist)
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2E6A8 (inside Obi.ObiPathFrame::op_Multiply +0x764)");
		}
		...
		public unsafe void DebugDraw(float size)
		{
			//IL_000b: Expected O, but got Ref
			object obj = (object)System.Runtime.CompilerServices.Unsafe.AsPointer(ref System.Runtime.CompilerServices.Unsafe.AddByteOffset(ref this, 16));
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C2EA04 (inside Obi.ObiPathFrame::op_Multiply +0xAC0)");
		}
	}
}
