...
public class AndroidTenjin : BaseTenjin
{
	...
	{
		Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1660FC8 (inside Tenjin+DeferredDeeplinkDelegate::EndInvoke +0x18)");
	}
	...
	public static AndroidJavaObject CreateJavaMapFromDictainary(IDictionary<string, string> parameters)
	{
		...
		//IL_0613: Expected I4, but got O
		//IL_0643: Expected O, but got I8
		//IL_0650: Expected O, but got I8
