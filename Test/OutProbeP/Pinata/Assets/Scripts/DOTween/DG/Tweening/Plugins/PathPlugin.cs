...
namespace DG.Tweening.Plugins
{
	...
	public class PathPlugin : ABSTweenPlugin<Vector3, Path, PathOptions>
	{
		...
		public override void SetChangeValue(TweenerCore<Vector3, Path, PathOptions> t)
		{
			...
			endValue2.FinalizePath(t.plugOptions.isClosedPath, t.plugOptions.lockPositionAxis, vector);
			Quaternion rotation = transform.rotation;
			t.plugOptions.startupRot.x = rotation.x;
			t.plugOptions.startupRot.y = rotation.y;
			t.plugOptions.startupRot.z = rotation.z;
			t.plugOptions.startupRot.w = rotation.w;
			Vector3 eulerAngles = transform.eulerAngles;
			endValue = t.endValue;
			t.plugOptions.startupZRot = eulerAngles.z;
			goto IL_0749;
			IL_0723:
			IndexOutOfRangeException ex = new IndexOutOfRangeException();
			throw ex;
		...
		public unsafe void SetOrientation(PathOptions options, Tween t, Path path, float pathPerc, Vector3 tPos, UpdateNotice updateNotice)
		{
			...
			//IL_1131: Expected F4, but got I
			//IL_0235: Expected F4, but got I
			//IL_0245: Expected F4, but got I
			//IL_118c: Expected F4, but got I
			//IL_11b3: Expected F4, but got I
			//IL_0787: Expected O, but got I8
			//IL_07b2: Expected O, but got I
			//IL_035f: Expected F4, but got I
			//IL_0f4c: Expected F4, but got I
			//IL_0c63: Expected F4, but got I
			//IL_0ba3: Expected F4, but got I
			//IL_07de: Expected F4, but got I
			//IL_0800: Expected F4, but got I
			//IL_0dab: Expected F4, but got I
			//IL_05fb: Expected I, but got O
			//IL_041a: Expected O, but got I
			//IL_042f: Expected F4, but got I
			//IL_088e: Expected F4, but got I
			//IL_091d: Expected O, but got I
			//IL_0969: Expected O, but got I4
			//IL_12b1: Expected O, but got F4
			//IL_12be: Expected O, but got F4
			//IL_09c0: Expected O, but got I8
			//IL_09eb: Expected O, but got I
			//IL_0a05: Expected F4, but got I
			//IL_0a50: Expected F4, but got I
			//IL_0aac: Expected F4, but got I
			object obj2 = default(object);
			object obj = obj2;
			Component component = t.target as Component;
			Transform transform;
