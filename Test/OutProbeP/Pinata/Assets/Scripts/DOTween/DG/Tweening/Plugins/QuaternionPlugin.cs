	...
	public class QuaternionPlugin : ABSTweenPlugin<Quaternion, Vector3, QuaternionOptions>
	{
		...
		public override void SetFrom(TweenerCore<Quaternion, Vector3, QuaternionOptions> t, bool isRelative)
		{
			...
			if (!flag)
			{
				if ((object)t.plugOptions != null || t._003CisRelative_003Ek__BackingField)
				{
					...
					else
					{
						...
						euler2.y = y;
						euler2.z = z;
						quaternion = Quaternion.Euler(euler2);
						w2 = quaternion.w;
						z3 = quaternion.z;
						y3 = quaternion.y;
						quaternion2 = quaternion;
					...
					quaternion4.x = quaternion2.x;
					quaternion4.y = y3;
					quaternion4.z = z3;
					quaternion4.w = w2;
					quaternion = quaternion3 * quaternion4;
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10CC508 (inside UnityEngine.Quaternion::Internal_MakePositive +0x9C)");
					t.startValue.x = quaternion.x;
					t.startValue.y = quaternion.y;
					t.startValue.z = quaternion.z;
			...
			else
			{
				...
				vector4.x = quaternion.x;
				vector4.y = quaternion.y;
				vector4.z = quaternion.z;
				Vector3 vector5 = default(Vector3);
				vector5.x = t.endValue.x;
				vector5.y = t.endValue.y;
				vector5.z = t.endValue.z;
			...
			euler3.y = y;
			euler3.z = z;
			quaternion = Quaternion.Euler(euler3);
			t.setter(quaternion);
		}
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0027;\n\tv30 = *([1ED3B60]);\n\tv31 = *([v30 @ X8_v10]);\n\tv32 = \"il2cpp_codegen_initialize_method\"(v31, t, methodInfo, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46);\n\tv50 = 0 | 1;\n\t*([20274BA]) = v50;\nL_0027:\n\tgoto L_0034;\n\tv66 = *([v59 @ X0_v4+E0]);\n\tv67 = v66 == 0;\n\tv68 = ~v67;\n\tif (v68) goto L_0034;\n\tv70 = \"il2cpp_codegen_runtime_class_init\"(v59, t, methodInfo, v34, v35, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46);\nL_0034:\n\t// 52 MakeStruct v80 @ AGG10D9DF4_0_v1 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.endValue (UnityEngine.Vector3), t.endValue.y (System.Single), t.endValue.z (System.Single)\n\t// 53 MakeStruct v81 @ AGG10D9DF4_1_v1 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.startValue (UnityEngine.Vector3), t.startValue.y (System.Single), t.startValue.z (System.Single)\n\tv82 = UnityEngine.Vector3::op_Addition(v80, v81);\n\tt.endValue.x = v82;\n\tt.endValue.y = v82.y;\n\tt.endValue.z = v82.z;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 54 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0021;\n\tv32 = *([1EC8F18]);\n\tv33 = *([v32 @ X8_v23]);\n\tv34 = \"il2cpp_codegen_initialize_method\"(v33, t, methodInfo, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48);\n\tv52 = 0 | 1;\n\t*([20274BB]) = v52;\nL_0021:\n\tv59 = t.plugOptions == 1;\n\tif (v59) goto L_003C;\n\tv66 = t.plugOptions == 0;\n\tv67 = ~v66;\n\tif (v67) goto L_002E;\n\tv85 = ~t.<isRelative>k__BackingField;\n\tif (v85) goto L_0063;\nL_002E:\n\tv69 = ~t.<isRelative>k__BackingField;\n\tif (v69) goto L_004F;\nL_003C:\n\tgoto L_0049;\n\tv88 = *([v79 @ X0_v5+E0]);\n\tv89 = v88 == 0;\n\tv90 = ~v89;\n\tif (v90) goto L_0049;\n\tv92 = \"il2cpp_codegen_runtime_class_init\"(v79, t, methodInfo, v36, v37, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48);\nL_0049:\n\t// 73 MakeStruct v102 @ AGG10D9EE0_0_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.endValue (UnityEngine.Vector3), t.endValue.y (System.Single), t.endValue.z (System.Single)\n\t// 74 MakeStruct v103 @ AGG10D9EE0_1_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.startValue (UnityEngine.Vector3), t.startValue.y (System.Single), t.startValue.z (System.Single)\n\tv141 = UnityEngine.Vector3::op_Subtraction(v102, v103);\n\tv139 = v141.y;\n\tv137 = v141.z;\n\tgoto L_0144;\nL_004F:\n\tv141 = t.endValue;\n\tv139 = t.endValue.y;\n\tv137 = t.endValue.z;\n\tgoto L_0144;\nL_0063:\n\tv206 = t.endValue <= 360f;\n\tif (v206) goto L_0074;\n\tv287 = 0x6D1F60(v287, t, methodInfo, v36, v37, v38, v39, v40, t.endValue, 360f, v43, v44, v45, v46, v47, v48);\nL_0074:\n\tv231 = t.endValue.y <= 360f;\n\tif (v231) goto L_0085;\n\tv287 = 0x6D1F60(v287, t, methodInfo, v36, v37, v38, v39, v40, t.endValue.y, 360f, v43, v44, v45, v46, v47, v48);\nL_0085:\n\tv299 = t.endValue.z <= 360f;\n\tif (v299) goto L_0094;\n\tv302 = 0x6D1F60(v287, t, methodInfo, v36, v37, v38, v39, v40, t.endValue.z, 360f, v43, v44, v45, v46, v47, v48);\nL_0094:\n\tgoto L_00A1;\n\tv313 = *([v309 @ X0_v12+E0]);\n\tv314 = v313 == 0;\n\tv315 = ~v314;\n\tgoto L_00A1;\n\tv317 = \"il2cpp_codegen_runtime_class_init\"(v309, t, methodInfo, v36, v37, v38, v39, v40, v304, v303, v43, v44, v45, v46, v47, v48);\nL_00A1:\n\t// 161 MakeStruct v239 @ AGG10D9F9C_0_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.endValue (UnityEngine.Vector3), t.endValue.y (System.Single), t.endValue.z (System.Single)\n\t// 162 MakeStruct v238 @ AGG10D9F9C_1_v2 (UnityEngine.Vector3), typeof(UnityEngine.Vector3), t.startValue (UnityEngine.Vector3), t.startValue.y (System.Single), t.startValue.z (System.Single)\n\tv141 = UnityEngine.Vector3::op_Subtraction(v239, v238);\n\tv139 = v141.y;\n\tv137 = v141.z;\n\tv343 = -v141;\n\tv331 = v141 < 0;\n\tv332 = v141 == 0;\n\tv334 = v141 ^ v141;\n\tv335 = v141 & v334;\n\tv336 = v335 < 0;\n\tv337 = v331 == v336;\n\tv338 = ~v332;\n\tv339 = v337 & v338;\n\tv340 = ~v339;\n\tif (v340) goto L_00C6;\n\tgoto L_00C6;\nL_00C6:\n\tv355 = v343 <= 180f;\n\tif (v355) goto L_00DC;\n\tv356 = 360f - v343;\n\tv357 = -v356;\n\tv361 = v141 < 0;\n\tv362 = v141 == 0;\n\tv364 = v141 ^ v141;\n\tv365 = v141 & v364;\n\tv366 = v365 < 0;\n\tv367 = v361 == v366;\n\tv368 = ~v362;\n\tv369 = v367 & v368;\n\tv370 = ~v369;\n\tif (v370) goto L_FFFFFFFF;\n\tgoto L_00DC;\nL_00DC:\n\tv402 = -v139;\n\tv390 = v139 < 0;\n\tv391 = v139 == 0;\n\tv393 = v139 ^ v139;\n\tv394 = v139 & v393;\n\tv395 = v394 < 0;\n\tv396 = v390 == v395;\n\tv397 = ~v391;\n\tv398 = v396 & v397;\n\tv399 = ~v398;\n\tif (v399) goto L_00FA;\n\tgoto L_00FA;\nL_00FA:\n\tv414 = v402 <= 180f;\n\tif (v414) goto L_0110;\n\tv415 = 360f - v402;\n\tv416 = -v415;\n\tv420 = v139 < 0;\n\tv421 = v139 == 0;\n\tv423 = v139 ^ v139;\n\tv424 = v139 & v423;\n\tv425 = v424 < 0;\n\tv426 = v420 == v425;\n\tv427 = ~v421;\n\tv428 = v426 & v427;\n\tv429 = ~v428;\n\tif (v429) goto L_FFFFFFFF;\n\tgoto L_0110;\nL_0110:\n\tv243 = -v137;\n\tv448 = v137 < 0;\n\tv449 = v137 == 0;\n\tv451 = v137 ^ v137;\n\tv452 = v137 & v451;\n\tv453 = v452 < 0;\n\tv454 = v448 == v453;\n\tv236 = ~v449;\n\tv455 = v454 & v236;\n\tv234 = ~v455;\n\tif (v234) goto L_012E;\n\tgoto L_012E;\nL_012E:\n\tv240 = v243 <= 180f;\n\tif (v240) goto L_0144;\n\tv246 = 360f - v243;\n\tv244 = -v246;\n\tv273 = v137 < 0;\n\tv271 = v137 == 0;\n\tv267 = v137 ^ v137;\n\tv265 = v137 & v267;\n\tv263 = v265 < 0;\n\tv462 = v273 == v263;\n\tv237 = ~v271;\n\tv241 = v462 & v237;\n\tv235 = ~v241;\n\tif (v235) goto L_FFFFFFFF;\n\tgoto L_0144;\nL_0144:\n\tt.changeValue.x = v141;\n\tt.changeValue.y = v139;\n\tt.changeValue.z = v137;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 205 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Quaternion, Vector3, QuaternionOptions> t)
		{
			...
			//IL_02bc: Unsupported input type for neg.
			//IL_02bc: Unknown result type (might be due to invalid IL or missing references)
			//IL_02c1: Expected O, but got Unknown
			//IL_0303: Unknown result type (might be due to invalid IL or missing references)
			//IL_0308: Expected I4, but got Unknown
			//IL_01fe: Expected O, but got F4
			//IL_0702: Expected O, but got F4
			//IL_070b: Unknown result type (might be due to invalid IL or missing references)
			//IL_0710: Expected I4, but got Unknown
			//IL_0381: Expected O, but got F4
			//IL_03c3: Unknown result type (might be due to invalid IL or missing references)
			//IL_03c8: Expected I4, but got Unknown
			//IL_0796: Expected O, but got F4
			//IL_079f: Unknown result type (might be due to invalid IL or missing references)
			//IL_07a4: Expected I4, but got Unknown
			//IL_042b: Expected O, but got F4
			//IL_0485: Expected O, but got F4
			//IL_048e: Unknown result type (might be due to invalid IL or missing references)
			//IL_0493: Expected I4, but got Unknown
			//IL_0550: Expected O, but got F4
			...
			if ((IntPtr)t.plugOptions != (IntPtr)1)
			{
				...
				else
				{
					...
					if (t.endValue.y > 360f)
					{
						QuaternionPlugin quaternionPlugin = (QuaternionPlugin)(t.endValue.y % 360f);
					}
					if (t.endValue.z > 360f)
					{
						object obj = t.endValue.z % 360f;
					}
					Vector3 vector2 = default(Vector3);
					vector2.x = t.endValue.x;
					vector2.y = t.endValue.y;
					vector2.z = t.endValue.z;
					Vector3 vector3 = default(Vector3);
					vector3.x = t.startValue.x;
					vector3.y = t.startValue.y;
					vector3.z = t.startValue.z;
					vector = vector2 - vector3;
					num = vector.y;
					num2 = vector.z;
					Vector3 vector4 = 0 - vector;
					...
					if (vector4.x > 180f)
					{
						float num4 = 360f - vector4.x;
						Vector3 vector5 = (Vector3)(0f - num4);
						...
						bool flag10 = !flag7;
						vector = ((!(flag9 && flag10)) ? ((Vector3)num4) : vector5);
					}
					float num6 = 0f - num;
					bool flag11 = num < 0f;
					bool flag12 = num == 0f;
					...
					if (num11 > 180f)
					{
						...
						bool flag30 = !flag27;
						num2 = ((!(flag29 && flag30)) ? num13 : num14);
					}
				}
				goto IL_05c6;
			}
			...
			vector6.x = t.endValue.x;
			vector6.y = t.endValue.y;
			vector6.z = t.endValue.z;
			Vector3 vector7 = default(Vector3);
			vector7.x = t.startValue.x;
			vector7.y = t.startValue.y;
			vector7.z = t.startValue.z;
			vector = vector6 - vector7;
			num = vector.y;
			num2 = vector.z;
			goto IL_05c6;
			IL_05c6:
			t.changeValue.x = vector.x;
			t.changeValue.y = num;
			t.changeValue.z = num2;
		}
