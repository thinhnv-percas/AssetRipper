...
namespace DG.Tweening.CustomPlugins
{
	...
	public class PureQuaternionPlugin : ABSTweenPlugin<Quaternion, Quaternion, NoOptions>
	{
		...
		public override void SetFrom(TweenerCore<Quaternion, Quaternion, NoOptions> t, bool isRelative)
		{
			...
			Quaternion quaternion = t.endValue;
			...
			Quaternion quaternion2 = ((DOGetter<Quaternion>)0)();
			t.endValue.x = quaternion2.x;
			t.endValue.y = quaternion2.y;
			t.endValue.z = quaternion2.z;
			t.endValue.w = quaternion2.w;
			if (isRelative)
			{
				Quaternion quaternion3 = default(Quaternion);
				quaternion3.x = t.endValue.x;
				quaternion3.y = t.endValue.y;
				quaternion3.z = t.endValue.z;
				quaternion3.w = t.endValue.w;
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_002B;\n\tv34 = *([1EE8A80]);\n\tv35 = *([v34 @ X8_v10]);\n\tv36 = \"il2cpp_codegen_initialize_method\"(v35, t, methodInfo, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50);\n\tv54 = 0 | 1;\n\t*([20269E4]) = v54;\nL_002B:\n\tgoto L_003A;\n\tv72 = *([v65 @ X0_v4+E0]);\n\tv73 = v72 == 0;\n\tv74 = ~v73;\n\tif (v74) goto L_003A;\n\tv76 = \"il2cpp_codegen_runtime_class_init\"(v65, t, methodInfo, v38, v39, v40, v41, v42, v43, v44, v45, v46, v47, v48, v49, v50);\nL_003A:\n\t// 58 MakeStruct v88 @ AGG107A958_0_v1 (UnityEngine.Quaternion), typeof(UnityEngine.Quaternion), t.endValue (UnityEngine.Quaternion), t.endValue.y (System.Single), t.endValue.z (System.Single), t.endValue.w (System.Single)\n\t// 59 MakeStruct v89 @ AGG107A958_1_v1 (UnityEngine.Quaternion), typeof(UnityEngine.Quaternion), t.startValue (UnityEngine.Quaternion), t.startValue.y (System.Single), t.startValue.z (System.Single), t.startValue.w (System.Single)\n\tv90 = UnityEngine.Quaternion::op_Multiply(v88, v89);\n\tt.endValue.x = v90;\n\tt.endValue.y = v90.y;\n\tt.endValue.z = v90.z;\n\tt.endValue.w = v90.w;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 63 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetRelativeEndValue(TweenerCore<Quaternion, Quaternion, NoOptions> t)
		{
			Quaternion quaternion = default(Quaternion);
			quaternion.x = t.endValue.x;
			quaternion.y = t.endValue.y;
			quaternion.z = t.endValue.z;
			quaternion.w = t.endValue.w;
			Quaternion quaternion2 = default(Quaternion);
			quaternion2.x = t.startValue.x;
			quaternion2.y = t.startValue.y;
			quaternion2.z = t.startValue.z;
			quaternion2.w = t.startValue.w;
			Quaternion quaternion3 = quaternion * quaternion2;
			t.endValue.x = quaternion3.x;
			t.endValue.y = quaternion3.y;
			t.endValue.z = quaternion3.z;
			t.endValue.w = quaternion3.w;
		}

		[Token(Token = "0x600026B")]
		[Address(RVA = "0x107A990", Offset = "0x107A990", Length = "0x30")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tt.changeValue.x = t.endValue;\n\tt.changeValue.y = t.endValue.y;\n\tt.changeValue.w = t.endValue.w;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 10 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public override void SetChangeValue(TweenerCore<Quaternion, Quaternion, NoOptions> t)
		{
			t.changeValue.x = t.endValue.x;
			t.changeValue.y = t.endValue.y;
			t.changeValue.w = t.endValue.w;
		}
