...
namespace DG.Tweening.Plugins
{
	...
	internal class Color2Plugin : ABSTweenPlugin<Color2, Color2, ColorOptions>
	{
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0029;\n\tv40 = *([1EEE6E8]);\n\tv41 = *([v40 @ X8_v22]);\n\tv42 = \"il2cpp_codegen_initialize_method\"(v41, t, isRelative, methodInfo, v44, v45, v46, v47, v48, v49, v50, v51, v52, v53, v54, v55);\n\tv59 = 0 | 1;\n\t*([2026A3C]) = v59;\nL_0029:\n\tv157 = t.endValue.ca.g;\n\tv155 = t.endValue.ca.b;\n\tv153 = t.endValue.ca.a;\n\tv151 = t.endValue.cb;\n\tv149 = t.endValue.cb.g;\n\tv147 = t.endValue.cb.b;\n\tv145 = t.endValue.cb.a;\n\tv81 = DG.Tweening.Core.DOGetter`1<DG.Tweening.Color2>::Invoke(t.getter);\n\tt.endValue.cb = v170;\n\tt.endValue = v80;\n\tv173 = isRelative == 0;\n\tif (v173) goto L_0064;\n\t// 70 MakeStruct v183 @ AGG107F410_0_v3 (UnityEngine.Color), typeof(UnityEngine.Color), t.endValue (DG.Tweening.Color2), t.endValue.ca.g (System.Single), t.endValue.ca.b (System.Single), t.endValue.ca.a (System.Single)\n\t// 71 MakeStruct v184 @ AGG107F410_1_v3 (UnityEngine.Color), typeof(UnityEngine.Color), t.endValue (DG.Tweening.Color2), t.endValue.ca.g (System.Single), t.endValue.ca.b (System.Single), t.endValue.ca.a (System.Single)\n\tv185 = UnityEngine.Color::op_Addition(v183, v184);\n\t// 90 MakeStruct v187 @ AGG107F44C_0_v3 (UnityEngine.Color), typeof(UnityEngine.Color), t.endValue.cb (UnityEngine.Color), t.endValue.cb.g (System.Single), t.endValue.cb.b (System.Single), t.endValue.cb.a (System.Single)\n\t// 91 MakeStruct v186 @ AGG107F44C_1_v3 (UnityEngine.Color), typeof(UnityEngine.Color), t.endValue.cb (UnityEngine.Color), t.endValue.cb.g (System.Single), t.endValue.cb.b (System.Single), t.endValue.cb.a (System.Single)\n\tv195 = UnityEngine.Color::op_Addition(v187, v186);\nL_0064:\n\tt.startValue.ca.r = v159;\n\tt.startValue.ca.g = v157;\n\tt.startValue.ca.b = v155;\n\tt.startValue.ca.a = v153;\n\tt.startValue.cb.r = v151;\n\tt.startValue.cb.g = v149;\n\tt.startValue.cb.b = v147;\n\tt.startValue.cb.a = v145;\n\tv215 = t.plugOptions == 0;\n\tv216 = ~v215;\n\tif (v216) goto L_009B;\nL_009B:\n\tDG.Tweening.Core.DOSetter`1<DG.Tweening.Color2>::Invoke(t.setter, &v105 @ stack_-A0_v4 (DG.Tweening.Color2));\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 136 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public unsafe override void SetFrom(TweenerCore<Color2, Color2, ColorOptions> t, bool isRelative)
		{
			...
			float g = t.endValue.ca.g;
			float b = t.endValue.ca.b;
			float a = t.endValue.ca.a;
			Color color = t.endValue.cb;
			float g2 = t.endValue.cb.g;
			float b2 = t.endValue.cb.b;
			float a2 = t.endValue.cb.a;
			...
			Color color3 = (Color)t.endValue;
			if (!flag)
			{
				Color color4 = default(Color);
				color4.r = (float)t.endValue;
				color4.g = t.endValue.ca.g;
				color4.b = t.endValue.ca.b;
				color4.a = t.endValue.ca.a;
				Color color5 = default(Color);
				color5.r = (float)t.endValue;
				color5.g = t.endValue.ca.g;
				color5.b = t.endValue.ca.b;
				color5.a = t.endValue.ca.a;
				Color color6 = color4 + color5;
				Color color7 = default(Color);
				color7.r = t.endValue.cb.r;
				color7.g = t.endValue.cb.g;
				color7.b = t.endValue.cb.b;
				color7.a = t.endValue.cb.a;
				Color color8 = default(Color);
				color8.r = t.endValue.cb.r;
				color8.g = t.endValue.cb.g;
				color8.b = t.endValue.cb.b;
				color8.a = t.endValue.cb.a;
				Color color9 = color7 + color8;
				a2 = color9.a;
				b2 = color9.b;
				g2 = color9.g;
				color = color9;
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv8 = &v9 @ stack_-10_v2;\n\tv16 = &v9 @ stack_-10_v2 - 0x30;\n\t*([v8 @ X29_v1-20]) = t.endValue.cb;\n\t*([v8 @ X29_v1-30]) = t.endValue;\n\tv23 = t.startValue;\n\tv26 = DG.Tweening.Color2::op_Addition(v16, &v23 @ V0_v4 (DG.Tweening.Color2));\n\tt.endValue.cb = v26.cb;\n\tt.endValue = v26.ca;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 34 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public unsafe override void SetRelativeEndValue(TweenerCore<Color2, Color2, ColorOptions> t)
		{
			...
			object obj = obj2;
			Color2 color = (Color2)((long)(IntPtr)obj2 - 48L);
			_ = t.endValue.cb;
			_ = t.endValue;
			Color2 startValue = t.startValue;
			Color2 color2 = color + (Color2)(&startValue);
		...
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv6 = &v7 @ stack_-10_v2;\n\tv14 = &v7 @ stack_-10_v2 - 0x30;\n\t*([v6 @ X29_v1-20]) = t.endValue.cb;\n\t*([v6 @ X29_v1-30]) = t.endValue;\n\tv22 = t.startValue;\n\tv25 = DG.Tweening.Color2::op_Subtraction(v14, &v22 @ V0_v4 (DG.Tweening.Color2));\n\tt.changeValue.cb = v25.cb;\n\tt.changeValue = v25.ca;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 35 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
