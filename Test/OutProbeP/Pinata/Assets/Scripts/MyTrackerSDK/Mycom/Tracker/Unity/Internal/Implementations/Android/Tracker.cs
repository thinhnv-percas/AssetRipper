						...
						if (text == null || (object)text.GetType() == typeof(string))
						{
							...
							if (dictionary3 != null)
							{
								...
								if (text3 == null || (object)text3.GetType() == typeof(string))
								{
									...
									Il2CppRuntime.Boundary("UNKNOWN", "Method not found @EA4640 (inside System.Decimal::FCallDivide +0x178)");
