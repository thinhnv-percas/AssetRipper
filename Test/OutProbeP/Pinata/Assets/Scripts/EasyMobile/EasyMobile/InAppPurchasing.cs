	...
	public class InAppPurchasing : MonoBehaviour
	{
		...
		public static event Action RestoreCompleted
		{
			...
			add
			{
				...
				if (0 == 0)
				{
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @C097E0 (inside EasyMobile.Internal.Privacy.ConsentDialogContentSerializer+SplitContent::IsButton +0x68)");
					return;
				}
