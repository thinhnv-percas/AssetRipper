...
namespace EasyMobile.Internal
{
	...
	internal class RuntimeHelper : MonoBehaviour
	{
		...
		{
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @B5DE1C (inside EasyMobile.ManifestGenerator.Elements.PermissionGroupElement+<get_AllAvailableAttributes>d__6::System.Collections.IEnumerable.GetEnumerator +0x10)");
		}
