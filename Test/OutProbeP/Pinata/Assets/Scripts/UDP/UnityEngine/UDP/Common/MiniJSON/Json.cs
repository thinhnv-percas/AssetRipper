	...
	public static class Json
	{
		...
		private sealed class Parser : IDisposable
		{
			...
			private char PeekChar
			{
				...
				[Address(RVA = "0x15C7C1C", Offset = "0x15C7C1C", Length = "0x88")]
			...
			private char NextChar
			{
				...
				[Address(RVA = "0x15C7A20", Offset = "0x15C7A20", Length = "0x88")]
			...
			[Address(RVA = "0x15C700C", Offset = "0x15C700C", Length = "0xA0")]
			...
			[Address(RVA = "0x15C70AC", Offset = "0x15C70AC", Length = "0x7C")]
			...
			[Address(RVA = "0x15C7150", Offset = "0x15C7150", Length = "0x34")]
			...
			[Address(RVA = "0x15C7128", Offset = "0x15C7128", Length = "0x28")]
			[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv10 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::get_NextToken(this);\n\treturnVal1 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::ParseByToken(this, v10);\n\treturn returnVal1;\n// 12 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
			...
			[Address(RVA = "0x15C77C0", Offset = "0x15C77C0", Length = "0xDC")]
			[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0015;\n\tv22 = *([1EF0810]);\n\tv23 = *([v22 @ X8_v8]);\n\tv24 = \"il2cpp_codegen_initialize_method\"(v23, token, methodInfo, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38);\n\tv41 = 0 | 1;\n\t*([20299B1]) = v41;\nL_0015:\n\tv42 = token - 1;\n\tv43 = v42 < 9;\n\tv44 = ~v43;\n\tv45 = v42 - 9;\n\tv47 = v45 == 0;\n\tv53 = ~v47;\n\tv54 = v44 & v53;\n\tif (v54) goto L_004D;\n\tv56 = 0x183B000 + 0xF3C;\n\tv58 = *([v56 @ X9_v2 (System.Int32)+v42 @ X8_v3 (System.Int32)*4]) + v56;\n\t// 39 IndirectJump v58 @ X8_v5, 0, 0, token @ X1 (UnityEngine.UDP.Common.MiniJSON.Json+Parser+TOKEN), methodInfo @ X2 (Il2CppMethodInfo), v26 @ X3, v27 @ X4, v28 @ X5, v29 @ X6, v30 @ X7, v31 @ V0, v32 @ V1, v33 @ V2, v34 @ V3, v35 @ V4, v36 @ V5, v37 @ V6, v38 @ V7\n\tX0 = X19;\n\tX0 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::ParseObject(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX0 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::ParseArray(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX0 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::ParseString(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX29 = stack[20];\n\tX30 = stack[28];\n\tX20 = stack[10];\n\tX19 = stack[18];\n\tX21 = stack[0];\n\t// 55 ShiftStack 48\n\tX0 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::ParseNumber(X0, X1);\n\treturn X0;\n\tX8 = *([1EC5410]);\n\tX1 = &stack[C];\n\tX0 = *([X8]);\n\tX8 = 0 | 1;\n\tstack[C] = X8;\n\tgoto L_0046;\n\tX8 = *([1EC5410]);\n\tX1 = &stack[8];\n\tstack[8] = 0;\n\tX0 = *([X8]);\nL_0046:\n\tX0 = 0x8D82A8(X0, X1, X2, X3, X4, X5, X6, X7, V0, V1, V2, V3, V4, V5, V6, V7);\nL_004D:\n\treturn 0;\n// 31 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
			...
			[Address(RVA = "0x15C789C", Offset = "0x15C789C", Length = "0x184")]
			[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0017;\n\tv20 = *([1ED7E08]);\n\tv21 = *([v20 @ X8_v19]);\n\tv22 = \"il2cpp_codegen_initialize_method\"(v21, methodInfo, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\n\tv40 = 0 | 1;\n\t*([20299B3]) = v40;\nL_0017:\n\tv44 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::get_NextWord(this);\n\tv50 = System.String::IndexOf(v44, 0x2E);\n\tv52 = v50 + 1;\n\tv54 = v52 == 0;\n\tv57 = ~v54;\n\tif (v57) goto L_0041;\n\tv61 = System.String::IndexOf(v44, 0x65);\n\tv84 = v61 + 1;\n\tv72 = v84 == 0;\n\tv63 = ~v72;\n\tif (v63) goto L_0041;\n\tv81 = System.String::IndexOf(v44, 0x45);\n\tv83 = v81 + 1;\n\tv71 = v83 == 0;\n\tif (v71) goto L_006F;\nL_0041:\n\tgoto L_0048;\n\tv140 = *([v87 @ X0_v10+E0]);\n\tv141 = v140 == 0;\n\tv142 = ~v141;\n\tif (v142) goto L_0048;\n\tv144 = \"il2cpp_codegen_runtime_class_init\"(v87, v78, v76, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\nL_0048:\n\tv148 = System.Globalization.CultureInfo::get_InvariantCulture();\n\tgoto L_005C;\n\tv157 = *([v153 @ X8_v8+E0]);\n\tv158 = v157 == 0;\n\tv159 = ~v158;\n\tif (v159) goto L_005C;\n\tv177 = v153;\n\tv162 = \"il2cpp_codegen_runtime_class_init\"(v177, v78, v76, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\nL_005C:\n\tv170 = System.Double::TryParse(v44, 0x1FF, v148, &v166 @ stack_-28_v3 (System.Double));\nL_0061:\n\treturnVal2 = \"il2cpp_vm_object_box\"(v197, &v135 @ X8_v3 (System.Double), v125, v103, v99, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\n\treturn returnVal2;\nL_006F:\n\tgoto L_0076;\n\tv180 = *([v173 @ X0_v25+E0]);\n\tv181 = v180 == 0;\n\tv182 = ~v181;\n\tif (v182) goto L_0076;\n\tv184 = \"il2cpp_codegen_runtime_class_init\"(v173, v79, v77, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\nL_0076:\n\tv188 = System.Globalization.CultureInfo::get_InvariantCulture();\n\tv202 = System.Int64::TryParse(v44, 0x1FF, v188, &v189 @ stack_-38_v3 (System.Int64));\n\tgoto L_0061;\n\treturnVal1 = new System.NullReferenceException();\n\treturn returnVal1;\n// 83 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
			private object ParseNumber()
			{
				//IL_0108: Expected O, but got I4
				//IL_0110: Expected O, but got F8
		...
		private sealed class Serializer
		{
			...
			[Address(RVA = "0x15C7CA4", Offset = "0x15C7CA4", Length = "0x6C")]
			...
			[Address(RVA = "0x15C7EBC", Offset = "0x15C7EBC", Length = "0x26C")]
		...
		[Address(RVA = "0x15C6E3C", Offset = "0x15C6E3C", Length = "0xC")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv0 = json == 0;\n\tif (v0) goto L_0004;\n\treturnVal2 = UnityEngine.UDP.Common.MiniJSON.Json+Parser::Parse(json);\n\treturn returnVal2;\nL_0004:\n\treturn json;\n")]
		...
		[Address(RVA = "0x15C6F88", Offset = "0x15C6F88", Length = "0x4")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\treturnVal1 = UnityEngine.UDP.Common.MiniJSON.Json+Serializer::Serialize(obj);\n\treturn returnVal1;\n")]
		public static string Serialize(object obj)
		{
