	...
	public class GA_MiniJSON
	{
		...
		private sealed class Parser : IDisposable
		{
			...
			private char PeekChar
			{
				...
				[Address(RVA = "0x15A73CC", Offset = "0x15A73CC", Length = "0x88")]
			...
			private char NextChar
			{
				...
				[Address(RVA = "0x15A71D0", Offset = "0x15A71D0", Length = "0x88")]
			...
			[Address(RVA = "0x15A6864", Offset = "0x15A6864", Length = "0xA0")]
			...
			[Address(RVA = "0x15A6904", Offset = "0x15A6904", Length = "0x7C")]
			...
			[Address(RVA = "0x15A69A8", Offset = "0x15A69A8", Length = "0x34")]
			...
			[Address(RVA = "0x15A6980", Offset = "0x15A6980", Length = "0x28")]
			[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv10 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::get_NextToken(this);\n\treturnVal1 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::ParseByToken(this, v10);\n\treturn returnVal1;\n// 12 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
			...
			[Address(RVA = "0x15A7014", Offset = "0x15A7014", Length = "0xDC")]
			[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0015;\n\tv22 = *([1EF3028]);\n\tv23 = *([v22 @ X8_v8]);\n\tv24 = \"il2cpp_codegen_initialize_method\"(v23, token, methodInfo, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37, v38);\n\tv41 = 0 | 1;\n\t*([202982F]) = v41;\nL_0015:\n\tv42 = token - 1;\n\tv43 = v42 < 9;\n\tv44 = ~v43;\n\tv45 = v42 - 9;\n\tv47 = v45 == 0;\n\tv53 = ~v47;\n\tv54 = v44 & v53;\n\tif (v54) goto L_004D;\n\tv56 = 0x183B000 + 0xB88;\n\tv58 = *([v56 @ X9_v2 (System.Int32)+v42 @ X8_v3 (System.Int32)*4]) + v56;\n\t// 39 IndirectJump v58 @ X8_v5, 0, 0, token @ X1 (GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser+TOKEN), methodInfo @ X2 (Il2CppMethodInfo), v26 @ X3, v27 @ X4, v28 @ X5, v29 @ X6, v30 @ X7, v31 @ V0, v32 @ V1, v33 @ V2, v34 @ V3, v35 @ V4, v36 @ V5, v37 @ V6, v38 @ V7\n\tX0 = X19;\n\tX0 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::ParseObject(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX0 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::ParseArray(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX0 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::ParseString(X0, X1);\n\tgoto L_004D;\n\tX0 = X19;\n\tX29 = stack[20];\n\tX30 = stack[28];\n\tX20 = stack[10];\n\tX19 = stack[18];\n\tX21 = stack[0];\n\t// 55 ShiftStack 48\n\tX0 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::ParseNumber(X0, X1);\n\treturn X0;\n\tX8 = *([1EC5410]);\n\tX1 = &stack[C];\n\tX0 = *([X8]);\n\tX8 = 0 | 1;\n\tstack[C] = X8;\n\tgoto L_0046;\n\tX8 = *([1EC5410]);\n\tX1 = &stack[8];\n\tstack[8] = 0;\n\tX0 = *([X8]);\nL_0046:\n\tX0 = 0x8D82A8(X0, X1, X2, X3, X4, X5, X6, X7, V0, V1, V2, V3, V4, V5, V6, V7);\nL_004D:\n\treturn 0;\n// 31 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		...
		private sealed class Serializer
		{
			...
			[Address(RVA = "0x15A7454", Offset = "0x15A7454", Length = "0x6C")]
			...
			[Address(RVA = "0x15A766C", Offset = "0x15A766C", Length = "0x26C")]
		...
		[Address(RVA = "0x15A6690", Offset = "0x15A6690", Length = "0xC")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tv0 = json == 0;\n\tif (v0) goto L_0004;\n\treturnVal2 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Parser::Parse(json);\n\treturn returnVal2;\nL_0004:\n\treturn json;\n")]
		...
		[Address(RVA = "0x15A1048", Offset = "0x15A1048", Length = "0x4")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\treturnVal1 = GameAnalyticsSDK.Utilities.GA_MiniJSON+Serializer::Serialize(obj);\n\treturn returnVal1;\n")]
		public static string Serialize(object obj)
		{
		...
		[Address(RVA = "0x15A685C", Offset = "0x15A685C", Length = "0x8")]
