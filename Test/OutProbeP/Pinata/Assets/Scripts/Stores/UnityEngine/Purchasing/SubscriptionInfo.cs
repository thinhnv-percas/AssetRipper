	...
	public class SubscriptionInfo
	{
		...
		public SubscriptionInfo(AppleInAppPurchaseReceipt r, string intro_json)
		{
			...
			else
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E95580 (inside System.DateTime::SpecifyKind +0xB8)");
		...
		public unsafe SubscriptionInfo(string skuDetails, bool isAutoRenewing, DateTime purchaseDate, bool isFreeTrial, bool hasIntroductoryPriceTrial, bool purchaseHistorySupported, string updateMetadata)
		{
			...
			//IL_071a: Expected O, but got I
			//IL_073a: Expected O, but got I4
			//IL_0ab1: Expected O, but got I4
			base._002Ector();
		...
		private DateTime nextBillingDate(DateTime billing_begin_date, TimeSpanUnits units)
		{
			...
			if (!flag)
			{
				...
				if (!flag3)
				{
					...
					if (!flag5)
					{
						...
						Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E93EDC (inside System.DateTime::TimeToTicks +0x454)");
			...
			while (true)
			{
				...
				if (num < 1)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E946B4 (inside System.DateTime::TimeToTicks +0xC2C)");
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E946C8 (inside System.DateTime::TimeToTicks +0xC40)");
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E94CC0 (inside System.DateTime::DaysInMonth +0x178)");
					t = utcNow;
					continue;
				}
				break;
		...
		private TimeSpan accumulateIntroductoryDuration(TimeSpanUnits units, long cycles)
		{
			...
			if (!flag)
			{
				...
				do
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @9BD230 (inside System.TimeSpan::TimeToTicks +0x2B0)");
					long num3 = num2 - 1;
					flag2 = num2 != 1;
					zero = (TimeSpan)zero2;
					num2 = num3;
		...
		private double computeExtraTime(string metadata, double new_sku_period_in_seconds)
		{
			...
			//IL_00a8: Expected I8, but got O
			//IL_017a: Expected I8, but got O
