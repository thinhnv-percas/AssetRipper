...
namespace Facebook.Unity.Mobile.IOS
{
	...
	internal class IOSFacebook : MobileFacebook
	{
		...
		public override void AppRequest(string message, OGActionType? actionType, string objectId, IEnumerable<string> to, IEnumerable<object> filters, IEnumerable<string> excludeIds, int? maxRecipients, string data, string title, FacebookDelegate<IAppRequestResult> callback)
		{
			...
			//IL_051a: Expected I4, but got Unknown
		...
		private static NativeDict MarshallDict(Dictionary<string, object> dict)
		{
			...
			if (0 == 0)
			{
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @D34EA8 (inside Facebook.Unity.Utilities+<>c::<ParsePermissionFromResult>b__18_0 +0x44)");
