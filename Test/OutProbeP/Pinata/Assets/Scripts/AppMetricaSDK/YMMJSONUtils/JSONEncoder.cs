...
namespace YMMJSONUtils
{
	...
	public class JSONEncoder
	{
		...
		private void EncodeObject(object obj)
		{
			...
			//IL_05b7: Expected F8, but got O
			//IL_03d5: Expected I8, but got O
			//IL_03f1: Expected I8, but got O
			//IL_040d: Expected I8, but got O
			//IL_0429: Expected I8, but got O
			//IL_0445: Expected I8, but got O
			//IL_0461: Expected I8, but got O
			//IL_047d: Expected I8, but got O
		...
		{
			CultureInfo invariantCulture = CultureInfo.InvariantCulture;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @BCCEFC (inside System.Single::IsNaN +0x2E4)");
		...
		{
			CultureInfo invariantCulture = CultureInfo.InvariantCulture;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @A6636C (inside System.Double::IsNaN +0x488)");
			string value = default(string);
			StringBuilder stringBuilder = _buffer.Append(value);
		}
		...
		{
			CultureInfo invariantCulture = CultureInfo.InvariantCulture;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @DC40D4 (inside System.Number::FormatInt64 +0x80)");
			string value = default(string);
			StringBuilder stringBuilder = _buffer.Append(value);
		}
		...
		{
			CultureInfo invariantCulture = CultureInfo.InvariantCulture;
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @13CC9C4 (inside System.UInt32::TryParse +0x904)");
			string value = default(string);
			StringBuilder stringBuilder = _buffer.Append(value);
		}
