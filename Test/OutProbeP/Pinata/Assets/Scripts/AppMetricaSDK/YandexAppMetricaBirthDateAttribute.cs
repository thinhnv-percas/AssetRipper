...
public class YandexAppMetricaBirthDateAttribute
{
	...
	public YandexAppMetricaUserProfileUpdate WithBirthDate(DateTime date)
	{
		...
		Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E958CC (inside System.DateTime::GetSystemTimeAsFileTime +0x74)");
		Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E956B4 (inside System.DateTime::SpecifyKind +0x1EC)");
		Il2CppRuntime.Boundary("UNKNOWN", "Method not found @E955D0 (inside System.DateTime::SpecifyKind +0x108)");
