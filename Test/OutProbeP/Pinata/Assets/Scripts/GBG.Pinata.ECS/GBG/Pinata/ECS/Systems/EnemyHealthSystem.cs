...
namespace GBG.Pinata.ECS.Systems
{
	...
	public class EnemyHealthSystem : UpdateSystem
	{
		...
		public override void OnUpdate(float deltaTime)
		{
			...
			//IL_0bb0: Expected I, but got O
			//IL_09c7: Expected O, but got I
			//IL_09d7: Expected O, but got I
			//IL_1185: Expected O, but got I
			...
			while (true)
			{
				...
				Il2CppRuntime.Boundary("MANAGED", "Method not found @ACCB14 (UnityEngine.GameObject::GetComponent, and 53 more at this address)");
