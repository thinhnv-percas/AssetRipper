...
public class TCP2_Demo : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		//IL_043f: Expected F4, but got O
		//IL_045a: Expected F4, but got O
		//IL_062e: Expected O, but got I4
		//IL_064b: Expected O, but got I4
		//IL_0675: Expected F4, but got O
		//IL_0690: Expected F4, but got O
		//IL_09e8: Expected O, but got I4
		//IL_0a12: Expected F4, but got O
		//IL_0a2d: Expected F4, but got O
		//IL_1702: Expected F4, but got O
		GUI.skin = GuiSkin;
		...
		if (mViewRobot)
		{
			...
			Il2CppRuntime.Boundary("UNKNOWN", "Method not found @B178C0 (inside Tayx.Graphy.Ram.G_RamGraph::.ctor +0x14)");
			return;
		}
		GUILayout.EndArea();
