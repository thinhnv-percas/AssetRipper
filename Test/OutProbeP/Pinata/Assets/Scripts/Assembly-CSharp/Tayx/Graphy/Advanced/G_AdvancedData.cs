			...
			if (windowStrings.Length != 0)
			{
				...
				if (!(flag4 || flag3))
				{
					...
					if (!(flag8 || flag7))
					{
						...
						Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10D3F84 (inside UnityEngine.RequireComponent::.ctor +0x48)");
											...
											if (!(flag30 || flag29))
											{
												...
												if (!(flag34 || flag33))
												{
													...
													if (!(flag38 || flag37))
													{
														...
														{
															array3[0] = "Screen: ";
															Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10D3F74 (inside UnityEngine.RequireComponent::.ctor +0x38)");
															...
															if (!(flag42 || flag41))
															{
																...
																{
																	array3[2] = "x";
																	Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10D3F7C (inside UnityEngine.RequireComponent::.ctor +0x40)");
																	flag2 = (byte)(int)(object)(flag2 ? 1 : 0) != 0;
																	if (flag2)
																	{
																		flag2 = (byte)(int)(flag2 as object) != 0;
