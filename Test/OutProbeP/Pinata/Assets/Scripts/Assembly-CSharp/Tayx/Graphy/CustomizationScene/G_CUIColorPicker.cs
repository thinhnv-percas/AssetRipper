...
namespace Tayx.Graphy.CustomizationScene
{
	...
	public class G_CUIColorPicker : MonoBehaviour
	{
		...
		private unsafe static bool GetLocalMouse(GameObject go, out Vector2 result)
		{
			...
			//IL_00f5: Expected Ref, but got F4
		...
		private static Vector2 GetWidgetSize(GameObject go)
		{
			...
			if ((object)transform.GetType() == typeof(RectTransform) && (object)transform.GetType() == typeof(RectTransform))
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @10CD198 (inside UnityEngine.Rect::MinMaxRect +0x1FC)");
				return rect;
			}
		...
		internal unsafe void Setup(Color inputColor)
		{
			...
			//IL_062b: Expected O, but got I8
			//IL_06d6: Expected O, but got I
			//IL_06eb: Expected F4, but got I
			//IL_0761: Expected O, but got I
			//IL_07a7: Expected O, but got I4
			//IL_07c4: Expected O, but got I4
			//IL_07ee: Expected F4, but got O
			//IL_0809: Expected F4, but got O
			//IL_0824: Expected F4, but got O
			//IL_08cc: Expected O, but got I4
			//IL_08ef: Expected O, but got I
			//IL_091f: Expected F4, but got O
			//IL_093a: Expected F4, but got O
			//IL_094f: Expected F4, but got I
			//IL_0964: Expected F4, but got I
			//IL_0b01: Expected O, but got I4
			//IL_0b35: Expected F4, but got O
			//IL_0bcb: Expected O, but got I4
			//IL_0bfa: Expected F4, but got O
			object obj2 = default(object);
			object obj = obj2;
