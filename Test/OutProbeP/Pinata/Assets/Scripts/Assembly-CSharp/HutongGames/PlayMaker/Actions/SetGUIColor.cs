...
{
	[AttributeAttribute(Type = typeof(ActionCategoryAttribute), RVA = "0x756D60", Offset = "0x756D60")]
	[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x756D60", Offset = "0x756D60")]
	...
	public class SetGUIColor : FsmStateAction
	{
		...
		[Address(RVA = "0x99407C", Offset = "0x99407C", Length = "0x30")]
		...
		public override void OnGUI()
		{
			...
			if (applyGlobally.Value)
			{
				...
				PlayMakerGUI.guiColor = guiColor;
				_ = guiColor.g;
				_ = guiColor.b;
				_ = guiColor.a;
			}
		...
		[Address(RVA = "0x9941FC", Offset = "0x9941FC", Length = "0x8")]
