	...
	public class GetAnimatorCurrentTransitionInfoIsUserName : FsmStateActionAnimatorBase
	{
		...
		private void IsName()
		{
			if (_animator != null)
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1639030 (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0x1B0)");
