	...
	public class GetLocationInfo : FsmStateAction
	{
		...
		private void DoGetLocationInfo()
		{
			...
			if (status == LocationServiceStatus.Running)
			{
				...
				_ = 0;
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @166FFFC (inside UnityEngine.Input::get_touches +0x150)");
				...
				_ = 0;
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @166FFF4 (inside UnityEngine.Input::get_touches +0x148)");
				...
				_ = 0;
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1670004 (inside UnityEngine.Input::get_touches +0x158)");
				...
				_ = 0;
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @167000C (inside UnityEngine.Input::get_touches +0x160)");
				Cpp2ILHelpers.NoteDecompilerIssue("Unmanaged memory load: [v129 @ X8_v11+10]");
				fsmFloat4.Value = 0f;
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1670014 (inside UnityEngine.Input::get_touches +0x168)");
