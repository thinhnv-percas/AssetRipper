		...
		private void SetProperties()
		{
			...
			if (!(_wj2d == null))
			{
				...
				if (!angle.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163E698 (inside UnityEngine.Joint2D::get_reactionTorque +0x70)");
				...
				if (!dampingRatio.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163E688 (inside UnityEngine.Joint2D::get_reactionTorque +0x60)");
					float maximumMotorTorque = _suspension.m_Frequency;
					float num = _suspension.m_Angle;
				...
				if (!frequency.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163E690 (inside UnityEngine.Joint2D::get_reactionTorque +0x68)");
