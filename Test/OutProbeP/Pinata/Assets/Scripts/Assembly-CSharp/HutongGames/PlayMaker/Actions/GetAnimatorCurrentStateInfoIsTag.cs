	...
	public class GetAnimatorCurrentStateInfoIsTag : FsmStateActionAnimatorBase
	{
		...
		private void IsTag()
		{
			if (_animator != null)
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1638F30 (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0xB0)");
