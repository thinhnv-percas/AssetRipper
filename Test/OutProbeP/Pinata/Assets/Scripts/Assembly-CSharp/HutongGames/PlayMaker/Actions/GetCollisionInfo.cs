	...
	public class GetCollisionInfo : FsmStateAction
	{
		...
		private void StoreCollisionInfo()
		{
			...
			if (contacts3.Length != 0)
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @16499F4 (inside UnityEngine.Collision::get_contacts +0x80)");
				...
				if (contacts4.Length != 0)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1649A00 (inside UnityEngine.Collision::get_contacts +0x8C)");
