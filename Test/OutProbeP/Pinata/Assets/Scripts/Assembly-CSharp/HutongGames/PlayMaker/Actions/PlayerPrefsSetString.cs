...
{
	[AttributeAttribute(Type = typeof(ActionCategoryAttribute), RVA = "0x75B480", Offset = "0x75B480")]
	[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x75B480", Offset = "0x75B480")]
	[Token(Token = "0x20002E6")]
	public class PlayerPrefsSetString : FsmStateAction
	{
		[AttributeAttribute(Type = typeof(CompoundArrayAttribute), RVA = "0x7C0CA0", Offset = "0x7C0CA0")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x7C0CA0", Offset = "0x7C0CA0")]
		...
		[Address(RVA = "0xB1AFBC", Offset = "0xB1AFBC", Length = "0x68")]
		...
		public override void OnEnter()
		{
			...
			while (true)
			{
				if (num < array.Length)
				{
					...
					{
						FsmString[] array5 = values;
						if (num >= array5.Length)
						{
							break;
						}
						string value4 = array5[num].Value;
						value3 = value4;
					}
					PlayerPrefs.SetString(value2, value3);
					goto IL_021e;
				}
				Finish();
				return;
		...
		[Address(RVA = "0xB1B1BC", Offset = "0xB1B1BC", Length = "0x8")]
