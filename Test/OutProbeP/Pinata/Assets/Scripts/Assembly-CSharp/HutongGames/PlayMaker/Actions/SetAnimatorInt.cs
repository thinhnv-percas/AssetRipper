...
{
	[Attribute(Type = typeof(ActionCategoryAttribute), RVA = "0x753464", Offset = "0x753464")]
	[Attribute(Type = typeof(TooltipAttribute), RVA = "0x753464", Offset = "0x753464")]
	[Token(Token = "0x2000160")]
	public class SetAnimatorInt : FsmStateActionAnimatorBase
	{
		[RequiredField]
		[Attribute(Type = typeof(CheckForComponentAttribute), RVA = "0x7A8284", Offset = "0x7A8284")]
		[Attribute(Type = typeof(TooltipAttribute), RVA = "0x7A8284", Offset = "0x7A8284")]
		[Token(Token = "0x4001201")]
		[FieldOffset(Offset = "0x58")]
		public FsmOwnerDefault gameObject;

		[RequiredField]
		[Attribute(Type = typeof(UIHintAttribute), RVA = "0x7A831C", Offset = "0x7A831C")]
		[Attribute(Type = typeof(TooltipAttribute), RVA = "0x7A831C", Offset = "0x7A831C")]
		[Token(Token = "0x4001202")]
		[FieldOffset(Offset = "0x60")]
		public FsmString parameter;

		[Attribute(Type = typeof(TooltipAttribute), RVA = "0x7A837C", Offset = "0x7A837C")]
		...
		[Address(RVA = "0xB2A5C4", Offset = "0xB2A5C4", Length = "0x2C")]
		...
		[Address(RVA = "0xB2A7E0", Offset = "0xB2A7E0", Length = "0x4")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tHutongGames.PlayMaker.Actions.SetAnimatorInt::SetParameter(this);\n\treturn;\n")]
		...
		[Address(RVA = "0xB2A724", Offset = "0xB2A724", Length = "0xBC")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_001A;\n\tv18 = *([1EE8D60]);\n\tv19 = *([v18 @ X8_v9]);\n\tv20 = \"il2cpp_codegen_initialize_method\"(v19, methodInfo, v22, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35);\n\tv38 = 0 | 1;\n\t*([2022606]) = v38;\nL_001A:\n\tgoto L_0023;\n\tv46 = *([v42 @ X0_v2+E0]);\n\tv47 = v46 == 0;\n\tv48 = ~v47;\n\tgoto L_0023;\n\tv50 = \"il2cpp_codegen_runtime_class_init\"(v42, methodInfo, v22, v23, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35);\nL_0023:\n\tv56 = UnityEngine.Object::op_Inequality(this._animator, 0);\n\tv58 = v56 == 0;\n\tif (v58) goto L_0040;\n\tv68 = HutongGames.PlayMaker.FsmInt::get_Value(this.Value);\n\tUnityEngine.Animator::SetInteger(this._animator, this._paramID, v68);\n\treturn;\nL_0040:\n\treturn;\n\tthrow System.NullReferenceException;\n\tthrow System.NullReferenceException;\n\treturn;\n// 47 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		...
		[Address(RVA = "0xB2A7E4", Offset = "0xB2A7E4", Length = "0x8")]
