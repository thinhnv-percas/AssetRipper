...
{
	[AttributeAttribute(Type = typeof(ActionCategoryAttribute), RVA = "0x74DD84", Offset = "0x74DD84")]
	[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x74DD84", Offset = "0x74DD84")]
	[AttributeAttribute(Type = typeof(HelpUrlAttribute), RVA = "0x74DD84", Offset = "0x74DD84")]
	[Token(Token = "0x2000095")]
	public class DOTweenControlMethodsCompleteById : FsmStateAction
	{
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76EF28", Offset = "0x76EF28")]
		[Token(Token = "0x4000511")]
		[FieldOffset(Offset = "0x4C")]
		public TweenId tweenIdType;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76EF60", Offset = "0x76EF60")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76EF60", Offset = "0x76EF60")]
		[Token(Token = "0x4000512")]
		[FieldOffset(Offset = "0x50")]
		public FsmString stringAsId;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76EFB0", Offset = "0x76EFB0")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76EFB0", Offset = "0x76EFB0")]
		[Token(Token = "0x4000513")]
		[FieldOffset(Offset = "0x58")]
		public FsmString tagAsId;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76F000", Offset = "0x76F000")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76F000", Offset = "0x76F000")]
		[Token(Token = "0x4000514")]
		[FieldOffset(Offset = "0x60")]
		public FsmGameObject gameObjectAsId;

		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76F050", Offset = "0x76F050")]
		[AttributeAttribute(Type = typeof(TooltipAttribute), RVA = "0x76F050", Offset = "0x76F050")]
		[Token(Token = "0x4000515")]
		[FieldOffset(Offset = "0x68")]
		public FsmBool withCallbacks;

		[AttributeAttribute(Type = typeof(ActionSection), RVA = "0x76F0A0", Offset = "0x76F0A0")]
		[AttributeAttribute(Type = typeof(UIHintAttribute), RVA = "0x76F0A0", Offset = "0x76F0A0")]
		[Token(Token = "0x4000516")]
		[FieldOffset(Offset = "0x70")]
		public FsmBool debugThis;

		[Token(Token = "0x60003EB")]
		[Address(RVA = "0xAF0284", Offset = "0xAF0284", Length = "0x128")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tgoto L_0016;\n\tv20 = *([1EE6F38]);\n\tv21 = *([v20 @ X8_v8]);\n\tv22 = \"il2cpp_codegen_initialize_method\"(v21, methodInfo, v24, v25, v26, v27, v28, v29, v30, v31, v32, v33, v34, v35, v36, v37);\n\tv40 = 0 | 1;\n\t*([202242F]) = v40;\nL_0016:\n\tHutongGames.PlayMaker.FsmStateAction::Reset(this);\n\tv46 = new HutongGames.PlayMaker.FsmString();\n\tHutongGames.PlayMaker.FsmString::.ctor(v46);\n\tv46.useVariable = 0;\n\tthis.stringAsId = v46;\n\tv51 = new HutongGames.PlayMaker.FsmString();\n\tHutongGames.PlayMaker.FsmString::.ctor(v51);\n\tv51.useVariable = 0;\n\tthis.tagAsId = v51;\n\tv62 = new HutongGames.PlayMaker.FsmGameObject();\n\tHutongGames.PlayMaker.FsmGameObject::.ctor(v62);\n\tv62.useVariable = 0;\n\tHutongGames.PlayMaker.FsmGameObject::set_Value(v62, 0);\n\tthis.gameObjectAsId = v62;\n\tv63 = new HutongGames.PlayMaker.FsmBool();\n\tHutongGames.PlayMaker.FsmBool::.ctor(v63);\n\tv63.useVariable = 0;\n\tv63.value = 0;\n\tthis.withCallbacks = v63;\n\tv64 = new HutongGames.PlayMaker.FsmBool();\n\tHutongGames.PlayMaker.FsmBool::.ctor(v64);\n\tv64.value = 0;\n\tthis.debugThis = v64;\n\treturn;\n\tthrow System.NullReferenceException;\n\treturn;\n// 57 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		...
		public override void OnEnter()
		{
			...
			goto IL_0198;
			IL_0198:
			bool value6 = withCallbacks.Value;
			int num2 = DOTween.Complete(targetOrId, value6);
			num = num2;
			goto IL_01ca;
			IL_01ca:
			if (debugThis.Value)
			{
				object obj = num;
				string message = string.Concat("DOTween Control Methods Complete By Id - Completed ", obj, " tweens");
				State.Debug(message);
			}
			Finish();
		}
		...
		[Address(RVA = "0xAF05A0", Offset = "0xAF05A0", Length = "0x8")]
		[NativeSource(Body = "// Approximate reconstruction from native code. Reads as C#; does not compile.\n\tHutongGames.PlayMaker.FsmStateAction::.ctor(this);\n\treturn;\n// 1 bookkeeping instructions omitted: flag registers, address bases and no-ops.\n")]
		public DOTweenControlMethodsCompleteById()
		{
		}
	}
}
