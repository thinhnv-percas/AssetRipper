	...
	public class GetCollision2dInfo : FsmStateAction
	{
		...
		private void StoreCollisionInfo()
		{
			...
			if (contacts3.Length != 0)
			{
				...
				Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163E178 (inside UnityEngine.Physics2D::get_queriesHitTriggers +0x34)");
				...
				if (contacts4.Length != 0)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163E180 (inside UnityEngine.Physics2D::get_queriesHitTriggers +0x3C)");
