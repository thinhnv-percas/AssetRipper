		...
		private void GetTransitionInfo()
		{
			...
			if (_animator != null)
			{
				...
				if (!nameHash.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163908C (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0x20C)");
				...
				if (!userNameHash.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @1639094 (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0x214)");
				...
				if (!normalizedTime.IsNone)
				{
					...
					Il2CppRuntime.Boundary("UNKNOWN", "Method not found @163909C (inside UnityEngine.AnimatorOverrideController+OnOverrideControllerDirtyCallback::EndInvoke +0x21C)");
