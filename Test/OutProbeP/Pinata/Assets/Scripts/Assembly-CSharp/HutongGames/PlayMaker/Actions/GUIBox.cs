	...
	public class GUIBox : GUIContentAction
	{
		...
		public override void OnGUI()
		{
			...
			else
			{
				...
				GUI.Box(position2, content, gUIStyle);
			}
		}

		[Token(Token = "0x6000A6C")]
		[Address(RVA = "0xB7814C", Offset = "0xB7814C", Length = "0x8")]
