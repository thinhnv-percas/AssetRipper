...
public class AppsFlyer : MonoBehaviour
{
	...
	{
		Il2CppRuntime.Boundary("UNKNOWN", "Method not found @16677D4 (inside AppsFlyerTrackerCallbacks::.ctor +0xC)");
	}
	...
	private unsafe static AndroidJavaObject ConvertHashMap(Dictionary<string, string> dict)
	{
		...
		//IL_08f5: Expected O, but got I8
		//IL_090b: Expected O, but got I8
