...
public static class BoxedTextColor
{
	...
	private static readonly object[] boxedColors = new object[300]
	{
		Text, Operator, Punctuation, Number, Comment, Keyword, String, VerbatimString, Char, Namespace,
		Type, SealedType, StaticType, Delegate, Enum, Interface, ValueType, Module, TypeGenericParameter, MethodGenericParameter,
		InstanceMethod, StaticMethod, ExtensionMethod, InstanceField, EnumField, LiteralField, StaticField, InstanceEvent, StaticEvent, InstanceProperty,
		StaticProperty, Local, Parameter, PreprocessorKeyword, PreprocessorText, Label, OpCode, ILDirective, ILModule, ExcludedCode,
		XmlDocCommentAttributeName, XmlDocCommentAttributeQuotes, XmlDocCommentAttributeValue, XmlDocCommentCDataSection, XmlDocCommentComment, XmlDocCommentDelimiter, XmlDocCommentEntityReference, XmlDocCommentName, XmlDocCommentProcessingInstruction, XmlDocCommentText,
		XmlLiteralAttributeName, XmlLiteralAttributeQuotes, XmlLiteralAttributeValue, XmlLiteralCDataSection, XmlLiteralComment, XmlLiteralDelimiter, XmlLiteralEmbeddedExpression, XmlLiteralEntityReference, XmlLiteralName, XmlLiteralProcessingInstruction,
		XmlLiteralText, XmlAttribute, XmlAttributeQuotes, XmlAttributeValue, XmlCDataSection, XmlComment, XmlDelimiter, XmlKeyword, XmlName, XmlProcessingInstruction,
		XmlText, XamlAttribute, XamlAttributeQuotes, XamlAttributeValue, XamlCDataSection, XamlComment, XamlDelimiter, XamlKeyword, XamlMarkupExtensionClass, XamlMarkupExtensionParameterName,
		XamlMarkupExtensionParameterValue, XamlName, XamlProcessingInstruction, XamlText, XmlDocToolTipHeader, Assembly, AssemblyExe, AssemblyModule, DirectoryPart, FileNameNoExtension,
		FileExtension, Error, ToStringEval, ReplPrompt1, ReplPrompt2, ReplOutputText, ReplScriptOutputText, Black, Blue, Cyan,
		DarkBlue, DarkCyan, DarkGray, DarkGreen, DarkMagenta, DarkRed, DarkYellow, Gray, Green, Magenta,
		Red, White, Yellow, InvBlack, InvBlue, InvCyan, InvDarkBlue, InvDarkCyan, InvDarkGray, InvDarkGreen,
		InvDarkMagenta, InvDarkRed, InvDarkYellow, InvGray, InvGreen, InvMagenta, InvRed, InvWhite, InvYellow, DebugLogExceptionHandled,
		DebugLogExceptionUnhandled, DebugLogStepFiltering, DebugLogLoadModule, DebugLogUnloadModule, DebugLogExitProcess, DebugLogExitThread, DebugLogProgramOutput, DebugLogMDA, DebugLogTimestamp, LineNumber,
		ReplLineNumberInput1, ReplLineNumberInput2, ReplLineNumberOutput, VisibleWhitespace, SelectedText, InactiveSelectedText, HighlightedReference, HighlightedWrittenReference, HighlightedDefinition, CurrentStatement,
		CurrentStatementMarker, CallReturn, CallReturnMarker, ActiveStatementMarker, BreakpointStatement, BreakpointStatementMarker, SelectedBreakpointStatementMarker, DisabledBreakpointStatementMarker, CurrentLine, CurrentLineNoFocus,
		HexText, HexOffset, HexByte0, HexByte1, HexByteError, HexAscii, HexCaret, HexInactiveCaret, HexSelection, GlyphMargin,
		BraceMatching, LineSeparator, FindMatchHighlightMarker, BlockStructureNamespace, BlockStructureType, BlockStructureModule, BlockStructureValueType, BlockStructureInterface, BlockStructureMethod, BlockStructureAccessor,
		BlockStructureAnonymousMethod, BlockStructureConstructor, BlockStructureDestructor, BlockStructureOperator, BlockStructureConditional, BlockStructureLoop, BlockStructureProperty, BlockStructureEvent, BlockStructureTry, BlockStructureCatch,
		BlockStructureFilter, BlockStructureFinally, BlockStructureFault, BlockStructureLock, BlockStructureUsing, BlockStructureFixed, BlockStructureSwitch, BlockStructureCase, BlockStructureLocalFunction, BlockStructureOther,
		BlockStructureXml, BlockStructureXaml, CompletionMatchHighlight, CompletionSuffix, SignatureHelpDocumentation, SignatureHelpCurrentParameter, SignatureHelpParameter, SignatureHelpParameterDocumentation, Url, HexPeDosHeader,
		HexPeFileHeader, HexPeOptionalHeader32, HexPeOptionalHeader64, HexPeSection, HexPeSectionName, HexCor20Header, HexStorageSignature, HexStorageHeader, HexStorageStream, HexStorageStreamName,
		HexStorageStreamNameInvalid, HexTablesStream, HexTableName, DocumentListMatchHighlight, GacMatchHighlight, AppSettingsTreeViewNodeMatchHighlight, AppSettingsTextMatchHighlight, HexCurrentLine, HexCurrentLineNoFocus, HexInactiveSelectedText,
		HexColumnLine0, HexColumnLine1, HexColumnLineGroup0, HexColumnLineGroup1, HexHighlightedValuesColumn, HexHighlightedAsciiColumn, HexGlyphMargin, HexCurrentValueCell, HexCurrentAsciiCell, OutputWindowText,
		HexFindMatchHighlightMarker, HexToolTipServiceField0, HexToolTipServiceField1, HexToolTipServiceCurrentField, ListFindMatchHighlight, AdvancedBreakpointStatement, AdvancedBreakpointStatementMarker, SelectedAdvancedBreakpointStatementMarker, DisabledAdvancedBreakpointStatement, DisabledAdvancedBreakpointStatementMarker,
		SelectedDisabledAdvancedBreakpointStatementMarker, BreakpointWarningStatement, BreakpointWarningStatementMarker, SelectedBreakpointWarningStatementMarker, BreakpointErrorStatement, BreakpointErrorStatementMarker, SelectedBreakpointErrorStatementMarker, AdvancedBreakpointWarningStatement, AdvancedBreakpointWarningStatementMarker, SelectedAdvancedBreakpointWarningStatementMarker,
		AdvancedBreakpointErrorStatement, AdvancedBreakpointErrorStatementMarker, SelectedAdvancedBreakpointErrorStatementMarker, TracepointStatement, TracepointStatementMarker, SelectedTracepointStatementMarker, DisabledTracepointStatement, DisabledTracepointStatementMarker, SelectedDisabledTracepointStatementMarker, AdvancedTracepointStatement,
		AdvancedTracepointStatementMarker, SelectedAdvancedTracepointStatementMarker, DisabledAdvancedTracepointStatement, DisabledAdvancedTracepointStatementMarker, SelectedDisabledAdvancedTracepointStatementMarker, TracepointWarningStatement, TracepointWarningStatementMarker, SelectedTracepointWarningStatementMarker, TracepointErrorStatement, TracepointErrorStatementMarker,
		SelectedTracepointErrorStatementMarker, AdvancedTracepointWarningStatement, AdvancedTracepointWarningStatementMarker, SelectedAdvancedTracepointWarningStatementMarker, AdvancedTracepointErrorStatement, AdvancedTracepointErrorStatementMarker, SelectedAdvancedTracepointErrorStatementMarker, BookmarkName, ActiveBookmarkName, DebugLogTrace,
		DebugLogExtensionMessage, DebuggerValueChangedHighlight, DebugExceptionName, DebugStowedExceptionName, DebugReturnValueName, DebugVariableName, DebugObjectIdName, DebuggerDisplayAttributeEval, DebuggerNoStringQuotesEval, DebugViewPropertyName
	};

	public static object Box(this TextColor color)
	{
		Debug.Assert(TextColor.Text <= color && color < TextColor.Last);
		if ((uint)color < (uint)boxedColors.Length)
		{
			return boxedColors[(int)color];
		}
		return Text;
	}
}
