...
internal sealed class SingleProducerSingleConsumerQueue<T> : System.Threading.Tasks.IProducerConsumerQueue<T>, IEnumerable<T>, IEnumerable
{
	...
	{
		internal System.Threading.Tasks.PaddingFor32 m_pad0;

		internal volatile int m_first;

		internal int m_lastCopy;

		internal System.Threading.Tasks.PaddingFor32 m_pad1;

		internal int m_firstCopy;

		internal volatile int m_last;

		internal System.Threading.Tasks.PaddingFor32 m_pad2;
	}

	private sealed class SingleProducerSingleConsumerQueue_DebugView
	{
		private readonly System.Threading.Tasks.SingleProducerSingleConsumerQueue<T> m_queue;
