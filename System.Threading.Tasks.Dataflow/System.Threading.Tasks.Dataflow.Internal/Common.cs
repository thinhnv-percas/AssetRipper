...
internal static class Common
{
	...
	internal static WeakReference<T> WrapWeakReference<T>(T state) where T : class
	{
	...
	internal static void WireCancellationToComplete(CancellationToken cancellationToken, Task completionTask, Action<object> completeAction, object completeState)
	{
		...
		else if (cancellationToken.CanBeCanceled)
		{
			...
			{
				SafeDisposeTokenRegistration((CancellationTokenRegistration)state);
	...
	internal static void ThrowAsync(Exception error)
	{
		...
		System.Threading.Tasks.Dataflow.Internal.Threading.ThreadPool.QueueUserWorkItem(delegate(object obj)
		{
