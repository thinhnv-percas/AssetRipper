...
public abstract class Conversion : IEquatable<Conversion>
{
	...
	private sealed class NumericOrEnumerationConversion : Conversion
	{
		...
		{
			if (other is NumericOrEnumerationConversion numericOrEnumerationConversion && isImplicit == numericOrEnumerationConversion.isImplicit && isLifted == numericOrEnumerationConversion.isLifted)
			{
	...
	private sealed class UserDefinedConv : Conversion
	{
		...
		public override bool Equals(Conversion other)
		{
			if (other is UserDefinedConv userDefinedConv && isLifted == userDefinedConv.isLifted && isImplicit == userDefinedConv.isImplicit && isValid == userDefinedConv.isValid)
			{
	...
	private sealed class MethodGroupConv : Conversion
	{
		...
		public override bool Equals(Conversion other)
		{
			if (other is MethodGroupConv methodGroupConv)
			{
