...
public class DefaultUnresolvedTypeDefinition : AbstractUnresolvedEntity, IUnresolvedTypeDefinition, ITypeReference, IUnresolvedEntity, INamedElement, IHasAccessibility
{
	...
	public FullTypeName FullTypeName
	{
		get
		{
			IUnresolvedTypeDefinition unresolvedTypeDefinition = base.DeclaringTypeDefinition;
			return unresolvedTypeDefinition?.FullTypeName.NestedType(base.Name, TypeParameters.Count - unresolvedTypeDefinition.TypeParameters.Count) ?? ((FullTypeName)new TopLevelTypeName(namespaceName, base.Name, TypeParameters.Count));
		}
	}
