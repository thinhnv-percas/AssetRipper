...
public sealed class SimpleInterningProvider : InterningProvider
{
	...
	public override ISupportsInterning Intern(ISupportsInterning obj)
	{
		...
		if (supportsInternDict.TryGetValue(obj, out var value))
		{
			return value;
		}
	...
	public override string Intern(string text)
	{
		...
		if (byValueDict.TryGetValue(text, out var value))
		{
			return (string)value;
		}
		return text;
	...
	public override object InternValue(object obj)
	{
		...
		if (byValueDict.TryGetValue(obj, out var value))
		{
			return value;
		}
		return obj;
	...
	public override IList<T> InternList<T>(IList<T> list)
	{
		...
		if (listDict.TryGetValue(list, out var value))
		{
			list = (IList<T>)value;
		}
		else
