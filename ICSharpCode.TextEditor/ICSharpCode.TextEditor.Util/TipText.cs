...
internal class TipText : TipSection
{
	...
	{
		StringFormat obj = (StringFormat)StringFormat.GenericTypographic.Clone();
		obj.FormatFlags = StringFormatFlags.FitBlackBox | StringFormatFlags.MeasureTrailingSpaces;
		obj.Alignment = horizontalAlignment;
		obj.LineAlignment = verticalAlignment;
		return obj;
	}
