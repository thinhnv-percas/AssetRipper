...
public class EnumMemberDeclaration : EntityDeclaration
{
	...
	{
		if (other is EnumMemberDeclaration enumMemberDeclaration && MatchAttributesAndModifiers(enumMemberDeclaration, match) && AstNode.MatchString(Name, enumMemberDeclaration.Name))
		{
			return Initializer.DoMatch(enumMemberDeclaration.Initializer, match);
		}
		return false;
	}
}
