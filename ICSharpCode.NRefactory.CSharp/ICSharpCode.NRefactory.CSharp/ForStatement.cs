...
public class ForStatement : Statement
{
	...
	{
		if (other is ForStatement forStatement && Initializers.DoMatch(forStatement.Initializers, match) && Condition.DoMatch(forStatement.Condition, match) && Iterators.DoMatch(forStatement.Iterators, match))
		{
