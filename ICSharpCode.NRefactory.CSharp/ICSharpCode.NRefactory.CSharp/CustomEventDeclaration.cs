...
public class CustomEventDeclaration : EntityDeclaration
{
	...
	{
		if (other is CustomEventDeclaration customEventDeclaration && AstNode.MatchString(Name, customEventDeclaration.Name) && MatchAttributesAndModifiers(customEventDeclaration, match) && ReturnType.DoMatch(customEventDeclaration.ReturnType, match) && PrivateImplementationType.DoMatch(customEventDeclaration.PrivateImplementationType, match) && AddAccessor.DoMatch(customEventDeclaration.AddAccessor, match))
		{
