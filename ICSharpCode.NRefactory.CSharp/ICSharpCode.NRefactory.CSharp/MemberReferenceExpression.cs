...
public class MemberReferenceExpression : Expression
{
	...
	{
		if (other is MemberReferenceExpression memberReferenceExpression && Target.DoMatch(memberReferenceExpression.Target, match) && AstNode.MatchString(MemberName, memberReferenceExpression.MemberName))
		{
