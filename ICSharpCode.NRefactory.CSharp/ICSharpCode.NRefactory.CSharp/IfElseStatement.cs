...
public class IfElseStatement : Statement
{
	...
	{
		if (other is IfElseStatement ifElseStatement && Condition.DoMatch(ifElseStatement.Condition, match) && TrueStatement.DoMatch(ifElseStatement.TrueStatement, match))
		{
