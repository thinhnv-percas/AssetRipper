...
public class ConditionalExpression : Expression
{
	...
	{
		if (other is ConditionalExpression conditionalExpression && Condition.DoMatch(conditionalExpression.Condition, match) && TrueExpression.DoMatch(conditionalExpression.TrueExpression, match))
		{
