...
public class TryCatchStatement : Statement
{
	...
	{
		if (other is TryCatchStatement tryCatchStatement && TryBlock.DoMatch(tryCatchStatement.TryBlock, match) && CatchClauses.DoMatch(tryCatchStatement.CatchClauses, match))
		{
