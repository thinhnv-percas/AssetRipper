...
public sealed class MemberTypeOrNamespaceReference : TypeOrNamespaceReference, ISupportsInterning
{
	...
	{
		if (other is MemberTypeOrNamespaceReference memberTypeOrNamespaceReference && target == memberTypeOrNamespaceReference.target && identifier == memberTypeOrNamespaceReference.identifier && typeArguments == memberTypeOrNamespaceReference.typeArguments)
		{
