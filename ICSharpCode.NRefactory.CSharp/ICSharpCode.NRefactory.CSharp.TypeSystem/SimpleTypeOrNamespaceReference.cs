...
public sealed class SimpleTypeOrNamespaceReference : TypeOrNamespaceReference, ISupportsInterning
{
	...
	{
		if (other is SimpleTypeOrNamespaceReference simpleTypeOrNamespaceReference && identifier == simpleTypeOrNamespaceReference.identifier && typeArguments == simpleTypeOrNamespaceReference.typeArguments)
		{
