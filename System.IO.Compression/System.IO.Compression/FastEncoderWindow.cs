...
internal sealed class FastEncoderWindow
{
	...
	public System.IO.Compression.DeflateInput UnprocessedInput
	{
		get
		{
			System.IO.Compression.DeflateInput deflateInput = new System.IO.Compression.DeflateInput();
			deflateInput.Buffer = _window;
			deflateInput.StartIndex = _bufPos;
			deflateInput.Count = _bufEnd - _bufPos;
			return deflateInput;
		}
	}
	...
	internal bool GetNextSymbolOrMatch(System.IO.Compression.Match match)
	{
