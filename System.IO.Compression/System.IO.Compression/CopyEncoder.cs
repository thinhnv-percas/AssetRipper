...
internal sealed class CopyEncoder
{
	...
	public void GetBlock(System.IO.Compression.DeflateInput input, System.IO.Compression.OutputBuffer output, bool isFinal)
	{
		int num = 0;
		if (input != null)
		{
	...
	private void WriteLenNLen(ushort len, System.IO.Compression.OutputBuffer output)
	{
