...
internal sealed class DeflaterManaged : IDisposable
{
	...
	{
		_deflateEncoder = new System.IO.Compression.FastEncoder();
		_copyEncoder = new System.IO.Compression.CopyEncoder();
		_input = new System.IO.Compression.DeflateInput();
		_output = new System.IO.Compression.OutputBuffer();
	...
	internal int GetDeflateOutput(byte[] outputBuffer)
	{
		...
		case DeflaterState.NotStarted:
		{
			System.IO.Compression.DeflateInput.InputState state3 = _input.DumpState();
			System.IO.Compression.OutputBuffer.BufferState state4 = _output.DumpState();
		...
		case DeflaterState.CheckingForIncompressible:
		{
			System.IO.Compression.DeflateInput.InputState state = _input.DumpState();
			System.IO.Compression.OutputBuffer.BufferState state2 = _output.DumpState();
