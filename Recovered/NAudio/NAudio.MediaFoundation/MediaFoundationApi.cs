...
namespace NAudio.MediaFoundation
{
	public static class MediaFoundationApi
	{
		...
		{
			MediaFoundationInterop.MFTEnumEx(category, _MFT_ENUM_FLAG.MFT_ENUM_FLAG_ALL, null, null, out IntPtr interfacesPointer, out int pcMFTActivate);
		...
		public static IMFByteStream CreateByteStream(object stream)
		{
			...
			{
				MediaFoundationInterop.MFCreateMFByteStreamOnStream(stream as IStream, out IMFByteStream ppByteStream);
				return ppByteStream;
			}
