...
namespace NAudio.CoreAudioApi
{
	public class AudioSessionControl : IDisposable
	{
		...
		public string DisplayName
		{
			get
			{
				Marshal.ThrowExceptionForHR(audioSessionControlInterface.GetDisplayName(out string displayName));
				return displayName;
			}
			set
			{
		...
		public string IconPath
		{
			get
			{
				Marshal.ThrowExceptionForHR(audioSessionControlInterface.GetIconPath(out string iconPath));
				return iconPath;
			}
			set
			{
		...
		{
			Marshal.ThrowExceptionForHR(audioSessionControlInterface.GetGroupingParam(out Guid groupingId));
			return groupingId;
		}
