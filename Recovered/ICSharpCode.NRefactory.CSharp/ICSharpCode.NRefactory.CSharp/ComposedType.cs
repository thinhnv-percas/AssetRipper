...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ComposedType : AstType
	{
		...
		protected internal override bool DoMatch(AstNode other, Match match)
		{
			...
			if (composedType != null && HasNullableSpecifier == composedType.HasNullableSpecifier && PointerRank == composedType.PointerRank && HasRefSpecifier == composedType.HasRefSpecifier && BaseType.DoMatch(composedType.BaseType, match))
			{
