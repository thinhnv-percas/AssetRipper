...
namespace ICSharpCode.NRefactory.CSharp
{
	public class UnaryOperatorExpression : Expression
	{
		...
		{
			UnaryOperatorExpression unaryOperatorExpression = other as UnaryOperatorExpression;
			if (unaryOperatorExpression != null && (Operator == UnaryOperatorType.Any || Operator == unaryOperatorExpression.Operator))
			{
