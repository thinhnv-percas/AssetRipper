...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ForeachStatement : Statement
	{
		...
		{
			ForeachStatement foreachStatement = other as ForeachStatement;
			if (foreachStatement != null && VariableType.DoMatch(foreachStatement.VariableType, match) && AstNode.MatchString(VariableName, foreachStatement.VariableName) && InExpression.DoMatch(foreachStatement.InExpression, match))
			{
