...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ObjectCreateExpression : Expression
	{
		...
		{
			ObjectCreateExpression objectCreateExpression = other as ObjectCreateExpression;
			if (objectCreateExpression != null && Type.DoMatch(objectCreateExpression.Type, match) && Arguments.DoMatch(objectCreateExpression.Arguments, match))
			{
