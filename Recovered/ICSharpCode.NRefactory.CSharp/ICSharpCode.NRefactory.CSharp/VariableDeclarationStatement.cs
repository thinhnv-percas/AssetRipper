...
namespace ICSharpCode.NRefactory.CSharp
{
	public class VariableDeclarationStatement : Statement
	{
		...
		{
			VariableDeclarationStatement variableDeclarationStatement = other as VariableDeclarationStatement;
			if (variableDeclarationStatement != null && Modifiers == variableDeclarationStatement.Modifiers && Type.DoMatch(variableDeclarationStatement.Type, match))
			{
