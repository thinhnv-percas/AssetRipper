...
namespace ICSharpCode.NRefactory.CSharp
{
	public class AnonymousMethodExpression : Expression
	{
		...
		{
			AnonymousMethodExpression anonymousMethodExpression = other as AnonymousMethodExpression;
			if (anonymousMethodExpression != null && IsAsync == anonymousMethodExpression.IsAsync && HasParameterList == anonymousMethodExpression.HasParameterList && Parameters.DoMatch(anonymousMethodExpression.Parameters, match))
			{
