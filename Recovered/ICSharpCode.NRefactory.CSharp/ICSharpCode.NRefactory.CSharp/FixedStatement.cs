...
namespace ICSharpCode.NRefactory.CSharp
{
	public class FixedStatement : Statement
	{
		...
		{
			FixedStatement fixedStatement = other as FixedStatement;
			if (fixedStatement != null && Type.DoMatch(fixedStatement.Type, match) && Variables.DoMatch(fixedStatement.Variables, match))
			{
