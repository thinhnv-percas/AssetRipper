...
namespace ICSharpCode.NRefactory.CSharp
{
	public class InsertParenthesesVisitor : DepthFirstAstVisitor
	{
		...
		private static int GetPrecedence(Expression expr)
		{
			...
			{
				if (unaryOperatorExpression.Operator == UnaryOperatorType.PostDecrement || unaryOperatorExpression.Operator == UnaryOperatorType.PostIncrement)
				{
					return 16;
				}
				return 14;
			...
			{
				object value = ((PrimitiveExpression)expr).Value;
		...
		{
			ParenthesizeIfRequired(memberReferenceExpression.Target, 16);
			base.VisitMemberReferenceExpression(memberReferenceExpression);
		}

		public override void VisitPointerReferenceExpression(PointerReferenceExpression pointerReferenceExpression)
		{
			ParenthesizeIfRequired(pointerReferenceExpression.Target, 16);
			base.VisitPointerReferenceExpression(pointerReferenceExpression);
		}

		public override void VisitInvocationExpression(InvocationExpression invocationExpression)
		{
			ParenthesizeIfRequired(invocationExpression.Target, 16);
			base.VisitInvocationExpression(invocationExpression);
		}

		public override void VisitIndexerExpression(IndexerExpression indexerExpression)
		{
			ParenthesizeIfRequired(indexerExpression.Target, 16);
			ArrayCreateExpression arrayCreateExpression = indexerExpression.Target as ArrayCreateExpression;
			if (arrayCreateExpression != null && (InsertParenthesesForReadability || arrayCreateExpression.Initializer.IsNull))
			{
		...
		public override void VisitUnaryOperatorExpression(UnaryOperatorExpression unaryOperatorExpression)
		{
			...
			UnaryOperatorExpression unaryOperatorExpression2 = unaryOperatorExpression.Expression as UnaryOperatorExpression;
			if (unaryOperatorExpression2 != null && InsertParenthesesForReadability)
			{
				Parenthesize(unaryOperatorExpression2);
			}
		...
		public override void VisitCastExpression(CastExpression castExpression)
		{
			...
			UnaryOperatorExpression unaryOperatorExpression = castExpression.Expression as UnaryOperatorExpression;
			if (unaryOperatorExpression != null && unaryOperatorExpression.Operator != UnaryOperatorType.BitNot && unaryOperatorExpression.Operator != UnaryOperatorType.Not && TypeCanBeMisinterpretedAsExpression(castExpression.Type))
			{
				Parenthesize(castExpression.Expression);
			}
			PrimitiveExpression primitiveExpression = castExpression.Expression as PrimitiveExpression;
			if (primitiveExpression != null && primitiveExpression.Value != null && TypeCanBeMisinterpretedAsExpression(castExpression.Type))
			{
				...
				case TypeCode.Decimal:
					if ((decimal)primitiveExpression.Value < decimal.Zero)
					{
						Parenthesize(castExpression.Expression);
					}
					break;
		...
		public override void VisitBinaryOperatorExpression(BinaryOperatorExpression binaryOperatorExpression)
		{
			...
			else if (InsertParenthesesForReadability && precedence < 9)
			{
				...
				{
					ParenthesizeIfRequired(binaryOperatorExpression.Left, 9);
				}
				ParenthesizeIfRequired(binaryOperatorExpression.Right, 9);
			}
			else
			{
				ParenthesizeIfRequired(binaryOperatorExpression.Left, precedence);
		...
		{
			return (expr as BinaryOperatorExpression)?.Operator;
		}
