...
namespace ICSharpCode.NRefactory.CSharp
{
	public class FixedFieldDeclaration : EntityDeclaration
	{
		...
		{
			FixedFieldDeclaration fixedFieldDeclaration = other as FixedFieldDeclaration;
			if (fixedFieldDeclaration != null && MatchAttributesAndModifiers(fixedFieldDeclaration, match) && ReturnType.DoMatch(fixedFieldDeclaration.ReturnType, match))
			{
