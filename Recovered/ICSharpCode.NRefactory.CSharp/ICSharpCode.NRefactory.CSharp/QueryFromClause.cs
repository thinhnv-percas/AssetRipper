...
namespace ICSharpCode.NRefactory.CSharp
{
	public class QueryFromClause : QueryClause
	{
		...
		{
			QueryFromClause queryFromClause = other as QueryFromClause;
			if (queryFromClause != null && Type.DoMatch(queryFromClause.Type, match) && AstNode.MatchString(Identifier, queryFromClause.Identifier))
			{
