...
namespace ICSharpCode.NRefactory.CSharp
{
	public class DirectionExpression : Expression
	{
		...
		public CSharpTokenNode FieldDirectionToken
		{
			get
			{
				if (FieldDirection != FieldDirection.Ref)
				{
		...
		{
			DirectionExpression directionExpression = other as DirectionExpression;
			if (directionExpression != null && FieldDirection == directionExpression.FieldDirection)
			{
