...
namespace ICSharpCode.NRefactory.CSharp
{
	public class LambdaExpression : Expression
	{
		...
		{
			LambdaExpression lambdaExpression = other as LambdaExpression;
			if (lambdaExpression != null && IsAsync == lambdaExpression.IsAsync && Parameters.DoMatch(lambdaExpression.Parameters, match))
			{
