...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ConstructorDeclaration : EntityDeclaration
	{
		...
		{
			ConstructorDeclaration constructorDeclaration = other as ConstructorDeclaration;
			if (constructorDeclaration != null && MatchAttributesAndModifiers(constructorDeclaration, match) && Parameters.DoMatch(constructorDeclaration.Parameters, match) && Initializer.DoMatch(constructorDeclaration.Initializer, match))
			{
