...
namespace ICSharpCode.NRefactory.CSharp
{
	public class NamedArgumentExpression : Expression
	{
		...
		{
			NamedArgumentExpression namedArgumentExpression = other as NamedArgumentExpression;
			if (namedArgumentExpression != null && AstNode.MatchString(Name, namedArgumentExpression.Name))
			{
