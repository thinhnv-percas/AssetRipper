...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ParameterDeclaration : AstNode
	{
		...
		{
			ParameterDeclaration parameterDeclaration = other as ParameterDeclaration;
			if (parameterDeclaration != null && Attributes.DoMatch(parameterDeclaration.Attributes, match) && ParameterModifier == parameterDeclaration.ParameterModifier && Type.DoMatch(parameterDeclaration.Type, match) && AstNode.MatchString(Name, parameterDeclaration.Name))
			{
