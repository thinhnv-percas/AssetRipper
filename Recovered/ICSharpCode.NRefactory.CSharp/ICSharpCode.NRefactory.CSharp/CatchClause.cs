...
namespace ICSharpCode.NRefactory.CSharp
{
	public class CatchClause : AstNode
	{
		...
		protected internal override bool DoMatch(AstNode other, Match match)
		{
			CatchClause catchClause = other as CatchClause;
			if (catchClause != null && Type.DoMatch(catchClause.Type, match) && AstNode.MatchString(VariableName, catchClause.VariableName))
			{
				return Body.DoMatch(catchClause.Body, match);
			}
			return false;
		}
	}
