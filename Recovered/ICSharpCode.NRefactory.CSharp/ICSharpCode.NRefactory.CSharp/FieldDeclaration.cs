...
namespace ICSharpCode.NRefactory.CSharp
{
	public class FieldDeclaration : EntityDeclaration
	{
		...
		{
			FieldDeclaration fieldDeclaration = other as FieldDeclaration;
			if (fieldDeclaration != null && MatchAttributesAndModifiers(fieldDeclaration, match) && ReturnType.DoMatch(fieldDeclaration.ReturnType, match))
			{
