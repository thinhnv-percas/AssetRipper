...
namespace ICSharpCode.NRefactory.CSharp
{
	public class UsingAliasDeclaration : AstNode
	{
		...
		{
			UsingAliasDeclaration usingAliasDeclaration = other as UsingAliasDeclaration;
			if (usingAliasDeclaration != null && AstNode.MatchString(Alias, usingAliasDeclaration.Alias))
			{
