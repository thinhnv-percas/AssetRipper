...
namespace ICSharpCode.NRefactory.CSharp
{
	public class DestructorDeclaration : EntityDeclaration
	{
		...
		{
			DestructorDeclaration destructorDeclaration = other as DestructorDeclaration;
			if (destructorDeclaration != null && MatchAttributesAndModifiers(destructorDeclaration, match))
			{
