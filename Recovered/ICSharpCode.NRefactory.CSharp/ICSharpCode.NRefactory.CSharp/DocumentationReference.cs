...
namespace ICSharpCode.NRefactory.CSharp
{
	public class DocumentationReference : AstNode
	{
		...
		{
			DocumentationReference documentationReference = other as DocumentationReference;
			if (documentationReference == null || SymbolKind != documentationReference.SymbolKind || HasParameterList != documentationReference.HasParameterList)
			{
				return false;
			}
