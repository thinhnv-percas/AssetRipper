...
namespace ICSharpCode.NRefactory.CSharp
{
	public class OperatorDeclaration : EntityDeclaration
	{
		...
		{
			OperatorDeclaration operatorDeclaration = other as OperatorDeclaration;
			if (operatorDeclaration != null && MatchAttributesAndModifiers(operatorDeclaration, match) && OperatorType == operatorDeclaration.OperatorType && ReturnType.DoMatch(operatorDeclaration.ReturnType, match) && Parameters.DoMatch(operatorDeclaration.Parameters, match))
			{
