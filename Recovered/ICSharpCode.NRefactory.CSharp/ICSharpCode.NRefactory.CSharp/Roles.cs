namespace ICSharpCode.NRefactory.CSharp
{
	public static class Roles
	{
		...
		public static readonly Role<Identifier> Identifier = new Role<Identifier>("Identifier", ICSharpCode.NRefactory.CSharp.Identifier.Null);
		...
		public static readonly Role<Expression> Argument = new Role<Expression>("Argument", ICSharpCode.NRefactory.CSharp.Expression.Null);

		public static readonly Role<AstType> Type = new Role<AstType>("Type", AstType.Null);

		public static readonly Role<Expression> Expression = new Role<Expression>("Expression", ICSharpCode.NRefactory.CSharp.Expression.Null);

		public static readonly Role<Expression> TargetExpression = new Role<Expression>("Target", ICSharpCode.NRefactory.CSharp.Expression.Null);

		public static readonly Role<Expression> Condition = new Role<Expression>("Condition", ICSharpCode.NRefactory.CSharp.Expression.Null);
