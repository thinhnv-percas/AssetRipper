...
namespace ICSharpCode.NRefactory.CSharp
{
	public class AsExpression : Expression
	{
		...
		{
			AsExpression asExpression = other as AsExpression;
			if (asExpression != null && Expression.DoMatch(asExpression.Expression, match))
			{
				return Type.DoMatch(asExpression.Type, match);
			}
			return false;
		}
