...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ForStatement : Statement
	{
		...
		{
			ForStatement forStatement = other as ForStatement;
			if (forStatement != null && Initializers.DoMatch(forStatement.Initializers, match) && Condition.DoMatch(forStatement.Condition, match) && Iterators.DoMatch(forStatement.Iterators, match))
			{
				return EmbeddedStatement.DoMatch(forStatement.EmbeddedStatement, match);
			}
			return false;
		}
	}
