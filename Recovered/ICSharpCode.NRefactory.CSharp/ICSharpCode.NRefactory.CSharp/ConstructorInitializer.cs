...
namespace ICSharpCode.NRefactory.CSharp
{
	public class ConstructorInitializer : AstNode
	{
		...
		protected internal override bool DoMatch(AstNode other, Match match)
		{
			ConstructorInitializer constructorInitializer = other as ConstructorInitializer;
			if (constructorInitializer != null && !constructorInitializer.IsNull && (ConstructorInitializerType == ConstructorInitializerType.Any || ConstructorInitializerType == constructorInitializer.ConstructorInitializerType))
			{
