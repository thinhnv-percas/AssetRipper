...
namespace ICSharpCode.NRefactory.CSharp
{
	public class AttributeSection : AstNode
	{
		...
		protected internal override bool DoMatch(AstNode other, Match match)
		{
			AttributeSection attributeSection = other as AttributeSection;
			if (attributeSection != null && AstNode.MatchString(AttributeTarget, attributeSection.AttributeTarget))
			{
