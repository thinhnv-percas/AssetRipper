...
namespace ICSharpCode.NRefactory.CSharp
{
	public class FixedVariableInitializer : AstNode
	{
		...
		{
			FixedVariableInitializer fixedVariableInitializer = other as FixedVariableInitializer;
			if (fixedVariableInitializer != null && AstNode.MatchString(Name, fixedVariableInitializer.Name))
			{
				return CountExpression.DoMatch(fixedVariableInitializer.CountExpression, match);
			}
			return false;
		}
	}
