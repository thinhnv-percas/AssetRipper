...
namespace ICSharpCode.NRefactory.CSharp.TypeSystem
{
	...
	public sealed class AttributeTypeReference : ITypeReference, ISupportsInterning
	{
		...
		{
			AttributeTypeReference attributeTypeReference = other as AttributeTypeReference;
			if (attributeTypeReference != null && withoutSuffix == attributeTypeReference.withoutSuffix)
			{
