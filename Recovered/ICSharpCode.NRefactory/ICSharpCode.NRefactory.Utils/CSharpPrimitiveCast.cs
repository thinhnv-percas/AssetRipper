			...
			checked
			{
				...
				case TypeCode.Char:
					unchecked
					{
						...
						{
						case TypeCode.SByte:
							return (char)checked((ushort)(sbyte)input);
						case TypeCode.Byte:
							return (char)(byte)input;
						case TypeCode.Int16:
							return (char)checked((ushort)(short)input);
						case TypeCode.UInt16:
							return (char)(ushort)input;
						case TypeCode.Int32:
							return (char)checked((ushort)(int)input);
						case TypeCode.UInt32:
							return (char)checked((ushort)(uint)input);
						case TypeCode.Int64:
							return (char)checked((ushort)(long)input);
						case TypeCode.UInt64:
							return (char)checked((ushort)(ulong)input);
						case TypeCode.Single:
							return (char)checked((ushort)(float)input);
						case TypeCode.Double:
							return (char)checked((ushort)(double)input);
				...
				case TypeCode.Int16:
					...
					case TypeCode.SByte:
						return unchecked((short)(sbyte)input);
					case TypeCode.Byte:
						return unchecked((short)(byte)input);
					case TypeCode.UInt16:
				...
				case TypeCode.UInt16:
					...
					{
					case TypeCode.Char:
						return unchecked((ushort)(char)input);
					case TypeCode.SByte:
						return (ushort)(sbyte)input;
					case TypeCode.Byte:
						return unchecked((ushort)(byte)input);
					case TypeCode.Int16:
				...
				case TypeCode.Int32:
					...
					{
					case TypeCode.Char:
						return unchecked((int)(char)input);
					case TypeCode.SByte:
						return unchecked((int)(sbyte)input);
					case TypeCode.Byte:
						return unchecked((int)(byte)input);
					case TypeCode.Int16:
						return unchecked((int)(short)input);
					case TypeCode.UInt16:
						return unchecked((int)(ushort)input);
					case TypeCode.UInt32:
				...
				case TypeCode.UInt32:
					...
					{
					case TypeCode.Char:
						return unchecked((uint)(char)input);
					case TypeCode.SByte:
						return (uint)(sbyte)input;
					case TypeCode.Byte:
						return unchecked((uint)(byte)input);
					case TypeCode.Int16:
						return (uint)(short)input;
					case TypeCode.UInt16:
						return unchecked((uint)(ushort)input);
					case TypeCode.Int32:
				...
				case TypeCode.Single:
					unchecked
					{
						...
						{
						case TypeCode.Char:
							return (float)(int)(char)input;
						case TypeCode.SByte:
							return (float)(sbyte)input;
						case TypeCode.Byte:
							return (float)(int)(byte)input;
						case TypeCode.Int16:
							return (float)(short)input;
						case TypeCode.UInt16:
							return (float)(int)(ushort)input;
						case TypeCode.Int32:
							return (float)(int)input;
						case TypeCode.UInt32:
							return (float)(double)(uint)input;
						case TypeCode.Int64:
							return (float)(long)input;
						case TypeCode.UInt64:
							return (float)(double)(ulong)input;
						case TypeCode.Double:
				...
				case TypeCode.Double:
					unchecked
					{
						...
						{
						case TypeCode.Char:
							return (double)(int)(char)input;
						case TypeCode.SByte:
							return (double)(sbyte)input;
						case TypeCode.Byte:
							return (double)(int)(byte)input;
						case TypeCode.Int16:
							return (double)(short)input;
						case TypeCode.UInt16:
							return (double)(int)(ushort)input;
						case TypeCode.Int32:
				...
				throw new InvalidCastException("Cast from " + typeCode + " to " + targetType + "not supported.");
			}
		}
