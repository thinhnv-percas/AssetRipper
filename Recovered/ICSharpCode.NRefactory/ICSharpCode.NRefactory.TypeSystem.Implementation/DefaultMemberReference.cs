...
namespace ICSharpCode.NRefactory.TypeSystem.Implementation
{
	...
	public sealed class DefaultMemberReference : IMemberReference, ISymbolReference, ISupportsInterning
	{
		...
		public IMember Resolve(ITypeResolveContext context)
		{
			...
			{
				IParameterizedMember parameterizedMember = item as IParameterizedMember;
		...
		bool ISupportsInterning.EqualsForInterning(ISupportsInterning other)
		{
			...
			if (defaultMemberReference != null && symbolKind == defaultMemberReference.symbolKind && typeReference == defaultMemberReference.typeReference && name == defaultMemberReference.name)
			{
