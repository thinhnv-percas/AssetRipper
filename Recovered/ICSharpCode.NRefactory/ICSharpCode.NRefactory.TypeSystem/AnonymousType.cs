...
namespace ICSharpCode.NRefactory.TypeSystem
{
	public class AnonymousType : AbstractType
	{
		private sealed class AnonymousTypeProperty : DefaultResolvedProperty
		{
			...
			{
				AnonymousTypeProperty anonymousTypeProperty = obj as AnonymousTypeProperty;
				if (anonymousTypeProperty != null && base.Name == anonymousTypeProperty.Name)
				{
		...
		private sealed class AnonymousTypeAccessor : DefaultResolvedMethod
		{
			...
			public override bool Equals(object obj)
			{
				AnonymousTypeAccessor anonymousTypeAccessor = obj as AnonymousTypeAccessor;
				if (anonymousTypeAccessor != null && base.Name == anonymousTypeAccessor.Name)
				{
		...
		public override bool Equals(IType other)
		{
			...
			if (anonymousType == null || resolvedProperties.Count != anonymousType.resolvedProperties.Count)
			{
				return false;
			}
