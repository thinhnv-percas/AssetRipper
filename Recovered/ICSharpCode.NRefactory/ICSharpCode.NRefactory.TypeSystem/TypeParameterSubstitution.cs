...
namespace ICSharpCode.NRefactory.TypeSystem
{
	public class TypeParameterSubstitution : TypeVisitor
	{
		...
		public static TypeParameterSubstitution Compose(TypeParameterSubstitution g, TypeParameterSubstitution f)
		{
			...
			IList<IType> obj = (f.classTypeArguments != null) ? GetComposedTypeArguments(f.classTypeArguments, g) : g.classTypeArguments;
			IList<IType> list = (f.methodTypeArguments != null) ? GetComposedTypeArguments(f.methodTypeArguments, g) : g.methodTypeArguments;
			return new TypeParameterSubstitution(obj, list);
		}
