...
namespace ICSharpCode.NRefactory.TypeSystem
{
	public static class NullableType
	{
		public static bool IsNullable(IType type)
		{
			...
			if (parameterizedType != null && parameterizedType.TypeParameterCount == 1)
			{
		...
		public static ParameterizedTypeReference Create(ITypeReference elementType)
		{
			...
			return new ParameterizedTypeReference(KnownTypeReference.NullableOfT, new ITypeReference[1]
			{
				elementType
			});
		}
