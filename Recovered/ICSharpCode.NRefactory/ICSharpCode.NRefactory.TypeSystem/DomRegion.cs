...
namespace ICSharpCode.NRefactory.TypeSystem
{
	...
	public struct DomRegion : IEquatable<DomRegion>
	{
		...
		{
			TextLocation left = (Begin > region.Begin) ? Begin : region.Begin;
			TextLocation right = (End < region.End) ? End : region.End;
			return left < right;
		}
		...
		{
			return ((fileName != null) ? fileName.GetHashCode() : 0) ^ (beginColumn + 1100009 * beginLine + 1200007 * endLine + 1300021 * endColumn);
		}
