...
namespace Mono.Cecil
{
	public class MetadataImporter : IMetadataImporter
	{
		...
		{
			if (module.TryGetAssemblyNameReference(name, out AssemblyNameReference assembly_reference))
			{
		...
		private TypeReference ImportTypeSpecification(TypeReference type, ImportGenericContext context)
		{
			...
			case ElementType.MVar:
			{
				...
				return context.MethodParameter(genericParameter.DeclaringMethod.Name, genericParameter.Position);
			}
			default:
