namespace System.Security.Cryptography
{
	internal class SHA1Internal
	{
		...
		private void ProcessBlock(byte[] inputBuffer, uint inputOffset)
		{
			...
			for (; i < 60; i += 5)
			{
				num5 = (uint)((int)num5 + ((int)(((num << 5) | (num >> 27)) + ((num2 & num3) | (num2 & num4) | (num3 & num4))) + -1894007588 + (int)array[i]));
				num2 = ((num2 << 30) | (num2 >> 2));
				num4 = (uint)((int)num4 + ((int)(((num5 << 5) | (num5 >> 27)) + ((num & num2) | (num & num3) | (num2 & num3))) + -1894007588 + (int)array[i + 1]));
				num = ((num << 30) | (num >> 2));
				num3 = (uint)((int)num3 + ((int)(((num4 << 5) | (num4 >> 27)) + ((num5 & num) | (num5 & num2) | (num & num2))) + -1894007588 + (int)array[i + 2]));
				num5 = ((num5 << 30) | (num5 >> 2));
				num2 = (uint)((int)num2 + ((int)(((num3 << 5) | (num3 >> 27)) + ((num4 & num5) | (num4 & num) | (num5 & num))) + -1894007588 + (int)array[i + 3]));
				num4 = ((num4 << 30) | (num4 >> 2));
				num = (uint)((int)num + ((int)(((num2 << 5) | (num2 >> 27)) + ((num3 & num4) | (num3 & num5) | (num4 & num5))) + -1894007588 + (int)array[i + 4]));
				num3 = ((num3 << 30) | (num3 >> 2));
			}
			for (; i < 80; i += 5)
			{
				num5 = (uint)((int)num5 + ((int)(((num << 5) | (num >> 27)) + (num2 ^ num3 ^ num4)) + -899497514 + (int)array[i]));
				num2 = ((num2 << 30) | (num2 >> 2));
				num4 = (uint)((int)num4 + ((int)(((num5 << 5) | (num5 >> 27)) + (num ^ num2 ^ num3)) + -899497514 + (int)array[i + 1]));
				num = ((num << 30) | (num >> 2));
				num3 = (uint)((int)num3 + ((int)(((num4 << 5) | (num4 >> 27)) + (num5 ^ num ^ num2)) + -899497514 + (int)array[i + 2]));
				num5 = ((num5 << 30) | (num5 >> 2));
				num2 = (uint)((int)num2 + ((int)(((num3 << 5) | (num3 >> 27)) + (num4 ^ num5 ^ num)) + -899497514 + (int)array[i + 3]));
				num4 = ((num4 << 30) | (num4 >> 2));
				num = (uint)((int)num + ((int)(((num2 << 5) | (num2 >> 27)) + (num3 ^ num4 ^ num5)) + -899497514 + (int)array[i + 4]));
				num3 = ((num3 << 30) | (num3 >> 2));
			}
			h[0] += num;
			h[1] += num2;
