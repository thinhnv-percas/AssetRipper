...
public static class FrameworkRedirect
{
	...
	{
		if (sourceModule != null && Utils.LocaleEquals(assembly.Culture, "") && (sourceModule.IsClr20 || sourceModule.IsClr40) && (sourceModule.IsClr20 ? frmRedir2 : frmRedir4).TryGetValue(assembly.Name, out var value) && PublicKeyBase.TokenCompareTo(assembly.PublicKeyOrToken, value.publicKeyToken) == 0 && Utils.CompareTo(assembly.Version, value.redirectVersion) != 0)
		{
			assembly = new AssemblyNameInfo(assembly);
			assembly.Version = value.redirectVersion;
		}
	}
}
