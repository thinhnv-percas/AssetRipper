...
internal sealed class InterfaceImplMD : InterfaceImpl, IMDTokenProviderMD, IMDTokenProvider
{
	...
	{
		RidList list = readerModule.Metadata.GetCustomAttributeRidList(Table.InterfaceImpl, origRid);
	...
	public InterfaceImplMD(ModuleDefMD readerModule, uint rid, GenericParamContext gpContext)
	{
		...
		bool condition = readerModule.TablesStream.TryReadInterfaceImplRow(origRid, out var row);
