...
public class RangeItemHeaderValue : ICloneable
{
	...
	internal static int GetRangeItemLength(string input, int startIndex, out RangeItemHeaderValue parsedValue)
	{
		...
		long result = 0L;
		if (numberLength > 0 && !HeaderUtilities.TryParseInt64(input.Substring(startIndex2, numberLength), out result))
		{
			return 0;
		}
		long result2 = 0L;
		if (num2 > 0 && !HeaderUtilities.TryParseInt64(input.Substring(startIndex3, num2), out result2))
		{
			return 0;
		}
