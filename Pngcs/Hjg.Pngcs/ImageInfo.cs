...
public class ImageInfo
{
	...
	{
		return "ImageInfo [cols=" + Cols + ", rows=" + Rows + ", bitDepth=" + BitDepth + ", channels=" + Channels + ", bitspPixel=" + BitspPixel + ", bytesPixel=" + BytesPixel + ", bytesPerRow=" + BytesPerRow + ", samplesPerRow=" + SamplesPerRow + ", samplesPerRowP=" + SamplesPerRowPacked + ", alpha=" + Alpha.ToString() + ", greyscale=" + Greyscale.ToString() + ", indexed=" + Indexed.ToString() + ", packed=" + Packed.ToString() + "]";
	}
