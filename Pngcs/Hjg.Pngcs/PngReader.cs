...
public class PngReader
{
	...
	public PngReader(Stream inputStream, string filename)
	{
		...
		SkipChunkIds = new string[1] { "fdAT" };
	...
	private PngChunk ReadChunk(byte[] chunkid, int clen, bool skipforced)
	{
		...
		{
			throw new PngjInputException("Maximum total bytes to read exceeeded: " + MaxTotalBytesRead + " offset:" + offset + " clen=" + clen);
		}
