...
public sealed class MetadataBuilder
{
	...
	private void SerializeTablesHeader(BlobBuilder writer, MetadataSizes metadataSizes)
	{
		...
		{
			heapSizeFlag |= (HeapSizeFlag)0xA0;
		}
		ulong num = metadataSizes.PresentTablesMask & 0xC4000000000000L;
		ulong value = num | (ulong)(metadataSizes.IsStandaloneDebugMetadata ? 0 : 24190111578624L);
