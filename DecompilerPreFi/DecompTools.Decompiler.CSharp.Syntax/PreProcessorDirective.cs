...
public class PreProcessorDirective : AstNode
{
	...
	{
		return other is PreProcessorDirective preProcessorDirective && Type == preProcessorDirective.Type && AstNode.MatchString(Argument, preProcessorDirective.Argument);
	}
}
