...
public class FixedFieldDeclaration : EntityDeclaration
{
	...
	{
		return other is FixedFieldDeclaration fixedFieldDeclaration && MatchAttributesAndModifiers(fixedFieldDeclaration, match) && ReturnType.DoMatch(fixedFieldDeclaration.ReturnType, match) && Variables.DoMatch(fixedFieldDeclaration.Variables, match);
	}
}
