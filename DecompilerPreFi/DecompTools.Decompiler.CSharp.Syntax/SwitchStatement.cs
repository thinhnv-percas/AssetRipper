...
public class SwitchStatement : Statement
{
	...
	{
		return other is SwitchStatement switchStatement && Expression.DoMatch(switchStatement.Expression, match) && SwitchSections.DoMatch(switchStatement.SwitchSections, match);
	}
}
