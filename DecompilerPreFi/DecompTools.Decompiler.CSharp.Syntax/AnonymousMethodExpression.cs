...
public class AnonymousMethodExpression : Expression
{
	...
	public bool HasParameterList
	{
		get
		{
			return hasParameterList || Enumerable.Any<ParameterDeclaration>((IEnumerable<ParameterDeclaration>)Parameters);
		}
		set
		{
			ThrowIfFrozen();
	...
	{
		return other is AnonymousMethodExpression anonymousMethodExpression && IsAsync == anonymousMethodExpression.IsAsync && HasParameterList == anonymousMethodExpression.HasParameterList && Parameters.DoMatch(anonymousMethodExpression.Parameters, match) && Body.DoMatch(anonymousMethodExpression.Body, match);
	}
}
