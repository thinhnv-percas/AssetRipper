...
public class QueryJoinClause : QueryClause
{
	...
	{
		return other is QueryJoinClause queryJoinClause && IsGroupJoin == queryJoinClause.IsGroupJoin && Type.DoMatch(queryJoinClause.Type, match) && AstNode.MatchString(JoinIdentifier, queryJoinClause.JoinIdentifier) && InExpression.DoMatch(queryJoinClause.InExpression, match) && OnExpression.DoMatch(queryJoinClause.OnExpression, match) && EqualsExpression.DoMatch(queryJoinClause.EqualsExpression, match) && AstNode.MatchString(IntoIdentifier, queryJoinClause.IntoIdentifier);
	}
}
