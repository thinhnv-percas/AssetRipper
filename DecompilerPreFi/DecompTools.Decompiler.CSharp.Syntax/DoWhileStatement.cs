...
public class DoWhileStatement : Statement
{
	...
	{
		return other is DoWhileStatement doWhileStatement && EmbeddedStatement.DoMatch(doWhileStatement.EmbeddedStatement, match) && Condition.DoMatch(doWhileStatement.Condition, match);
	}
