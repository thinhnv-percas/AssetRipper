...
public class ArrayCreateExpression : Expression
{
	...
	{
		return other is ArrayCreateExpression arrayCreateExpression && Type.DoMatch(arrayCreateExpression.Type, match) && Arguments.DoMatch(arrayCreateExpression.Arguments, match) && AdditionalArraySpecifiers.DoMatch(arrayCreateExpression.AdditionalArraySpecifiers, match) && Initializer.DoMatch(arrayCreateExpression.Initializer, match);
	}
}
