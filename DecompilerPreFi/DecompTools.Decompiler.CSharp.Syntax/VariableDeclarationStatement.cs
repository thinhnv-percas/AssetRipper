...
public class VariableDeclarationStatement : Statement
{
	...
	{
		return other is VariableDeclarationStatement variableDeclarationStatement && Modifiers == variableDeclarationStatement.Modifiers && Type.DoMatch(variableDeclarationStatement.Type, match) && Variables.DoMatch(variableDeclarationStatement.Variables, match);
	}
}
