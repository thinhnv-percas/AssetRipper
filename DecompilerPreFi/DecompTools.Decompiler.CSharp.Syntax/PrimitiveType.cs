...
public class PrimitiveType : AstType
{
	...
	public override TextLocation EndLocation => new TextLocation(location.Line, checked(location.Column + keyword.Length));
	...
	{
		return other is PrimitiveType primitiveType && AstNode.MatchString(Keyword, primitiveType.Keyword);
	}
