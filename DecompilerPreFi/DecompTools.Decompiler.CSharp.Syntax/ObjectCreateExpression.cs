...
public class ObjectCreateExpression : Expression
{
	...
	{
		return other is ObjectCreateExpression objectCreateExpression && Type.DoMatch(objectCreateExpression.Type, match) && Arguments.DoMatch(objectCreateExpression.Arguments, match) && Initializer.DoMatch(objectCreateExpression.Initializer, match);
	}
}
