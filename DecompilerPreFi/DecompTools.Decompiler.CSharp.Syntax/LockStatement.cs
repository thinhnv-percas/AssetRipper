...
public class LockStatement : Statement
{
	...
	{
		return other is LockStatement lockStatement && Expression.DoMatch(lockStatement.Expression, match) && EmbeddedStatement.DoMatch(lockStatement.EmbeddedStatement, match);
	}
}
