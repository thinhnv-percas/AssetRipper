...
public class FixedStatement : Statement
{
	...
	{
		return other is FixedStatement fixedStatement && Type.DoMatch(fixedStatement.Type, match) && Variables.DoMatch(fixedStatement.Variables, match) && EmbeddedStatement.DoMatch(fixedStatement.EmbeddedStatement, match);
	}
}
