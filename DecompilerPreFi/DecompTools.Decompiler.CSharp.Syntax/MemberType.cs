...
public class MemberType : AstType
{
	...
	{
		return other is MemberType memberType && IsDoubleColon == memberType.IsDoubleColon && AstNode.MatchString(MemberName, memberType.MemberName) && Target.DoMatch(memberType.Target, match) && TypeArguments.DoMatch(memberType.TypeArguments, match);
	}
