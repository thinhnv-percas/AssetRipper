...
public class IfElseStatement : Statement
{
	...
	{
		return other is IfElseStatement ifElseStatement && Condition.DoMatch(ifElseStatement.Condition, match) && TrueStatement.DoMatch(ifElseStatement.TrueStatement, match) && FalseStatement.DoMatch(ifElseStatement.FalseStatement, match);
	}
