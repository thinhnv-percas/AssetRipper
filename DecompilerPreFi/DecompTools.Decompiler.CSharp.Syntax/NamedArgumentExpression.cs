...
public class NamedArgumentExpression : Expression
{
	...
	{
		return other is NamedArgumentExpression namedArgumentExpression && AstNode.MatchString(Name, namedArgumentExpression.Name) && Expression.DoMatch(namedArgumentExpression.Expression, match);
	}
}
