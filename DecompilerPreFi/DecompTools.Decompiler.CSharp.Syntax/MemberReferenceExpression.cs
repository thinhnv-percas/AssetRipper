...
public class MemberReferenceExpression : Expression
{
	...
	{
		return other is MemberReferenceExpression memberReferenceExpression && Target.DoMatch(memberReferenceExpression.Target, match) && AstNode.MatchString(MemberName, memberReferenceExpression.MemberName) && TypeArguments.DoMatch(memberReferenceExpression.TypeArguments, match);
	}
}
