...
public class UndocumentedExpression : Expression
{
	...
	{
		return other is UndocumentedExpression undocumentedExpression && UndocumentedExpressionType == undocumentedExpression.UndocumentedExpressionType && Arguments.DoMatch(undocumentedExpression.Arguments, match);
	}
}
