...
public class ConstructorInitializer : AstNode
{
	...
	protected internal override bool DoMatch(AstNode other, Match match)
	{
		return other is ConstructorInitializer { IsNull: false } constructorInitializer && (ConstructorInitializerType == ConstructorInitializerType.Any || ConstructorInitializerType == constructorInitializer.ConstructorInitializerType) && Arguments.DoMatch(constructorInitializer.Arguments, match);
	}
}
