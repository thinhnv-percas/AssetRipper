...
public class UsingStatement : Statement
{
	...
	{
		return other is UsingStatement usingStatement && ResourceAcquisition.DoMatch(usingStatement.ResourceAcquisition, match) && EmbeddedStatement.DoMatch(usingStatement.EmbeddedStatement, match);
	}
}
