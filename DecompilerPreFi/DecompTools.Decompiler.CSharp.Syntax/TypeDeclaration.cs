...
public class TypeDeclaration : EntityDeclaration
{
	...
	{
		return other is TypeDeclaration typeDeclaration && ClassType == typeDeclaration.ClassType && AstNode.MatchString(Name, typeDeclaration.Name) && MatchAttributesAndModifiers(typeDeclaration, match) && TypeParameters.DoMatch(typeDeclaration.TypeParameters, match) && BaseTypes.DoMatch(typeDeclaration.BaseTypes, match) && Constraints.DoMatch(typeDeclaration.Constraints, match) && Members.DoMatch(typeDeclaration.Members, match);
	}
}
