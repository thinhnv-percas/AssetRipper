...
[Serializable]
public sealed class EmptyList<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IEnumerator<T>, IEnumerator, IDisposable, IReadOnlyList<T>, IReadOnlyCollection<T>
{
