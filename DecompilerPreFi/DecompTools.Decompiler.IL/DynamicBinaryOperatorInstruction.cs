...
public sealed class DynamicBinaryOperatorInstruction : DynamicInstruction
{
	...
	{
		DynamicBinaryOperatorInstruction dynamicBinaryOperatorInstruction = (DynamicBinaryOperatorInstruction)ShallowClone();
		dynamicBinaryOperatorInstruction.Left = left.Clone();
		dynamicBinaryOperatorInstruction.Right = right.Clone();
	...
	{
		return other is DynamicBinaryOperatorInstruction dynamicBinaryOperatorInstruction && left.PerformMatch(dynamicBinaryOperatorInstruction.left, ref match) && right.PerformMatch(dynamicBinaryOperatorInstruction.right, ref match);
	}
}
