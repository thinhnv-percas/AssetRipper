...
public class InvocationResolveResult : MemberResolveResult
{
	...
	{
		return Enumerable.Concat<ResolveResult>(Enumerable.Concat<ResolveResult>(base.GetChildResults(), (IEnumerable<ResolveResult>)Arguments), (IEnumerable<ResolveResult>)InitializerStatements);
	}
}
