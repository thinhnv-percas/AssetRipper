"""Port of Source/AssetRipper.Export.UnityProjects/RawAssets/UnknownObjectExporter.cs"""
...
from .unknown_export_collection import UnknownExportCollection


class UnknownObjectExporter(IAssetExporter):
    def try_create_collection(self, asset) -> "tuple[bool, object]":
        if isinstance(asset, UnknownObject):
            return True, UnknownExportCollection(self, asset)
        return False, None
