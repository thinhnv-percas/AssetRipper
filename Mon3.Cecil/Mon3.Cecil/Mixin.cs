...
using Mon3.Security.Cryptography;
...
internal static class Mixin
{
	...
	public static ParameterDefinition GetParameter(this Mon3.Cecil.Cil.MethodBody self, int index)
	{
	...
	public static VariableDefinition GetVariable(this Mon3.Cecil.Cil.MethodBody self, int index)
	{
